...
(Three.js + TypeScript + Vite, 싱글플레이). 직진하며 이상한 것을 **직접 짚는(지적)** 판정 —
놓치면 **골목이 접혀**(늘어나는 남은 거리) 긴장을 만든다. 깊이·꺼져가는 가로등이 압박,
감자튀김은 동기이자 유머 앵커. (2026-08-02 컨셉 전환 v0.4.0 + 지적 판정 v0.5.0 — game.md 결정 기록)
