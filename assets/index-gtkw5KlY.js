...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:ni,depthTest:!1,depthWrite:!1})}function Pl(){return new si({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Ro(),fragmentShader:`
		...
		`,blending:ni,depthTest:!1,depthWrite:!1})}function Ll(){return new si({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ro(),fragmentShader:`
	...
	`}function Dp(n){let t=new WeakMap,e=null;function i(o){if(o&&o.isTexture){const l=o.mapping,c=l===Ta||l===ba,u=l===Ji||l===Qi;if(c||u){let h=t.get(o);const f=h!==void 0?h.texture.pmremVersion:0;if(o.isRenderTargetTexture&&o.pmremVersion!==f)return e===null&&(e=new Rl(n)),h=c?e.fromEquirectangular(o,h):e.fromCubemap(o,h),h.texture.pmremVersion=o.pmremVersion,t.set(o,h),h.texture;if(h!==void 0)return h.texture;{const p=o.image;return c&&p&&p.height>0||u&&p&&r(p)?(e===null&&(e=new Rl(n)),h=c?e.fromEquirectangular(o):e.fromCubemap(o),h.texture.pmremVersion=o.pmremVersion,t.set(o,h),o.addEventListener("dispose",s),h.texture):null}}}return o}function r(o){let l=0;const c=6;for(let u=0;u<c;u++)o[u]!==void 0&&l++;return l===c}function s(o){const l=o.target;l.removeEventListener("dispose",s);const c=t.get(l);c!==void 0&&(t.delete(l),c.dispose())}function a(){t=new WeakMap,e!==null&&(e.dispose(),e=null)}return{get:i,dispose:a}}function Ip(n){const t={};function e(i){if(t[i]!==void 0)return t[i];let r;switch(i){case"WEBGL_depth_texture":r=n.getExtension("WEBGL_depth_texture")||n.getExtension("MOZ_WEBGL_depth_texture")||n.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":r=n.getExtension("EXT_texture_filter_anisotropic")||n.getExtension("MOZ_EXT_texture_filter_anisotropic")||n.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":r=n.getExtension("WEBGL_compressed_texture_s3tc")||n.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||n.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":r=n.getExtension("WEBGL_compressed_texture_pvrtc")||n.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:r=n.getExtension(i)}return t[i]=r,r}return{has:function(i){return e(i)!==null},init:function(){e("EXT_color_buffer_float"),e("WEBGL_clip_cull_distance"),e("OES_texture_float_linear"),e("EXT_color_buffer_half_float"),e("WEBGL_multisampled_render_to_texture"),e("WEBGL_render_shared_exponent")},get:function(i){const r=e(i);return r===null&&qi("THREE.WebGLRenderer: "+i+" extension not supported."),r}}}function Up(n,t,e,i){const r={},s=new WeakMap;function a(h){const f=h.target;f.index!==null&&t.remove(f.index);for(const _ in f.attributes)t.remove(f.attributes[_]);f.removeEventListener("dispose",a),delete r[f.id];const p=s.get(f);p&&(t.remove(p),s.delete(f)),i.releaseStatesOfGeometry(f),f.isInstancedBufferGeometry===!0&&delete f._maxInstanceCount,e.memory.geometries--}function o(h,f){return r[f.id]===!0||(f.addEventListener("dispose",a),r[f.id]=!0,e.memory.geometries++),f}function l(h){const f=h.attributes;for(const p in f)t.update(f[p],n.ARRAY_BUFFER)}function c(h){const f=[],p=h.index,_=h.attributes.position;let M=0;if(p!==null){const T=p.array;M=p.version;for(let E=0,S=T.length;E<S;E+=3){const L=T[E+0],A=T[E+1],w=T[E+2];f.push(L,A,A,w,w,L)}}else if(_!==void 0){const T=_.array;M=_.version;for(let E=0,S=T.length/3-1;E<S;E+=3){const L=E+0,A=E+1,w=E+2;f.push(L,A,A,w,w,L)}}else return;const m=new(Ec(f)?Rc:Ac)(f,1);m.version=M;const d=s.get(h);d&&t.remove(d),s.set(h,m)}function u(h){const f=s.get(h);if(f){const p=h.index;p!==null&&f.version<p.version&&c(h)}else c(h);return s.get(h)}return{get:o,update:l,getWireframeAttribute:u}}function Np(n,t,e){let i;function r(f){i=f}let s,a;function o(f){s=f.type,a=f.bytesPerElement}function l(f,p){n.drawElements(i,p,s,f*a),e.update(p,i,1)}function c(f,p,_){_!==0&&(n.drawElementsInstanced(i,p,s,f*a,_),e.update(p,i,_))}function u(f,p,_){if(_===0)return;t.get("WEBGL_multi_draw").multiDrawElementsWEBGL(i,p,0,s,f,0,_);let m=0;for(let d=0;d<_;d++)m+=p[d];e.update(m,i,1)}function h(f,p,_,M){if(_===0)return;const m=t.get("WEBGL_multi_draw");if(m===null)for(let d=0;d<f.length;d++)c(f[d]/a,p[d],M[d]);else{m.multiDrawElementsInstancedWEBGL(i,p,0,s,f,0,M,0,_);let d=0;for(let T=0;T<_;T++)d+=p[T]*M[T];e.update(d,i,1)}}this.setMode=r,this.setIndex=o,this.render=l,this.renderInstances=c,this.renderMultiDraw=u,this.renderMultiDrawInstances=h}function Fp(n){const t={geometries:0,textures:0},e={frame:0,calls:0,triangles:0,points:0,lines:0};function i(s,a,o){switch(e.calls++,a){case n.TRIANGLES:e.triangles+=o*(s/3);break;case n.LINES:e.lines+=o*(s/2);break;case n.LINE_STRIP:e.lines+=o*(s-1);break;case n.LINE_LOOP:e.lines+=o*s;break;case n.POINTS:e.points+=o*s;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",a);break}}function r(){e.calls=0,e.triangles=0,e.points=0,e.lines=0}return{memory:t,render:e,programs:null,autoReset:!0,reset:r,update:i}}function Op(n,t,e){const i=new WeakMap,r=new de;function s(a,o,l){const c=a.morphTargetInfluences,u=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,h=u!==void 0?u.length:0;let f=i.get(o);if(f===void 0||f.count!==h){let x=function(){I.dispose(),i.delete(o),o.removeEventListener("dispose",x)};var p=x;f!==void 0&&f.texture.dispose();const _=o.morphAttributes.position!==void 0,M=o.morphAttributes.normal!==void 0,m=o.morphAttributes.color!==void 0,d=o.morphAttributes.position||[],T=o.morphAttributes.normal||[],E=o.morphAttributes.color||[];let S=0;_===!0&&(S=1),M===!0&&(S=2),m===!0&&(S=3);let L=o.attributes.position.count*S,A=1;L>t.maxTextureSize&&(A=Math.ceil(L/t.maxTextureSize),L=t.maxTextureSize);const w=new Float32Array(L*A*4*h),I=new Tc(w,L,A,h);I.type=Gn,I.needsUpdate=!0;const y=S*4;for(let C=0;C<h;C++){const H=d[C],B=T[C],q=E[C],Y=L*A*4*C;for(let W=0;W<H.count;W++){const J=W*y;_===!0&&(r.fromBufferAttribute(H,W),w[Y+J+0]=r.x,w[Y+J+1]=r.y,w[Y+J+2]=r.z,w[Y+J+3]=0),M===!0&&(r.fromBufferAttribute(B,W),w[Y+J+4]=r.x,w[Y+J+5]=r.y,w[Y+J+6]=r.z,w[Y+J+7]=0),m===!0&&(r.fromBufferAttribute(q,W),w[Y+J+8]=r.x,w[Y+J+9]=r.y,w[Y+J+10]=r.z,w[Y+J+11]=q.itemSize===4?r.w:1)}}f={count:h,texture:I,size:new Xt(L,A)},i.set(o,f),o.addEventListener("dispose",x)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)l.getUniforms().setValue(n,"morphTexture",a.morphTexture,e);else{let _=0;for(let m=0;m<c.length;m++)_+=c[m];const M=o.morphTargetsRelative?1:1-_;l.getUniforms().setValue(n,"morphTargetBaseInfluence",M),l.getUniforms().setValue(n,"morphTargetInfluences",c)}l.getUniforms().setValue(n,"morphTargetsTexture",f.texture,e),l.getUniforms().setValue(n,"morphTargetsTextureSize",f.size)}return{update:s}}function Bp(n,t,e,i){let r=new WeakMap;function s(l){const c=i.render.frame,u=l.geometry,h=t.get(l,u);if(r.get(h)!==c&&(t.update(h),r.set(h,c)),l.isInstancedMesh&&(l.hasEventListener("dispose",o)===!1&&l.addEventListener("dispose",o),r.get(l)!==c&&(e.update(l.instanceMatrix,n.ARRAY_BUFFER),l.instanceColor!==null&&e.update(l.instanceColor,n.ARRAY_BUFFER),r.set(l,c))),l.isSkinnedMesh){const f=l.skeleton;r.get(f)!==c&&(f.update(),r.set(f,c))}return h}function a(){r=new WeakMap}function o(l){const c=l.target;c.removeEventListener("dispose",o),e.remove(c.instanceMatrix),c.instanceColor!==null&&e.remove(c.instanceColor)}return{update:s,dispose:a}}const Fc=new Je,Dl=new Dc(1,1),Oc=new Tc,Bc=new lh,zc=new Lc,Il=[],Ul=[],Nl=new Float32Array(16),Fl=new Float32Array(9),Ol=new Float32Array(4);function ar(n,t,e){const i=n[0];if(i<=0||i>0)return n;const r=t*e;let s=Il[r];if(s===void 0&&(s=new Float32Array(r),Il[r]=s),t!==0){i.toArray(s,0);for(let a=1,o=0;a!==t;++a)o+=e,n[a].toArray(s,o)}return s}function Oe(n,t){if(n.length!==t.length)return!1;for(let e=0,i=n.length;e<i;e++)if(n[e]!==t[e])return!1;return!0}function Be(n,t){for(let e=0,i=t.length;e<i;e++)n[e]=t[e]}function Es(n,t){let e=Ul[t];e===void 0&&(e=new Int32Array(t),Ul[t]=e);for(let i=0;i!==t;++i)e[i]=n.allocateTextureUnit();return e}function zp(n,t){const e=this.cache;e[0]!==t&&(n.uniform1f(this.addr,t),e[0]=t)}function kp(n,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(n.uniform2f(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(Oe(e,t))return;n.uniform2fv(this.addr,t),Be(e,t)}}function Hp(n,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(n.uniform3f(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else if(t.r!==void 0)(e[0]!==t.r||e[1]!==t.g||e[2]!==t.b)&&(n.uniform3f(this.addr,t.r,t.g,t.b),e[0]=t.r,e[1]=t.g,e[2]=t.b);else{if(Oe(e,t))return;n.uniform3fv(this.addr,t),Be(e,t)}}function Gp(n,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(n.uniform4f(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(Oe(e,t))return;n.uniform4fv(this.addr,t),Be(e,t)}}function Vp(n,t){const e=this.cache,i=t.elements;if(i===void 0){if(Oe(e,t))return;n.uniformMatrix2fv(this.addr,!1,t),Be(e,t)}else{if(Oe(e,i))return;Ol.set(i),n.uniformMatrix2fv(this.addr,!1,Ol),Be(e,i)}}function Wp(n,t){const e=this.cache,i=t.elements;if(i===void 0){if(Oe(e,t))return;n.uniformMatrix3fv(this.addr,!1,t),Be(e,t)}else{if(Oe(e,i))return;Fl.set(i),n.uniformMatrix3fv(this.addr,!1,Fl),Be(e,i)}}function Xp(n,t){const e=this.cache,i=t.elements;if(i===void 0){if(Oe(e,t))return;n.uniformMatrix4fv(this.addr,!1,t),Be(e,t)}else{if(Oe(e,i))return;Nl.set(i),n.uniformMatrix4fv(this.addr,!1,Nl),Be(e,i)}}function qp(n,t){const e=this.cache;e[0]!==t&&(n.uniform1i(this.addr,t),e[0]=t)}function Yp(n,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(n.uniform2i(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(Oe(e,t))return;n.uniform2iv(this.addr,t),Be(e,t)}}function $p(n,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(n.uniform3i(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(Oe(e,t))return;n.uniform3iv(this.addr,t),Be(e,t)}}function Kp(n,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(n.uniform4i(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(Oe(e,t))return;n.uniform4iv(this.addr,t),Be(e,t)}}function Zp(n,t){const e=this.cache;e[0]!==t&&(n.uniform1ui(this.addr,t),e[0]=t)}function jp(n,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(n.uniform2ui(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(Oe(e,t))return;n.uniform2uiv(this.addr,t),Be(e,t)}}function Jp(n,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(n.uniform3ui(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(Oe(e,t))return;n.uniform3uiv(this.addr,t),Be(e,t)}}function Qp(n,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(n.uniform4ui(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(Oe(e,t))return;n.uniform4uiv(this.addr,t),Be(e,t)}}function tm(n,t,e){const i=this.cache,r=e.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r);let s;this.type===n.SAMPLER_2D_SHADOW?(Dl.compareFunction=yc,s=Dl):s=Fc,e.setTexture2D(t||s,r)}function em(n,t,e){const i=this.cache,r=e.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r),e.setTexture3D(t||Bc,r)}function nm(n,t,e){const i=this.cache,r=e.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r),e.setTextureCube(t||zc,r)}function im(n,t,e){const i=this.cache,r=e.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r),e.setTexture2DArray(t||Oc,r)}function rm(n){switch(n){case 5126:return zp;case 35664:return kp;case 35665:return Hp;case 35666:return Gp;case 35674:return Vp;case 35675:return Wp;case 35676:return Xp;case 5124:case 35670:return qp;case 35667:case 35671:return Yp;case 35668:case 35672:return $p;case 35669:case 35673:return Kp;case 5125:return Zp;case 36294:return jp;case 36295:return Jp;case 36296:return Qp;case 35678:case 36198:case 36298:case 36306:case 35682:return tm;case 35679:case 36299:case 36307:return em;case 35680:case 36300:case 36308:case 36293:return nm;case 36289:case 36303:case 36311:case 36292:return im}}function sm(n,t){n.uniform1fv(this.addr,t)}function am(n,t){const e=ar(t,this.size,2);n.uniform2fv(this.addr,e)}function om(n,t){const e=ar(t,this.size,3);n.uniform3fv(this.addr,e)}function lm(n,t){const e=ar(t,this.size,4);n.uniform4fv(this.addr,e)}function cm(n,t){const e=ar(t,this.size,4);n.uniformMatrix2fv(this.addr,!1,e)}function um(n,t){const e=ar(t,this.size,9);n.uniformMatrix3fv(this.addr,!1,e)}function hm(n,t){const e=ar(t,this.size,16);n.uniformMatrix4fv(this.addr,!1,e)}function dm(n,t){n.uniform1iv(this.addr,t)}function fm(n,t){n.uniform2iv(this.addr,t)}function pm(n,t){n.uniform3iv(this.addr,t)}function mm(n,t){n.uniform4iv(this.addr,t)}function gm(n,t){n.uniform1uiv(this.addr,t)}function _m(n,t){n.uniform2uiv(this.addr,t)}function vm(n,t){n.uniform3uiv(this.addr,t)}function xm(n,t){n.uniform4uiv(this.addr,t)}function Mm(n,t,e){const i=this.cache,r=t.length,s=Es(e,r);Oe(i,s)||(n.uniform1iv(this.addr,s),Be(i,s));for(let a=0;a!==r;++a)e.setTexture2D(t[a]||Fc,s[a])}function Sm(n,t,e){const i=this.cache,r=t.length,s=Es(e,r);Oe(i,s)||(n.uniform1iv(this.addr,s),Be(i,s));for(let a=0;a!==r;++a)e.setTexture3D(t[a]||Bc,s[a])}function ym(n,t,e){const i=this.cache,r=t.length,s=Es(e,r);Oe(i,s)||(n.uniform1iv(this.addr,s),Be(i,s));for(let a=0;a!==r;++a)e.setTextureCube(t[a]||zc,s[a])}function Em(n,t,e){const i=this.cache,r=t.length,s=Es(e,r);Oe(i,s)||(n.uniform1iv(this.addr,s),Be(i,s));for(let a=0;a!==r;++a)e.setTexture2DArray(t[a]||Oc,s[a])}function Tm(n){switch(n){case 5126:return sm;case 35664:return am;case 35665:return om;case 35666:return lm;case 35674:return cm;case 35675:return um;case 35676:return hm;case 5124:case 35670:return dm;case 35667:case 35671:return fm;case 35668:case 35672:return pm;case 35669:case 35673:return mm;case 5125:return gm;case 36294:return _m;case 36295:return vm;case 36296:return xm;case 35678:case 36198:case 36298:case 36306:case 35682:return Mm;case 35679:case 36299:case 36307:return Sm;case 35680:case 36300:case 36308:case 36293:return ym;case 36289:case 36303:case 36311:case 36292:return Em}}class bm{constructor(t,e,i){this.id=t,this.addr=i,this.cache=[],this.type=e.type,this.setValue=rm(e.type)}}class wm{constructor(t,e,i){this.id=t,this.addr=i,this.cache=[],this.type=e.type,this.size=e.size,this.setValue=Tm(e.type)}}class Am{constructor(t){this.id=t,this.seq=[],this.map={}}setValue(t,e,i){const r=this.seq;for(let s=0,a=r.length;s!==a;++s){const o=r[s];o.setValue(t,e[o.id],i)}}}const oa=/(\w+)(\])?(\[|\.)?/g;function Bl(n,t){n.seq.push(t),n.map[t.id]=t}function Rm(n,t,e){const i=n.name,r=i.length;for(oa.lastIndex=0;;){const s=oa.exec(i),a=oa.lastIndex;let o=s[1];const l=s[2]==="]",c=s[3];if(l&&(o=o|0),c===void 0||c==="["&&a+2===r){Bl(e,c===void 0?new bm(o,n,t):new wm(o,n,t));break}else{let h=e.map[o];h===void 0&&(h=new Am(o),Bl(e,h)),e=h}}}class cs{constructor(t,e){this.seq=[],this.map={};const i=t.getProgramParameter(e,t.ACTIVE_UNIFORMS);for(let r=0;r<i;++r){const s=t.getActiveUniform(e,r),a=t.getUniformLocation(e,s.name);Rm(s,a,this)}}setValue(t,e,i,r){const s=this.map[e];s!==void 0&&s.setValue(t,i,r)}setOptional(t,e,i){const r=e[i];r!==void 0&&this.setValue(t,i,r)}static upload(t,e,i,r){for(let s=0,a=e.length;s!==a;++s){const o=e[s],l=i[o.id];l.needsUpdate!==!1&&o.setValue(t,l.value,r)}}static seqWithValue(t,e){const i=[];for(let r=0,s=t.length;r!==s;++r){const a=t[r];a.id in e&&i.push(a)}return i}}function zl(n,t,e){const i=n.createShader(t);return n.shaderSource(i,e),n.compileShader(i),i}const Cm=37297;let Pm=0;function Lm(n,t){const e=n.split(`
`),i=[],r=Math.max(t-6,0),s=Math.min(t+6,e.length);for(let a=r;a<s;a++){const o=a+1;i.push(`${o===t?">":" "} ${o}: ${e[a]}`)}return i.join(`
`)}const kl=new zt;function Dm(n){Qt._getMatrix(kl,Qt.workingColorSpace,n);const t=`mat3( ${kl.elements.map(e=>e.toFixed(4))} )`;switch(Qt.getTransfer(n)){case ds:return[t,"LinearTransferOETF"];case he:return[t,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space: ",n),[t,"LinearTransferOETF"]}}function Hl(n,t,e){const i=n.getShaderParameter(t,n.COMPILE_STATUS),r=n.getShaderInfoLog(t).trim();if(i&&r==="")return"";const s=/ERROR: 0:(\d+)/.exec(r);if(s){const a=parseInt(s[1]);return e.toUpperCase()+`

`+r+`

`+Lm(n.getShaderSource(t),a)}else return r}function Im(n,t){const e=Dm(t);return[`vec4 ${n}( vec4 value ) {`,`	return ${e[1]}( vec4( value.rgb * ${e[0]}, value.a ) );`,"}"].join(`
`)}function Um(n,t){let e;switch(t){case Nu:e="Linear";break;case Fu:e="Reinhard";break;case Ou:e="Cineon";break;case hc:e="ACESFilmic";break;case zu:e="AgX";break;case ku:e="Neutral";break;case Bu:e="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",t),e="Linear"}return"vec3 "+n+"( vec3 color ) { return "+e+"ToneMapping( color ); }"}const ts=new F;function Nm(){Qt.getLuminanceCoefficients(ts);const n=ts.x.toFixed(4),t=ts.y.toFixed(4),e=ts.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${n}, ${t}, ${e} );`,"	return dot( weights, rgb );","}"].join(`
`)}function Fm(n){return[n.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",n.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(gr).join(`
`)}function Om(n){const t=[];for(const e in n){const i=n[e];i!==!1&&t.push("#define "+e+" "+i)}return t.join(`
`)}function Bm(n,t){const e={},i=n.getProgramParameter(t,n.ACTIVE_ATTRIBUTES);for(let r=0;r<i;r++){const s=n.getActiveAttrib(t,r),a=s.name;let o=1;s.type===n.FLOAT_MAT2&&(o=2),s.type===n.FLOAT_MAT3&&(o=3),s.type===n.FLOAT_MAT4&&(o=4),e[a]={type:s.type,location:n.getAttribLocation(t,a),locationSize:o}}return e}function gr(n){return n!==""}function Gl(n,t){const e=t.numSpotLightShadows+t.numSpotLightMaps-t.numSpotLightShadowsWithMaps;return n.replace(/NUM_DIR_LIGHTS/g,t.numDirLights).replace(/NUM_SPOT_LIGHTS/g,t.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,t.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,e).replace(/NUM_RECT_AREA_LIGHTS/g,t.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,t.numPointLights).replace(/NUM_HEMI_LIGHTS/g,t.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,t.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,t.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,t.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,t.numPointLightShadows)}function Vl(n,t){return n.replace(/NUM_CLIPPING_PLANES/g,t.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,t.numClippingPlanes-t.numClipIntersection)}const zm=/^[ \t]*#include +<([\w\d./]+)>/gm;function no(n){return n.replace(zm,Hm)}const km=new Map;function Hm(n,t){let e=Gt[t];if(e===void 0){const i=km.get(t);if(i!==void 0)e=Gt[i],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',t,i);else throw new Error("Can not resolve #include <"+t+">")}return no(e)}const Gm=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Wl(n){return n.replace(Gm,Vm)}function Vm(n,t,e,i){let r="";for(let s=parseInt(t);s<parseInt(e);s++)r+=i.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return r}function Xl(n){let t=`precision ${n.precision} float;
...
#define LOW_PRECISION`),t}function Wm(n){let t="SHADOWMAP_TYPE_BASIC";return n.shadowMapType===cc?t="SHADOWMAP_TYPE_PCF":n.shadowMapType===pu?t="SHADOWMAP_TYPE_PCF_SOFT":n.shadowMapType===Hn&&(t="SHADOWMAP_TYPE_VSM"),t}function Xm(n){let t="ENVMAP_TYPE_CUBE";if(n.envMap)switch(n.envMapMode){case Ji:case Qi:t="ENVMAP_TYPE_CUBE";break;case Ms:t="ENVMAP_TYPE_CUBE_UV";break}return t}function qm(n){let t="ENVMAP_MODE_REFLECTION";if(n.envMap)switch(n.envMapMode){case Qi:t="ENVMAP_MODE_REFRACTION";break}return t}function Ym(n){let t="ENVMAP_BLENDING_NONE";if(n.envMap)switch(n.combine){case uc:t="ENVMAP_BLENDING_MULTIPLY";break;case Iu:t="ENVMAP_BLENDING_MIX";break;case Uu:t="ENVMAP_BLENDING_ADD";break}return t}function $m(n){const t=n.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,i=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),112)),texelHeight:i,maxMip:e}}function Km(n,t,e,i){const r=n.getContext(),s=e.defines;let a=e.vertexShader,o=e.fragmentShader;const l=Wm(e),c=Xm(e),u=qm(e),h=Ym(e),f=$m(e),p=Fm(e),_=Om(s),M=r.createProgram();let m,d,T=e.glslVersion?"#version "+e.glslVersion+`
...
정신을 차려 보니, 가게 앞이다.
걸어온 길이, 하나도 기억나지 않는다.`,softFailBtn:"…다시 걷는다",couponOverflow:"…여섯 번째 도장은, 칸 밖에 찍혀 있다."};function w0(n){return n<=0?"crispy":n<=2?"lukewarm":"soggy"}function A0(n){return 1+Math.min(kt.swarmMax,n)}const Kl=2.4;class R0{constructor(t){this.yaw=0,this.pitch=0,this.onPoint=null,this.touchForward=0,this.touchStrafe=0,this.keys=new Set,this.locked=!1,this.lookTouch=null,this.tapCandidate=null,this.usesTouch=!1,this.canvas=t,window.addEventListener("keydown",e=>this.keys.add(e.code)),window.addEventListener("keyup",e=>this.keys.delete(e.code)),window.addEventListener("blur",()=>this.keys.clear()),document.addEventListener("pointerlockchange",()=>{this.locked=document.pointerLockElement===this.canvas}),document.addEventListener("mousemove",e=>{this.locked&&this.applyLook(e.movementX,e.movementY)}),t.addEventListener("pointerdown",e=>this.onPointerDown(e)),t.addEventListener("pointermove",e=>this.onPointerMove(e)),t.addEventListener("pointerup",e=>this.onPointerEnd(e)),t.addEventListener("pointercancel",e=>this.onPointerEnd(e))}activate(){var t,e;this.usesTouch||(e=(t=this.canvas).requestPointerLock)==null||e.call(t)}applyLook(t,e){this.yaw-=t*.0024,this.pitch-=e*.0024;const r=Math.PI/2-.05;this.pitch=Math.max(-r,Math.min(r,this.pitch))}onPointerDown(t){var e,i,r;if(t.pointerType==="mouse"){if(!this.locked){(i=(e=this.canvas).requestPointerLock)==null||i.call(e);return}(r=this.onPoint)==null||r.call(this,window.innerWidth/2,window.innerHeight/2);return}this.usesTouch=!0,this.tapCandidate={id:t.pointerId,x:t.clientX,y:t.clientY,t:performance.now()},this.lookTouch||(this.lookTouch={id:t.pointerId,x:t.clientX,y:t.clientY})}onPointerMove(t){this.lookTouch&&t.pointerId===this.lookTouch.id&&(this.applyLook((t.clientX-this.lookTouch.x)*Kl,(t.clientY-this.lookTouch.y)*Kl),this.lookTouch.x=t.clientX,this.lookTouch.y=t.clientY)}onPointerEnd(t){var e;if(this.tapCandidate&&t.pointerId===this.tapCandidate.id){const i=this.tapCandidate,r=performance.now()-i.t<350,s=Math.hypot(t.clientX-i.x,t.clientY-i.y)<14;r&&s&&((e=this.onPoint)==null||e.call(this,t.clientX,t.clientY)),this.tapCandidate=null}this.lookTouch&&t.pointerId===this.lookTouch.id&&(this.lookTouch=null)}isDown(t){return this.keys.has(t)}getMove(){let t=0,e=0;return(this.keys.has("KeyW")||this.keys.has("ArrowUp"))&&(t+=1),(this.keys.has("KeyS")||this.keys.has("ArrowDown"))&&(t-=1),(this.keys.has("KeyD")||this.keys.has("ArrowRight"))&&(e+=1),(this.keys.has("KeyA")||this.keys.has("ArrowLeft"))&&(e-=1),t+=this.touchForward,e+=this.touchStrafe,{forward:Math.max(-1,Math.min(1,t)),strafe:Math.max(-1,Math.min(1,e))}}}class C0{constructor(){this.status=document.getElementById("status"),this.msg=document.getElementById("msg"),this.fade=document.getElementById("fade"),this.touchHint=document.getElementById("touch-hint"),this.reticle=document.getElementById("reticle"),this.reticleShown=!1,this.msgTimer=0,this.hintTimer=0}setReticle(t){t!==this.reticleShown&&(this.reticleShown=t,this.reticle.style.opacity=t?"0.5":"0")}setStatus(t){this.status.textContent=t}setStatusFold(t){this.status.style.opacity="0",setTimeout(()=>{this.status.textContent=t,this.status.style.opacity="1"},320)}showHint(t,e){this.touchHint.textContent=t,this.touchHint.style.display="block",window.clearTimeout(this.hintTimer),e&&(this.hintTimer=window.setTimeout(()=>this.hideHint(),e))}hideHint(){this.touchHint.style.display="none"}say(t,e=2600){this.msg.textContent=t,this.msg.style.opacity="1",window.clearTimeout(this.msgTimer),this.msgTimer=window.setTimeout(()=>{this.msg.style.opacity="0"},e)}async fadeOut(t=1200){this.fade.style.transitionDuration=`${t}ms`,this.fade.style.opacity="1",await new Promise(e=>setTimeout(e,t+60))}async fadeIn(t=1200){this.fade.style.transitionDuration=`${t}ms`,this.fade.style.opacity="0",await new Promise(e=>setTimeout(e,t+60))}async arrivalScene(t){var o;(o=document.exitPointerLock)==null||o.call(document);const e=document.createElement("div");e.className="overlay",e.style.opacity="0",e.style.background=t.bg,e.style.transitionDuration="1.4s";const i=document.createElement("div");i.className="sub",i.textContent=t.gauge;const r=document.createElement("div");r.className="quote",r.style.whiteSpace="pre-line",r.style.lineHeight="2",r.style.transition="opacity 1.1s",r.textContent=t.result;const s=document.createElement("button");s.textContent=t.steps[0],e.append(i,r,s),document.body.append(e),requestAnimationFrame(()=>e.style.opacity="1");let a=0;await new Promise(l=>{s.addEventListener("click",()=>{if(a>=2){l();return}if(t.onBite(a),a+=1,a<2){s.textContent=t.steps[1];return}s.disabled=!0,s.style.opacity="0.4",setTimeout(()=>{r.style.opacity="0",setTimeout(()=>{r.textContent=t.epilogue,r.style.opacity="1",s.textContent=t.endLabel,s.disabled=!1,s.style.opacity=""},1150)},1400)})}),e.style.opacity="0",setTimeout(()=>e.remove(),1500)}async blackScreen(t,e){var a;(a=document.exitPointerLock)==null||a.call(document);const i=document.createElement("div");i.className="overlay",i.style.opacity="0",i.style.background="#000";const r=document.createElement("div");r.className="quote",r.style.whiteSpace="pre-line",r.style.lineHeight="2",r.textContent=t;const s=document.createElement("button");s.textContent=e,i.append(r,s),document.body.append(i),requestAnimationFrame(()=>i.style.opacity="1"),await new Promise(o=>{s.addEventListener("click",()=>o(),{once:!0})}),i.style.opacity="0",setTimeout(()=>i.remove(),900)}}const Zl=.9;class P0{constructor(){this.ctx=null,this.master=null,this.ambGain=null,this.stepTimer=0,this.muted=!1}start(){if(this.ctx){this.ctx.resume();return}const t=new AudioContext;this.ctx=t,this.master=t.createGain(),this.master.gain.value=this.muted?0:Zl,this.master.connect(t.destination);const e=t.createBufferSource();e.buffer=this.noiseBuffer(4),e.loop=!0;const i=t.createBiquadFilter();i.type="lowpass",i.frequency.value=320;const r=t.createOscillator();r.frequency.value=.07;const s=t.createGain();s.gain.value=140,r.connect(s).connect(i.frequency),this.ambGain=t.createGain(),this.ambGain.gain.value=.05,e.connect(i).connect(this.ambGain).connect(this.master),e.start(),r.start()}suspend(){var t;(t=this.ctx)==null||t.suspend()}resume(){var t;(t=this.ctx)==null||t.resume()}setMuted(t){if(this.muted=t,!this.ctx||!this.master)return;const e=this.ctx.currentTime;this.master.gain.cancelScheduledValues(e),this.master.gain.setValueAtTime(this.master.gain.value,e),this.master.gain.linearRampToValueAtTime(t?0:Zl,e+.15)}duck(t){if(!this.ctx||!this.ambGain)return;const e=this.ctx.currentTime;this.ambGain.gain.cancelScheduledValues(e),this.ambGain.gain.setValueAtTime(this.ambGain.gain.value,e),this.ambGain.gain.linearRampToValueAtTime(t?.006:.05,e+2.2)}update(t,e){if(this.ctx){if(!e){this.stepTimer=.12;return}this.stepTimer-=t,this.stepTimer<=0&&(this.footstep(),this.stepTimer=.6)}}footstep(){const t=this.ctx;if(!t||!this.master)return;const e=t.createBufferSource();e.buffer=this.noiseBuffer(.08);const i=t.createBiquadFilter();i.type="bandpass",i.frequency.value=170+Math.random()*60,i.Q.value=1.2;const r=t.createGain(),s=t.currentTime;r.gain.setValueAtTime(.1,s),r.gain.exponentialRampToValueAtTime(.001,s+.09),e.connect(i).connect(r).connect(this.master),e.start(),e.stop(s+.1)}crunch(t){const e=this.ctx;if(!e||!this.master)return;const i=Math.max(0,Math.min(1,t)),r=i>.6?3:i>.3?2:1;for(let s=0;s<r;s++){const a=e.currentTime+s*.5,o=5+Math.floor(i*7);for(let l=0;l<o;l++){const c=e.createBufferSource();c.buffer=this.noiseBuffer(.03);const u=e.createBiquadFilter();u.type="highpass",u.frequency.value=1200+i*2500+Math.random()*800;const h=e.createGain(),f=a+l*(.028+Math.random()*.02);h.gain.setValueAtTime(1e-4,f),h.gain.exponentialRampToValueAtTime(.07+i*.06,f+.006),h.gain.exponentialRampToValueAtTime(.001,f+.03),c.connect(u).connect(h).connect(this.master),c.start(f),c.stop(f+.05)}}}carPass(t){const e=this.ctx;if(!e||!this.master)return;const i=e.currentTime,r=e.createBufferSource();r.buffer=this.noiseBuffer(t+.2);const s=e.createBiquadFilter();s.type="lowpass",s.frequency.setValueAtTime(240,i),s.frequency.linearRampToValueAtTime(900,i+t*.45),s.frequency.linearRampToValueAtTime(220,i+t);const a=e.createGain();a.gain.setValueAtTime(1e-4,i),a.gain.exponentialRampToValueAtTime(.16,i+t*.45),a.gain.exponentialRampToValueAtTime(8e-4,i+t),r.connect(s).connect(a).connect(this.master),r.start(i),r.stop(i+t+.2)}noiseBuffer(t){const e=this.ctx,i=Math.max(1,Math.floor(e.sampleRate*t)),r=e.createBuffer(1,i,e.sampleRate),s=r.getChannelData(0);let a=0;for(let o=0;o<i;o++){const l=Math.random()*2-1;a=(a+.02*l)/1.02,s[o]=a*3.2}return r}}const rn='"Malgun Gothic", "Apple SD Gothic Neo", sans-serif';function ai(n,t,e){const i=document.createElement("canvas");i.width=n,i.height=t;const r=i.getContext("2d");e(r);const s=new Lh(i);return s.colorSpace=dn,s.anisotropy=4,s}function jl(n){return ai(256,352,t=>{t.fillStyle="#b3ad9c",t.fillRect(0,0,256,352),t.fillStyle="#2a2620",t.textAlign="center",t.font=`bold 46px ${rn}`,t.fillText("과외",128,84),t.fillText("구합니다",128,140),t.font=`24px ${rn}`,t.fillText("수학 · 영어 — 초·중등",128,196),t.font=`bold 31px ${rn}`,t.fillText(n,128,268),t.strokeStyle="#6d675a",t.setLineDash([5,5]);for(let e=32;e<256;e+=32)t.beginPath(),t.moveTo(e,300),t.lineTo(e,352),t.stroke()})}function Jl(n){return ai(512,384,t=>{t.fillStyle="#0d1220",t.fillRect(0,0,512,384),t.strokeStyle="#2a3148",t.lineWidth=10,t.strokeRect(5,5,502,374),[["희망빌라 302",n?"급구":"월세 35"],["동아주택 B01","월세 30"],["한빛빌라 201","전세 8,500"],["성원빌라 402","월세 28"]].forEach(([i,r],s)=>{const a=28+s%2*240,o=32+Math.floor(s/2)*168;t.fillStyle="#c6c1b1",t.fillRect(a,o,216,140),t.textAlign="center",t.fillStyle="#33302a",t.font=`22px ${rn}`,t.fillText(i,a+108,o+44),t.font=`bold 40px ${rn}`,t.fillText(r,a+108,o+102)})})}function L0(){return ai(256,320,n=>{n.fillStyle="#0d1220",n.fillRect(0,0,256,320);const t=n.createRadialGradient(128,150,20,128,150,95);t.addColorStop(0,"rgba(190, 186, 170, 0.92)"),t.addColorStop(.75,"rgba(160, 155, 140, 0.5)"),t.addColorStop(1,"rgba(120, 116, 104, 0)"),n.fillStyle=t,n.beginPath(),n.ellipse(128,150,72,100,0,0,Math.PI*2),n.fill(),n.fillStyle="rgba(10, 12, 18, 0.9)";for(const e of[98,158])n.beginPath(),n.ellipse(e,128,11,16,0,0,Math.PI*2),n.fill()})}function D0(){return ai(1024,512,n=>{n.clearRect(0,0,1024,512);const t=[[190,260,.28,.85],[340,180,-.2,.7],[520,300,.5,.9],[660,210,-.4,.6],[810,290,.15,.8],[430,400,-.1,.5]];for(const[e,i,r,s]of t){n.save(),n.translate(e,i),n.rotate(r),n.fillStyle=`rgba(90, 15, 15, ${s})`,n.beginPath(),n.ellipse(0,0,26,34,0,0,Math.PI*2),n.fill();for(let a=0;a<5;a++){const o=-.7+a*.35;n.beginPath(),n.ellipse(Math.sin(o)*34,-Math.cos(o)*44,7,17,o,0,Math.PI*2),n.fill()}n.restore()}})}function I0(){return ai(1024,192,n=>{n.fillStyle="#7c1d22",n.fillRect(0,0,1024,192),n.strokeStyle="#e8d9a0",n.lineWidth=5,n.strokeRect(14,14,996,164),n.textAlign="center",n.fillStyle="#fdf3d8",n.font=`bold 78px ${rn}`,n.fillText("FF-1204  개업",512,86),n.font=`bold 56px ${rn}`,n.fillText("XXXXL 감자튀김",512,154)})}function ro(n){return ai(512,144,t=>{t.fillStyle="#140d05",t.fillRect(0,0,512,144),t.textAlign="center",t.fillStyle="#ffd9a0",t.font=`bold 60px ${rn}`;const e=t.measureText(n).width;e>470&&(t.font=`bold ${Math.floor(60*470/e)}px ${rn}`),t.fillText(n,256,96)})}function U0(){return ai(512,192,n=>{n.fillStyle="#140d05",n.fillRect(0,0,512,192),n.strokeStyle="#3a2a12",n.lineWidth=6,n.strokeRect(8,8,496,176),n.fillStyle="#ffd9a0",n.font=`bold 34px ${rn}`,n.fillText("감자튀김",28,54),n.font=`26px ${rn}`,[["XXXXL","9,900"],["XXL","6,900"],["L","4,900"]].forEach(([e,i],r)=>{const s=96+r*34;n.fillStyle=r===0?"#ffd9a0":"#9a8a6a",n.fillText(e,40,s),n.textAlign="right",n.fillText(i,472,s),n.textAlign="left"})})}function N0(){return ai(256,320,n=>{n.fillStyle="#e8e0cc",n.fillRect(0,0,256,320),n.fillStyle="#33302a",n.textAlign="center",n.font=`bold 30px ${rn}`,n.fillText("방문 도장",128,58),n.font=`20px ${rn}`,n.fillText("오실 때마다",128,96),n.strokeStyle="#5c5648",n.lineWidth=3;for(let t=0;t<5;t++){const e=52+t%3*52,i=150+Math.floor(t/3)*62;n.beginPath(),n.arc(e,i,21,0,Math.PI*2),n.stroke()}n.font=`17px ${rn}`,n.fillText("다섯 칸",128,292)})}function At(n,t,e,i,r,s,a,o){const l=new xt(new fe(n,t,e),new te({color:i,roughness:.95}));return l.position.set(r,s,a),o.add(l),l}function X(n,t,e,i,r,s,a,o){const l=new xt(new fe(t,e,i),n);return l.position.set(r,s,a),o.add(l),l}const Rt=n=>new te({color:n,roughness:.95});function F0(){return{blood:new te({color:5705744,roughness:1}),darkFigure:new te({color:724502,roughness:1})}}const D=kt.segLength,V=kt.corridorHalfWidth,se=7,Se=-D*.68,Tn=3.2,O0=-D*.585,Co=9,B0=3.5,Hc=6;function ms(n){return n%Co<Hc}function z0(n){const t=n%Co;return t>=B0&&t<Hc}const so=44,Gc=3.8,k0=18,H0=9,G0=4.6,Ve=9,Ue=3.4,Vc=1.5,V0=-36-Ve/2,W0=[1.8,Ve/2],X0=12371672,Po=8160924,Wc=3.2,Xc=Math.PI/2,q0=0,qc=[[1.6,-D*.26],[-1.9,-D*.36],[2.1,-D*.49],[-1.4,-D*.58],[.9,-D*.71],[-2.1,-D*.81]],Yc=new F(-2.35,.28,-D*.46),Y0=new F(.5,.28,-D*.42),Er=[26,20,14,9,5.5,3],Tr=658970,$c=10466511,en=-D-6.6;function Ql(n=!1){const t=new oe,e={road:Rt(1580072),wall:Rt(2304056),shutter:Rt(2765123),tile:Rt(7236190),steel:Rt(9080470),dark:Rt(1317154),awning:Rt(8133922)},i=new te({color:16757310,emissive:16757310,emissiveIntensity:.55,roughness:.4});X(e.road,12,.2,12,0,-.18,en+3.4,t);const r=8,s=3.6,a=en-s;X(e.tile,r,3.4,.2,0,1.7,a,t);for(const f of[-1,1])X(e.tile,.2,3.4,s,f*(r/2),1.7,en-s/2,t);X(e.dark,r+.4,.25,s,0,3.5,en-s/2,t),X(e.dark,r+.4,1.1,.4,0,3,en,t);const o=X(e.awning,r+1,.12,1.5,0,2.62,en+.75,t);o.rotation.x=-.16,X(e.steel,r-1,1.05,.7,0,.525,en-.5,t),X(e.tile,r-.8,.08,.85,0,1.09,en-.5,t);for(const f of[-1,1]){X(e.steel,1.25,.95,.85,f*1.5,1.5,a+.75,t);const p=new xt(new fe(1.02,.05,.62),i);p.position.set(f*1.5,1.99,a+.75),t.add(p),X(e.steel,.06,.5,.06,f*1.5,2.25,a+1.1,t)}X(e.dark,3.6,.55,1.1,0,2.75,a+.75,t);const l=new xt(new qe(2.7,1),new te({map:U0(),roughness:.9}));l.position.set(-1.5,1.92,en-.25),t.add(l);const c=new xt(new qe(.72,.9),new te({map:N0(),roughness:.95}));c.position.set(2.6,1.75,a+.11),t.add(c);for(const f of[2.15,2.62])X(e.steel,2.2,.06,.34,2.6,f,a+.28,t);const u=4.6,h=en+3.4;for(const f of[-1,1]){X(e.wall,.5,7,7.6,f*u,3.5,h,t),X(e.shutter,.16,2.4,5.4,f*(u-.32),1.2,h,t);for(let _=0;_<4;_++)X(e.dark,.17,.05,5.4,f*(u-.32),.5+_*.55,h,t);const p=X(e.awning,.9,.1,5.6,f*(u-.6),2.75,h,t);p.rotation.z=f*-.24}X(e.wall,r+6,4.2,.6,0,5.5,en+.15,t);for(const f of[-2.4,0,2.4])X(e.dark,1.3,1,.1,f,5.2,en-.2,t);if(n){const f=ro("FF-1204 24시"),p=new te({color:16777215,map:f,emissiveMap:f,emissive:16777215}),_=Rt(1314053),M=new xt(new fe(3.4,.9,.3),[_,_,_,_,p,_]);M.position.set(0,4.3,en+.55),t.add(M);const m=new qn(16757310,20,26,2);m.position.set(0,3,en+.6),t.add(m)}return t.visible=!1,t}const Ne=-D-6;function $0(){const n=new oe,t={road:Rt(1580072),wall:Rt(2304056),villa:Rt(2501694),trim:Rt(2896452),door:Rt(1119519),dark:Rt(1317154),crate:Rt(2765122)},e=new te({color:16767392,emissive:16762503,emissiveIntensity:1}),i=new te({color:6970434,emissive:16757310,emissiveIntensity:.35,roughness:.6}),r=new te({color:3814440,emissive:16757310,emissiveIntensity:.18}),s=4.6,a=Ne+3.4;X(t.road,12,.2,12,0,-.18,a,n);for(const u of[-1,1])X(t.wall,.5,7,7.6,u*s,3.5,a,n);const o=9;X(t.villa,o,7,.6,0,3.5,Ne-.3,n),X(t.trim,o+.6,.3,.9,0,7.1,Ne-.3,n),X(t.trim,3.4,.22,1.3,0,2.62,Ne+.45,n);for(const u of[-1,1])X(t.trim,.16,2.5,.16,u*1.5,1.25,Ne+.95,n);X(t.trim,2.3,2.5,.2,0,1.25,Ne+.02,n),X(t.door,1.6,2.2,.14,0,1.1,Ne+.1,n);const l=new xt(new fe(.44,1.05,.06),i);l.position.set(0,1.52,Ne+.17),n.add(l);for(const u of[1.16,1.52,1.88])X(t.door,.5,.05,.09,0,u,Ne+.19,n);X(t.trim,.46,.1,.26,0,2.53,Ne+.19,n);const c=new xt(new fe(.3,.11,.14),e);c.position.set(0,2.44,Ne+.17),n.add(c),X(t.trim,1,.55,.16,-1.75,1.35,Ne+.05,n);for(let u=0;u<3;u++)X(t.dark,.26,.34,.04,-2.05+u*.3,1.35,Ne+.14,n);return X(t.trim,.5,.26,.06,1.7,2.15,Ne+.03,n),[3.6,5.1,6.3].forEach((u,h)=>{X(t.dark,.9,1.1,.12,2.6,u,Ne+.02,n);const f=new xt(new fe(.8,1,.06),h===1?r:t.dark);f.position.set(-2.6,u,Ne+.02),n.add(f)}),X(t.trim,.85,.6,.4,3,4.4,Ne+.2,n),X(t.crate,1.7,.5,1,-3.3,.25,Ne+1.5,n),X(t.crate,.75,.36,.62,-3.5,.86,Ne+1.45,n),n.visible=!1,n}function K0(){return{wall:Rt(2106938),portal:Rt(2304056),deck:Rt(1711915),base:Rt(1448741),trim:Rt(2436157),girder:Rt(1317154),groove:Rt(1119517),road:Rt(1580072),fog:[.22,.32,.45,.6,.75].map(n=>new Ss({color:263690,transparent:!0,opacity:n,depthWrite:!1,fog:!1,side:Pn}))}}let Z0=null;const Kc=()=>Z0??(Z0=K0());function tc(n,t,e,i,r){const s=new oe,a=p=>n+t*p,o=Vc,l=Ve/2,c=Ve+2,u=a(l+1);X(i.road,20,.2,Ve+6,0,-.1,a(l),s);for(const p of[2.2,4.4])X(i.groove,o*2+.6,.04,.08,0,.02,a(p),s);for(const p of[-1,1]){const _=p*(o+.45);X(i.wall,.9,Ue,c,_,Ue/2,u,s),X(i.base,1,.5,c,p*(o+.43),.25,u,s),X(i.trim,1,.14,c,p*(o+.43),Ue-.3,u,s);for(const M of[1.2,2.6,4,5.4])X(i.groove,.07,Ue-1,.09,p*(o-.02),(Ue+.5)/2,a(M),s);X(i.groove,.34,.06,c,p*(o-.17),.035,u,s)}X(i.deck,o*2+2,.9,c,0,Ue+.45,u,s);for(const p of[1,3,5,7])X(i.girder,o*2+1.2,.3,.4,0,Ue-.13,a(p),s);const h=.125;for(const p of[-1,1])X(i.portal,.78,Ue+.62,.85,p*(o+.39),(Ue+.62)/2,a(h),s);X(i.portal,o*2+1.9,.62,.9,0,Ue+.31,a(h),s),X(i.trim,o*2+2.4,.16,1.12,0,Ue+.7,a(h-.08),s);for(const p of[.1,Ve-.1])X(i.portal,20,.62,.62,0,Ue+1,a(p),s),X(i.portal,20,1.15,.44,0,Ue+1.89,a(p),s);for(let p=-3.6;p<=3.61;p+=.9)X(i.trim,.16,.6,.3,p,Ue+2.76,a(.1),s);X(i.trim,20,.16,.38,0,Ue+3.14,a(.1),s);for(const p of W0)X(i.girder,.44,.16,.24,0,Ue-.44,a(p),s),X(r,.3,.05,.15,0,Ue-.545,a(p),s);const f=new qn(X0,Wc,11,2);return f.position.set(0,Ue-.7,a(l)),s.add(f),[3.2,4.2,5.2,6.4,7.8].forEach((p,_)=>{const M=new xt(new qe(14,11),i.fog[_]);M.position.set(0,Ue/2,a(p)),s.add(M)}),X(i.portal,20,se,1,0,se/2,a(Ve+e),s),{group:s,light:f}}function j0(n,t){n.background=new Kt(Tr),n.fog=new So(Tr,.044);const e=new Oh(3752286,2.2);n.add(e);const i=new Fh(8425664,.75);i.position.set(4,10,2),n.add(i);const r=new oe;n.add(r),At(V*2+14,.2,D+14,1580072,0,-.1,-D/2,r);const s=21.28,a=D+(Se-Tn);for(const[st,ct]of[[V+.5,2304056],[-V-.5,2106938]])At(1,se,s,ct,st,se/2,-s/2,r),At(1,se,a,ct,st,se/2,Se-Tn-a/2,r);const o=V-_r+1;for(const st of[-D-.5,.5])for(const ct of[-1,1])At(o,se,1,2304056,ct*(_r+o/2),se/2,st,r);const l=Kc(),c=new te({color:2830912,emissive:Po}),u=tc(-D,-1,4,l,c),h=tc(0,1,.6,l,c),f=u.group,p=h.group;r.add(p),r.add(f);const _=[u.light,h.light],M=-D*.45,m=At(.15,5,.15,3817815,V-.4,2.5,M,r),d=new qn(16762503,22,18,1.8);d.position.set(V-.9,4.8,M),r.add(d);const T=new qn(16757310,0,26,2);T.position.set(0,3,-D-6),r.add(T);const E=new oe,S=new xt(new fe(.46,1.22,.28),t.darkFigure);S.position.y=.9;const L=new xt(new pn(.15,10,8),t.darkFigure);L.position.y=1.66,E.add(S,L),E.visible=!1,r.add(E);const A=new xt(new bo(.42,.5,24),new Ss({color:9146536,transparent:!0,opacity:.32}));A.rotation.x=-Math.PI/2,A.position.set(.9,.03,-5.5),A.visible=!1,r.add(A);const w=[ro("FF-1204 24시"),ro("FF-1204 24시간요")],I=new te({color:16777215,map:w[0],emissiveMap:w[0],emissive:0}),y=Rt(1314053),x=new xt(new fe(3.4,.9,.3),[y,y,y,y,I,y]);x.position.set(0,4.6,-D+.2),r.add(x);const C=Ql(),H=$0();r.add(C,H);const B=Ql(!0);B.rotation.y=Math.PI,B.position.z=-D,r.add(B);const q=new oe,Y=new xt(new fe(4.1,.95,1.75),new te({color:1448484,roughness:.7}));Y.position.y=.72;const W=new xt(new fe(2.1,.62,1.6),new te({color:1119261,roughness:.7}));W.position.set(-.25,1.45,0),q.add(Y,W);const J=new te({color:16774872,emissive:16773320});for(const st of[-.6,.6]){const ct=new xt(new fe(.14,.22,.3),J);ct.position.set(2.02,.78,st),q.add(ct)}const G=new qn(16771512,0,16,2);return G.position.set(2.6,.9,0),q.add(G),q.position.set(0,0,Se),q.visible=!1,r.add(q),{refs:{group:r,scene:n,moon:i,tunnel:f,backTunnel:p,tunnelLights:_,tunnelLampMat:c,car:q,carLight:G,ambient:e,foldMark:A,lampLight:d,shopGlow:T,shopSign:x,shopSignMat:I,shopTex:w,shopFront:C,homeFront:H,shopBack:B,figure:E},hit:{lamp_flicker:[m],shop_typo:[x],figure:[E]}}}function J0(n,t){const e=Kc(),i=Tn,r=G0,s=H0,a=c=>n*(k0+c),o=a(s/2+1);for(const c of[-1,1])X(e.wall,s+2,r,.9,o,r/2,Se+c*(i+.45),t),X(e.base,s+2,.5,1,o,.25,Se+c*(i+.43),t);X(e.deck,s+2,.9,i*2+2,o,r+.45,Se,t);for(const c of[1.4,4])X(e.girder,.4,.3,i*2+1.2,a(c),r-.13,Se,t);for(const c of[-1,1])X(e.portal,.85,r+.62,.78,a(.1),(r+.62)/2,Se+c*(i+.39),t);X(e.portal,.9,.62,i*2+1.9,a(.1),r+.31,Se,t),X(e.trim,1.12,.16,i*2+2.4,a(.02),r+.7,Se,t);const l=new te({color:2830912,emissive:Po});X(e.girder,.24,.16,.5,a(1.5),r-.44,Se,t),X(l,.17,.05,.38,a(1.5),r-.55,Se,t),X(e.portal,1,se-(r+.9),i*2+2,a(.5),(r+.9+se)/2,Se,t),[1.2,2.4,3.8,5.4,7].forEach((c,u)=>{const h=new xt(new qe(i*2+1,r+.8),e.fog[u]);h.position.set(a(c),r/2,Se),h.rotation.y=Math.PI/2,t.add(h)}),X(e.portal,1,se,i*2+2,a(s+2),se/2,Se,t)}function Q0(n){At(1,se,Tn*2,2304056,V+.5,se/2,Se,n),At(1,se,Tn*2,2106938,-V-.5,se/2,Se,n)}function tg(n){const t=new oe,e=new oe,i=[[.55,-D*.31,.3],[.2,-D*.345,.2],[-.2,-D*.375,.26],[-.6,-D*.4,.17],[-1.1,-D*.42,.22],[-1.6,-D*.435,.14]];for(const[Y,W,J]of i){const G=new xt(new ys(J,14),n.blood);G.rotation.x=-Math.PI/2,G.position.set(Y,.015,W),e.add(G)}e.visible=!1,t.add(e);const r=new oe,s=new te({color:13222576,roughness:.85}),a=new xt(new pn(.17,12,10),s);a.position.y=.14,a.scale.set(1,.92,1.08);const o=new xt(new fe(.2,.09,.16),s);o.position.set(0,-.02,.04);const l=new te({color:658450,roughness:1});for(const Y of[-.062,.062]){const W=new xt(new pn(.042,8,6),l);W.position.set(Y,.15,.145),r.add(W)}r.add(a,o),r.position.set(-V+.8,1.06,-D*.19),r.rotation.y=Math.PI/6,r.visible=!1,t.add(r);const c=L0(),u=new xt(new qe(1,1.28),new te({map:c,emissiveMap:c,emissive:4867644}));u.position.set(V-.03,3.4,-D*.68),u.rotation.y=-Math.PI/2,u.visible=!1,t.add(u),At(1.6,.5,1,2765122,-V+1,.25,-D*.2,t),At(.7,.35,.6,2436157,-V+.8,.85,-D*.19,t);const h=new oe,f=At(.06,1.3,.06,5593968,0,.65,0,h);f.rotation.z=.5;const p=new xt(new To(.55,.5,8),new te({color:7017760,roughness:.8}));p.position.set(-.35,1.35,0),p.rotation.z=.5,h.add(p),h.position.set(-V+1.8,0,-D*.24),h.visible=!1,t.add(h);const _=At(.45,.22,.16,1843760,-V+.12,1.7,-D*.3,t),M=_.material,m=new qn(15260080,0,6,1.8);m.position.set(-V+.5,1.7,-D*.3),t.add(m);const d=new xt(new qe(1.1,1.4),new te({color:1119263,emissive:0}));d.position.set(V-.02,3.4,-D*.68),d.rotation.y=-Math.PI/2,t.add(d);const T=d.material,E=[jl("010-4172-8956"),jl("010-417-8956")],S=new te({map:E[0],roughness:.9}),L=new xt(new qe(.55,.75),S);L.position.set(V-.01,1.55,-D*.4),L.rotation.y=-Math.PI/2,t.add(L),At(.24,6.8,.24,2896452,V-.35,3.4,-D*.15,t),At(.24,6.8,.24,2896452,-V+.35,3.4,-D*.72,t),At(.035,.035,D*.85,1119261,V-.35,6.3,-D*.5,t);const A=V-.35-(-V+.35),w=-D*.15- -D*.72,I=At(.035,.035,Math.hypot(A,w),1119261,0,6,(-D*.15+-D*.72)/2,t);I.rotation.y=Math.atan2(A,w),At(.85,.6,.38,2764864,V-.35,2.5,-D*.58,t),At(.85,.6,.38,2501692,-V+.35,2.2,-D*.33,t),At(.12,2.4,1.5,1119519,-V+.05,1.2,-D*.22,t),At(.2,.16,1.9,2896452,-V+.1,2.5,-D*.22,t);const y={pipe:Rt(3752282),meter:Rt(2896452),dark:Rt(1119519),prop:Rt(2501694),paper:Rt(4868690)};for(const[Y,W]of[[-1,-D*.52],[1,-D*.24],[-1,-D*.82]])X(y.pipe,.14,5.2,.14,Y*(V-.16),2.6,W,t);X(y.pipe,.1,.1,D*.36,-V+.16,2.9,-D*.67,t),X(y.pipe,.1,.1,D*.3,V-.16,2.75,-D*.38,t),X(y.dark,.12,2.4,1.5,V-.05,1.2,-D*.86,t),X(y.meter,.2,.16,1.9,V-.1,2.5,-D*.86,t),X(y.meter,.16,.6,.9,V-.12,1.7,-D*.78,t);for(let Y=0;Y<4;Y++)X(y.prop,.14,.26,.22,V-.14,1.45,-D*.75+Y*.28,t);X(y.meter,.16,.55,.8,-V+.12,1.75,-D*.29,t),X(y.prop,.42,.55,1.5,V-.42,.42,-D*.66,t),X(y.prop,.3,.35,.3,V-.42,.9,-D*.62,t),X(y.prop,.5,.42,.5,-V+.35,.21,-D*.62,t),X(y.prop,.45,.38,.45,-V+.38,.6,-D*.63,t);for(const[Y,W,J]of[[-1,-D*.72,1.5],[1,-D*.48,1.35],[-1,-D*.46,1.9]])X(y.paper,.02,.34,.24,Y*(V-.02),J,W,t);const x=new oe;for(const Y of[-.11,.11]){const W=X(Rt(14210248),.24,.11,.34,0,.055,0,x);W.position.x=Y}x.position.set(V-.55,0,-D*.86+.15),x.visible=!1,t.add(x);const C=new oe,H=new xt(new fe(.4,.72,.26),n.darkFigure);H.position.y=1.24;const B=new xt(new pn(.14,10,8),n.darkFigure);B.position.set(0,1.74,.02);const q=new xt(new fe(.34,.5,.5),n.darkFigure);return q.position.set(0,.78,.24),C.add(H,B,q),C.position.set(V-.42,0,-D*.655),C.visible=!1,t.add(C),{group:t,refs:{umbrella:h,sensorMat:M,sensorLight:m,windowMat:T,flyerMat:S,flyerTex:E,bloodTrail:e,skull:r,facePlane:u,shoes:x,bikeFigure:C},hit:{umbrella:[h],sensor_on:[_],window_red:[d],flyer_digits:[L],blood_trail:[e],skull:[r],face_window:[u],shoes:[x],bike_figure:[C]}}}function eg(){const n=new oe,t=At(.08,2,2.6,1316900,V-.06,1.25,-D*.39,n),e=t.material,i=At(.12,2.2,2.7,2830916,V-.18,1.25,-D*.39,n),r=new qn(13623528,0,8,1.8);r.position.set(V-.9,1.3,-D*.39),n.add(r);const s=new xt(new qe(2.4,1.7),new te({map:D0(),transparent:!0,roughness:1}));s.position.set(V-.25,1.25,-D*.39),s.rotation.y=-Math.PI/2,s.visible=!1,n.add(s);const a=At(1.7,.65,.14,1975348,V-.1,3.2,-D*.5,n),o=a.material;At(1.5,.6,.14,1843504,V-.1,3.4,-D*.29,n),At(1.9,.7,.14,2106938,V-.1,3.1,-D*.62,n);const l=[Jl(!1),Jl(!0)],c=new te({map:l[0],roughness:.85}),u=new xt(new qe(1.5,1.1),c);u.position.set(-V+.01,1.5,-D*.5),u.rotation.y=Math.PI/2,n.add(u);const h={shutter:Rt(2765123),slat:Rt(2041140),awning:Rt(2302260),curb:Rt(2238262),sign:Rt(2106938),steel:Rt(3752282),prop:Rt(2501694),dark:Rt(1514538)};for(const[E,S]of[[-1,-D*.3],[-1,-D*.68],[-1,-D*.86],[1,-D*.19],[1,-D*.76]]){const L=E*(V-.1);X(h.shutter,.12,2.1,2.3,L,1.15,S,n);for(let w=0;w<4;w++)X(h.slat,.13,.05,2.3,L,.45+w*.5,S,n);const A=X(h.awning,.85,.07,2.5,E*(V-.5),2.65,S,n);A.rotation.z=E*.3,X(h.sign,.14,.5,2,E*(V-.12),3.05,S,n)}const f=-D*.68,p=new te({color:1119260,roughness:1}),_=new xt(new qe(1.7,2),p);_.rotation.x=-Math.PI/2,_.position.set(-1.45,.02,f),n.add(_);const M=new te({color:1119260}),m=new xt(new fe(.06,.1,2.1),M);m.position.set(-2.7,.18,f),n.add(m);const d=new qn(16769192,0,6.5,2);d.position.set(-2.1,.5,f),n.add(d),X(h.curb,.55,.14,D*.92,-V+.28,.07,-D/2,n),X(h.curb,.55,.14,D*.92,V-.28,.07,-D/2,n),X(h.dark,.9,.3,1.8,-V+.55,.02,-D*.44,n);for(const E of[-D*.41,-D*.47])X(h.steel,.06,.9,.06,-V+1,.45,E,n);X(h.steel,.06,.06,1.3,-V+1,.88,-D*.44,n);for(const[E,S]of[[1,-D*.42],[1,-D*.58],[-1,-D*.55]])X(h.prop,.5,.42,.8,E*(V-.28),1.9,S,n);X(h.steel,.16,4.6,.16,V-.2,2.3,-D*.35,n),X(h.steel,.12,.12,D*.4,V-.2,2.55,-D*.55,n);const T=X(h.prop,.16,1,.7,-V+.32,.5,-D*.24,n);T.rotation.z=-.12;for(const[E,S]of[[-D*.63,.34],[-D*.66,.28]])X(h.prop,.42,S,.6,-V+.34,S/2,E,n);return{group:n,refs:{laundryShutter:i,laundryMat:e,laundryLight:r,storeSignMat:o,realtyMat:c,realtyTex:l,handprints:s,shutterGlowMat:p,shutterGlowSlitMat:M,shutterGlowLight:d},hit:{laundry_open:[i,t],sign_lit:[a],realty_urgent:[u],handprints:[s],shutter_glow:[_,m]}}}function ng(n){const t=new oe;for(const m of[-D*.32,-D*.375,-D*.43,-D*.485])At(.07,.85,1.7,3291730,-V+.85,.45,m,t);At(.1,2.3,.1,3817815,-V+.22,1.15,-D*.365,t),At(.1,2.3,.1,3817815,-V+.22,1.15,-D*.42,t),At(.08,.08,2.2,3817815,-V+.22,2.3,-D*.393,t);const e=new oe;e.position.set(-V+.22,2.26,-D*.393),At(.03,1.5,.03,5593968,0,-.75,-.22,e),At(.03,1.5,.03,5593968,0,-.75,.22,e),At(.14,.06,.55,5593968,0,-1.5,0,e),t.add(e);const i=new xt(new pn(.28,12,10),new te({color:7173256,roughness:.85}));i.position.copy(Yc),t.add(i);const r=new oe,s=new xt(new fe(.4,.62,.26),n.darkFigure);s.position.y=1.12;const a=new xt(new pn(.13,10,8),n.darkFigure);a.position.set(.05,1.56,0);const o=new xt(new fe(.34,.52,.16),n.darkFigure);o.position.set(.2,.56,0),o.rotation.z=.25,r.add(s,a,o),r.position.set(-V+.22,0,-D*.393),r.visible=!1,t.add(r);const l=new oe,c=new te({color:724502,emissive:9410220,emissiveIntensity:.9});for(const m of[-.09,.09]){const d=new xt(new pn(.045,8,6),c);d.position.x=m,l.add(d)}l.position.set(-V+.38,1.42,-D*.55),l.visible=!1,t.add(l);const u=new te({color:1251880,roughness:1});for(const[m,d]of[[-D*.25,1.6],[-D*.42,2],[-D*.58,1.5],[-D*.78,1.8]]){const T=new xt(new pn(1,7,5),u);T.scale.set(d,d*.75,d),T.position.set(-V-1.4,se+.6,m),t.add(T)}const h={fence:Rt(3291730),rail:Rt(3818592),gear:Rt(2765648),wall2:Rt(2041140),dark:Rt(1514538),prop:Rt(2501694)};X(h.gear,.12,2.6,.12,-V-2.2,se+.6,-D*.34,t),X(h.gear,1.9,.12,.9,-V-2.9,se+1.7,-D*.34,t);const f=X(h.gear,2.6,.1,.7,-V-3.4,se+.5,-D*.34,t);f.rotation.z=.5;const p=new oe,_=new xt(new fe(.42,1.2,.26),n.darkFigure);_.position.y=.6;const M=new xt(new pn(.15,10,8),n.darkFigure);M.position.y=1.35,p.add(_,M),p.position.set(-V+.15,se,-D*.36),p.visible=!1,t.add(p);for(const m of[-D*.62,-D*.7])X(h.gear,.09,1.8,.09,-V-2,se+.3,m,t),X(h.gear,.09,1.8,.09,-V-3.4,se+.3,m,t);for(const m of[se-.5,se+.4,se+1.2])X(h.gear,1.5,.09,.09,-V-2.7,m,-D*.66,t);for(const m of[-D*.15,-D*.21,-D*.265,-D*.54,-D*.595,-D*.65,-D*.72,-D*.79,-D*.86])X(h.fence,.07,.85,1.7,-V+.85,.45,m,t);X(h.rail,.05,.06,D*.78,-V+.85,.88,-D*.5,t),X(h.prop,.5,.1,1.6,-V+.5,.45,-D*.24,t);for(const m of[-D*.215,-D*.265])X(h.prop,.45,.45,.08,-V+.5,.22,m,t);X(h.prop,.42,.7,.42,-V+.45,.35,-D*.75,t),X(h.dark,.1,2.2,1.3,V-.05,1.1,-D*.7,t),X(h.wall2,.16,.2,1.6,V-.12,2.3,-D*.7,t),X(h.wall2,.14,.5,.4,V-.1,1.5,-D*.58,t);for(const m of[-D*.3,-D*.38,-D*.46])X(h.prop,.34,.3,.34,V-.25,2.3,m,t),X(h.gear,.3,.34,.3,V-.25,2.6,m,t);return X(h.wall2,.5,.16,D*.5,V-.3,2.12,-D*.4,t),X(h.prop,.3,.75,.3,V-.25,.37,-D*.86,t),X(h.wall2,.12,1.1,.5,V-.08,1.6,-D*.86,t),{group:t,refs:{swingPivot:e,ball:i,swingFigure:r,eyes:l,slideFigure:p},hit:{swing:[e],ball_out:[i],swing_figure:[r],eyes:[l],slide_figure:[p]}}}function ig(n){const t=new oe;At(.08,2.2,2.2,2436157,V-.06,1.35,-D*.32,t),At(.9,.08,2.4,2765122,V-.5,2.5,-D*.32,t),At(.08,2.5,.08,2765122,V-.34,1.25,-D*.29,t),At(.08,2.5,.08,2765122,V-.34,1.25,-D*.35,t),At(.35,.08,1.8,2765122,V-.32,.55,-D*.32,t);const i=At(.62,.06,1.7,2765122,V-.5,2.4,-D*.32,t).material;i.emissive.setHex(9414340);const r=new qn(12374250,9,8.5,2);r.position.set(V-.7,2.2,-D*.32),t.add(r);const s=new oe,a=new xt(new fe(.42,.6,.26),n.darkFigure);a.position.y=.95;const o=new xt(new pn(.13,10,8),n.darkFigure);o.position.set(-.06,1.38,0);const l=new xt(new fe(.4,.5,.18),n.darkFigure);l.position.set(-.2,.35,0),s.add(a,o,l),s.position.set(V-.42,0,-D*.32),s.visible=!1,t.add(s);const c=new oe,u=new xt(new fe(.44,1.2,.26),n.darkFigure);u.position.y=.9;const h=new xt(new pn(.15,10,8),n.darkFigure);h.position.y=1.64,c.add(u,h),c.position.set(-1.1,0,Se-Tn-.6),c.visible=!1,t.add(c);const f=[],p=[],_=[],M=-D*.55,m=Se-Tn-.9;for(const[E,S,L]of[[V-.4,m,1],[-2.6,M,-1]]){At(.12,3.4,.12,3817815,E,1.7,S,t),_.push(At(.3,.66,.24,1843760,E,3.55,S,t));const A=At(.16,.16,.06,3477780,E,3.7,S+.14*L,t),w=At(.16,.16,.06,1124378,E,3.42,S+.14*L,t);f.push(A.material),p.push(w.material)}At(60,.2,Tn*2,1843244,0,-.1,Se,t);for(const E of[-1,1])At(15,se,1,2304056,E*11,se/2,Se-Tn-.5,t),At(15,se,1,2106938,E*11,se/2,Se+Tn+.5,t),J0(E,t);for(let E=0;E<4;E++)At(V*2-1.2,.03,.6,8949922,0,.02,-D*.62-E*1.15,t);At(V*2-1.2,.03,.35,8949922,0,.02,-D*.585,t),At(.16,.7,.16,3752282,V-.7,.35,-D*.24,t),At(.16,.7,.16,3752282,V-.7,.35,-D*.4,t),At(.5,.14,D*.9,2304056,V-.25,.07,-D/2,t);const d=new te({map:I0(),roughness:.95}),T=new xt(new qe(6.4,1.1),d);return T.position.set(0,5.25,-D+.25),t.add(T),{group:t,refs:{trafficRed:f,trafficGreen:p,busFigure:s,banner:T,boothLight:r,boothTubeMat:i,acrossFigure:c},hit:{traffic_red:_,bus_figure:[s],across_figure:[c]}}}function rg(n){const t=new oe;At(.14,.6,1.5,2106938,-V+.1,3.1,-D*.25,t),At(1.6,.7,.14,1975348,V-.1,3.35,-D*.33,t),At(.14,.55,1.3,1843504,-V+.1,2.9,-D*.47,t),At(1.8,.6,.14,2106938,V-.1,3.15,-D*.6,t);const e=new oe,i=new te({color:9146536,roughness:.9}),r=new fe(.8,1.15,.06);for(const d of[1,-1]){const T=new xt(r,i);T.position.set(0,.56,d*.16),T.rotation.x=-d*.26,e.add(T)}e.position.set(-V+.75,0,-D*.55),e.rotation.y=Xc,t.add(e);const s=new oe,a=new xt(new ys(.34,16),n.blood);a.rotation.x=-Math.PI/2,a.position.set(.7,.015,-D*.52);const o=new xt(new qe(.34,6.2),n.blood);o.rotation.x=-Math.PI/2,o.rotation.z=.42,o.position.set(-.55,.015,-D*.595),s.add(a,o),s.visible=!1,t.add(s);const l={front:Rt(2304056),shutter:Rt(2765123),slat:Rt(2041140),awning:Rt(2827060),signB:Rt(2106938),crate:Rt(2501694),steel:Rt(3817815),wire:Rt(1119261)};X(l.signB,V*2+.6,.55,.05,0,4.4,-D*.12,t);const c=[[1,-D*.2,3],[-1,-D*.33,3.4],[1,-D*.46,3.2],[-1,-D*.58,3],[1,-D*.71,3.4],[-1,-D*.83,3.2]],u=2,h=new oe;t.add(h),c.forEach(([d,T,E],S)=>{const L=d*(V-.1),A=S===u?h:t;X(l.front,.2,4.2,E,L,2.1,T,t),X(l.shutter,.16,2.3,E-.5,d*(V-.26),1.15,T,A);for(let I=0;I<4;I++)X(l.slat,.17,.05,E-.5,d*(V-.26),.5+I*.5,T,A);const w=X(l.awning,.95,.08,E+.2,d*(V-.55),2.72,T,t);w.rotation.z=d*-.28,X(l.signB,.14,.62,E-.8,d*(V-.12),3.42,T,t),S%2===1&&X(l.signB,.5,1.5,.16,d*(V-.45),3.3,T+1.1,t),X(l.steel,.4,.08,E-1.2,d*(V-.2),.78,T,t);for(const I of[-1,1])X(l.steel,.06,.78,.06,d*(V-.2),.39,T+I*(E/2-.8),t)});const f=[[V-.2,.18,-D*.42,.44],[V-.22,.53,-D*.43,.4],[-V+.2,.2,-D*.7,.42],[-V+.22,.18,-D*.26,.44],[V-.24,.17,-D*.63,.4],[-V+.2,.54,-D*.71,.36]];for(const[d,T,E,S]of f)X(l.crate,S,S*.78,S,d,T,E,t);for(const d of[-D*.28,-D*.52,-D*.76]){X(l.wire,V*2+.4,.035,.035,0,4.05,d,t);for(let T=-2;T<=2;T++)X(l.crate,.09,.13,.09,T*1.15,3.95,d,t)}const[,p,_]=c[u],M=_-.5,m=new oe;X(l.shutter,.16,.95,M,V-.26,1.83,p,m);for(let d=0;d<2;d++)X(l.slat,.17,.05,M,V-.26,1.55+d*.4,p,m);return X(Rt(263690),.06,1.35,M,V-.36,.68,p,m),m.visible=!1,t.add(m),{group:t,refs:{sign:e,dragMark:s,openShutter:m,closedShutter:h},hit:{sign_turn:[e],drag_mark:[s],open_shutter:[m]}}}function cn(n){return{reset:t=>{n(t).visible=!1},apply:t=>{n(t).visible=!0}}}const ec={shoes:cn(n=>n.shoes),bike_figure:cn(n=>n.bikeFigure),slide_figure:cn(n=>n.slideFigure),across_figure:cn(n=>n.acrossFigure),open_shutter:{reset:n=>{n.openShutter.visible=!1,n.closedShutter.visible=!0},apply:n=>{n.openShutter.visible=!0,n.closedShutter.visible=!1}},shutter_glow:{reset:n=>{n.shutterGlowMat.color.setHex(1119260),n.shutterGlowSlitMat.emissive.setHex(0),n.shutterGlowLight.intensity=0},apply:n=>{n.shutterGlowMat.color.setHex(9077362),n.shutterGlowSlitMat.emissive.setHex(16764810),n.shutterGlowLight.intensity=5.5}},umbrella:cn(n=>n.umbrella),sensor_on:{reset:n=>{n.sensorMat.emissive.setHex(0),n.sensorLight.intensity=0},apply:n=>{n.sensorMat.emissive.setHex(13615780),n.sensorLight.intensity=4}},window_red:{reset:n=>{n.windowMat.emissive.setHex(0)},apply:n=>{n.windowMat.emissive.setHex(7999504)}},laundry_open:{reset:n=>{n.laundryShutter.position.y=1.25,n.laundryShutter.scale.y=1,n.laundryMat.emissive.setHex(0),n.laundryLight.intensity=0},apply:n=>{n.laundryShutter.position.y=2,n.laundryShutter.scale.y=.42,n.laundryMat.emissive.setHex(7833487),n.laundryLight.intensity=6}},sign_lit:{reset:n=>{n.storeSignMat.emissive.setHex(0)},apply:n=>{n.storeSignMat.emissive.setHex(7214100)}},swing:{reset:n=>{n.swingPivot.rotation.x=0}},lamp_flicker:{reset:n=>{n.lampLight.intensity=n.group.userData.morning?0:n.group.userData.lampBase??Er[0]}},traffic_red:{reset:()=>{}},ball_out:{reset:n=>{n.ball.position.copy(Yc)},apply:n=>{n.ball.position.copy(Y0)}},sign_turn:{reset:n=>{n.sign.rotation.y=Xc},apply:n=>{n.sign.rotation.y=q0}},flyer_digits:{reset:n=>{n.flyerMat.map=n.flyerTex[0]},apply:n=>{n.flyerMat.map=n.flyerTex[1]}},realty_urgent:{reset:n=>{n.realtyMat.map=n.realtyTex[0]},apply:n=>{n.realtyMat.map=n.realtyTex[1]}},shop_typo:{reset:n=>{n.shopSignMat.map=n.shopTex[0],n.shopSignMat.emissiveMap=n.shopTex[0]},apply:n=>{n.shopSignMat.map=n.shopTex[1],n.shopSignMat.emissiveMap=n.shopTex[1]}},figure:{reset:n=>{n.figure.visible=!1},apply:n=>{const[t,e]=qc[n.group.userData.figureAnchor??0];n.figure.position.set(t,0,e),n.figure.rotation.y=Math.random()<.5?Math.PI:Math.PI*.85,n.figure.visible=!0}},blood_trail:cn(n=>n.bloodTrail),skull:cn(n=>n.skull),face_window:cn(n=>n.facePlane),handprints:cn(n=>n.handprints),swing_figure:cn(n=>n.swingFigure),eyes:cn(n=>n.eyes),bus_figure:cn(n=>n.busFigure),drag_mark:cn(n=>n.dragMark)};function Zc(n,t){var e,i;for(const r of Object.values(ec))r.reset(n);n.group.userData.effects=t;for(const r of t)(i=(e=ec[r]).apply)==null||i.call(e,n)}const sg=new Kt(Tr);function ag(n,t){n.themes.forEach((e,i)=>e.visible=i===t-1)}function jc(n,t){if(n.group.userData.morning)return;const e=Er[Math.min(t,Er.length-1)];n.group.userData.lampBase=e,n.lampLight.intensity=e,n.ambient.intensity=Math.max(1.1,2.2-t*.18),n.group.userData.ambientBase=n.ambient.intensity,Jc(n,9-t*.7)}function Jc(n,t){n.boothLight.intensity=Math.max(0,t),n.boothTubeMat.emissive.setHex(t>.1?9414340:0)}function Lo(n,t){n.group.userData.morning=t;const e=t?$c:Tr;n.scene.background.setHex(e);const i=n.scene.fog;i.color.setHex(e),i.density=t?.008:.044,n.ambient.color.setHex(t?14541804:3752286),n.ambient.intensity=t?5.6:2.2,n.group.userData.ambientBase=n.ambient.intensity,n.moon.color.setHex(t?16774106:8425664),n.moon.intensity=t?3.6:.75,n.lampLight.intensity=t?0:Er[0],Jc(n,t?0:9)}function us(n,t,e){const i=n.scene.fog,r=Math.max(0,Math.min(1,t));i.density=e+r*r*1.4;const s=!!n.group.userData.morning,a=s?$c:Tr,o=Math.pow(1-r,2.2),l=u=>{u.setHex(a),s&&r>0&&u.lerp(sg,Math.min(1,r*2.5)),u.multiplyScalar(o)};l(i.color),l(n.scene.background);for(const u of n.tunnelLights)u.intensity=Wc*(1-r);n.tunnelLampMat.emissive.setHex(Po).multiplyScalar(1-r);const c=n.group.userData.ambientBase??2.2;n.ambient.intensity=c*(1-r*.92)}function og(n,t){n.foldMark.visible=t}function lg(n,t,e=!0){const i=!!n.group.userData.morning;n.tunnel.visible=!t,n.shopFront.visible=t&&e,n.homeFront.visible=t&&!e,n.shopGlow.intensity=t?e?26:30:i?0:4,n.shopSign.visible=t&&e,n.shopSignMat.emissive.setHex(t&&e?16777215:0)}function cg(n,t){n.backTunnel.visible=!t,n.shopBack.visible=t}function ug(n,t){n.banner.position.z=t?-D+.25:-.25,n.banner.rotation.y=t?0:Math.PI}function hg(n,t){const e=(i,r)=>{i.scale.x=r?-1:1};e(n.themes[3],t),e(n.themes[4],!t),n.banner.scale.x=t?-1:1}const dg=9049622,fg=3111498;function pg(n,t){const e=n.group.userData.effects??[];if(e.includes("lamp_flicker")){const r=n.group.userData.lampBase??Er[0],s=t%1.6,a=!(s<.12||s>.24&&s<.36);n.lampLight.intensity=a?r:Math.min(2,r)}if(e.includes("swing")&&(n.swingPivot.rotation.x=Math.sin(t*2.2)*.38),n.themes[3].visible){const r=e.includes("traffic_red"),s=z0(t)?Math.floor(t*4)%2===0:!0,a=!r&&ms(t)&&s,o=r||!ms(t);for(const l of n.trafficGreen)l.emissive.setHex(a?fg:0);for(const l of n.trafficRed)l.emissive.setHex(o?dg:0)}const i=n.group.userData.carStart;if(i!==void 0){const r=(t-i)/Gc;if(r>=1||!n.themes[3].visible)n.car.visible=!1,n.carLight.intensity=0,n.group.userData.carStart=void 0;else{const s=n.group.userData.carDir??1;n.car.position.x=s*(-so/2+so*r),n.car.rotation.y=s>0?0:Math.PI,n.car.visible=!0,n.carLight.intensity=26}}}function mg(n){n.group.userData.carStart=void 0,n.car.visible=!1,n.carLight.intensity=0}function gg(n,t,e=1){n.group.userData.carStart=t,n.group.userData.carDir=e,n.car.position.set(e*-so/2,0,Se),n.car.visible=!0}function _g(n){return n.car.visible&&Math.abs(n.car.position.x)<V+2.2}function vg(n){const t=F0(),e=j0(n,t),i=tg(t),r=eg(),s=ng(t),a=ig(t),o=rg(t),c=[i,r,s,a,o].map(h=>h.group);c.forEach((h,f)=>{f!==3&&Q0(h),h.visible=!1,h.name=`테마${f+1}`,e.refs.group.add(h)}),e.refs.group.name="골목",e.refs.tunnel.name="앞터널",e.refs.backTunnel.name="뒤터널",e.refs.shopFront.name="FF-1204(앞)",e.refs.shopBack.name="FF-1204(뒤)",e.refs.homeFront.name="집",e.refs.figure.name="그림자사람",e.refs.car.name="차",e.refs.shopSign.name="FF-1204 간판",a.refs.banner.name="개업 현수막",a.refs.busFigure.name="정류장의 형체",o.refs.sign.name="입간판",o.refs.dragMark.name="끌린 자국",i.refs.bloodTrail.name="핏자국",i.refs.skull.name="백골",i.refs.umbrella.name="우산",r.refs.handprints.name="손자국",s.refs.swingFigure.name="그네의 형체",s.refs.eyes.name="어둠의 눈",s.refs.ball.name="공";const u={...e.hit,...i.hit,...r.hit,...s.hit,...a.hit,...o.hit};return{...e.refs,...i.refs,...r.refs,...s.refs,...a.refs,...o.refs,themes:c,hit:u}}const Do="fries.save.v1",gs={night:1,tut:!1,misses:0,results:[],brightness:1,muted:!1};function xg(n){const t={...gs,results:[]};if(typeof n!="object"||n===null)return t;const e=n;return typeof e.night=="number"&&Number.isInteger(e.night)&&e.night>=1&&e.night<=99&&(t.night=e.night),typeof e.tut=="boolean"&&(t.tut=e.tut),t.night>1&&(t.tut=!0),typeof e.misses=="number"&&Number.isInteger(e.misses)&&e.misses>=0&&(t.misses=e.misses),Array.isArray(e.results)&&(t.results=e.results.slice(0,99).map(i=>i==="crispy"||i==="lukewarm"||i==="soggy"?i:null)),typeof e.brightness=="number"&&e.brightness>=.6&&e.brightness<=1.9&&(t.brightness=e.brightness),typeof e.muted=="boolean"&&(t.muted=e.muted),t}function Mg(){try{const n=localStorage.getItem(Do);return n?xg(JSON.parse(n)):{...gs,results:[]}}catch{return{...gs,results:[]}}}const ce=Mg();function or(){try{localStorage.setItem(Do,JSON.stringify(ce))}catch{}}function Sg(){Object.assign(ce,gs,{results:[]});try{localStorage.removeItem(Do)}catch{}}function yg(){return ce.night>1||ce.misses>0||ce.tut}const Eg=`
...
<span class="k">조준</span> ${c}`}pick(){var p;this.ray.setFromCamera(this.center,this.host.camera);const e=this.ray.intersectObjects(this.host.scene.children,!0).find(_=>{if(!_.object.isMesh)return!1;for(let M=_.object;M;M=M.parent)if(!M.visible)return!1;return!0});if(!e)return'<span class="k">(없음)</span>';const i=e.object,r=[];for(let _=i;_;_=_.parent)_.name&&r.unshift(_.name);const s=i.geometry,a=s.parameters;let o=s.type??"?";a&&(s.type==="BoxGeometry"?o=`Box ${_e(a.width)}×${_e(a.height)}×${_e(a.depth)}`:s.type==="PlaneGeometry"?o=`Plane ${_e(a.width)}×${_e(a.height)}`:s.type==="SphereGeometry"?o=`Sphere r${_e(a.radius)}`:s.type==="CylinderGeometry"&&(o=`Cyl r${_e(a.radiusTop)} h${_e(a.height)}`));const l=i.material,c=Array.isArray(l)?"(면별 재질)":"#"+(((p=l.color)==null?void 0:p.getHexString())??"??????"),u=i.getWorldPosition(new F),h=this.host.segLength,f=u.z<.5&&u.z>-h*1.4?` = -L*${_e(-u.z/h,3)}`:"";return this.line+=`
${r.join(" › ")} | ${o} ${c} | x ${_e(u.x)} y ${_e(u.y)} z ${_e(u.z)}${f}`,`<span class="o">${r.join(" › ")||"(이름 없음)"}</span>
     ${o}  ${c}  <span class="k">${_e(e.distance,1)}m</span>
     <span class="v">x ${_e(u.x)}  y ${_e(u.y)}  z ${_e(u.z)}</span><span class="k">${f}</span>`}openPanel(){var a,o,l,c;(a=document.exitPointerLock)==null||a.call(document);const t=this.host.snapshot(),e=document.createElement("div");e.id="adm-panel";const i=this.host.anomalies.map(u=>`<option value="${u.effect}">${u.segment||"전"} · ${u.label}</option>`).join("");e.innerHTML=`
      <h3>관리자 — 스테이지 이동</h3>
      ...
      <label><span>구간 테마</span><select id="adm-theme">${Array.from({length:this.host.segments},(u,h)=>h+1).map(u=>`<option value="${u}"${u===t.theme?" selected":""}>${u} — ${bg[u]??""}</option>`).join("")}</select></label>
      ...
      <div class="help">비행 WASD · Space 상승 · Shift 하강 · Alt 가속 · 휠 속도<br>
        ...
        관리자 모드에서는 붙잡힘·치임·접힘·구간 전환이 전부 멈춘다</div>`,document.body.appendChild(e),this.panel=e;const r=e.querySelector("#adm-depth"),s=e.querySelector("#adm-depth-v");r.addEventListener("input",()=>s.textContent=r.value),(o=e.querySelector("#adm-go"))==null||o.addEventListener("click",()=>{const u=e.querySelector("#adm-eff").value;this.clearView=e.querySelector("#adm-view").value==="clear",this.host.jump({night:Number(e.querySelector("#adm-night").value)||1,morning:e.querySelector("#adm-when").value==="morning",theme:Number(e.querySelector("#adm-theme").value),depth:Number(r.value),effect:u===""?null:u}),this.closePanel()}),(l=e.querySelector("#adm-close"))==null||l.addEventListener("click",()=>this.closePanel()),(c=e.querySelector("#adm-off"))==null||c.addEventListener("click",()=>{this.closePanel(),this.toggle()})}closePanel(){var t;(t=this.panel)==null||t.remove(),this.panel=null,this.active&&this.host.relock()}}const bg={1:"원룸 골목 (집)",2:"상가 골목",3:"놀이터 옆길",4:"정류장 앞 (차도)",5:"먹자골목 입구 (가게)"},wg=document.getElementById("app"),An=new E0({antialias:!0});An.setPixelRatio(Math.min(window.devicePixelRatio,2));An.setSize(window.innerWidth,window.innerHeight);An.toneMapping=hc;wg.appendChild(An.domElement);const ao=1.35,ti=document.getElementById("bright"),Io=document.getElementById("start");let Qc=0;function nc(){window.clearTimeout(Qc),Io.classList.add("peek")}function la(){Io.classList.remove("peek")}ti&&(ti.value=String(ce.brightness),An.toneMappingExposure=ce.brightness*ao,ti.addEventListener("pointerdown",nc),window.addEventListener("pointerup",la),window.addEventListener("pointercancel",la),ti.addEventListener("input",()=>{An.toneMappingExposure=parseFloat(ti.value)*ao,ce.brightness=parseFloat(ti.value),or(),nc(),Qc=window.setTimeout(la,1e3)}));const Ts=new Ah,re=new fn(72,window.innerWidth/window.innerHeight,.1,120),Zt=vg(Ts),ae=new R0(An.domElement),$t=new C0,je=new P0,_s=new zh,ca=document.getElementById("pain");function br(n){ca&&(ca.style.opacity=String(Math.min(.55,n*.09)),ca.classList.toggle("acute",n>=4))}const $i=document.getElementById("sound-btn");function Uo(){je.setMuted(ce.muted),$i&&($i.textContent=ce.muted?"🔇":"🔊",$i.setAttribute("aria-label",ce.muted?"소리 켜기":"소리 끄기"))}function tu(){ce.muted=!ce.muted,or(),Uo()}$i==null||$i.addEventListener("click",tu);window.addEventListener("keydown",n=>{n.code==="KeyM"&&tu()});Uo();let Pe="gate",we="return",ir=!1,ua=!1,De=ce.night,We=0,vn=kt.segments,Re=1,ke=0,lr=0,bs=!1,Ai=0,vs=0,un=0,Wi=!1,xs=-1,xi=0,wr=0,Ce=[];const Wn=new Set;let oo=new Set,lo=0;const Vt={x:0,z:0};function Ag(){return Math.min(.8,kt.baseAnomalyChance+wr/60*kt.chancePerMinute)}const ws=new URLSearchParams(location.search),No=ws.get("a"),Rg=ws.has("t"),Cg=ws.get("avert")==="off",Pg=Math.max(0,Math.min(5,Number(ws.get("anchor")??2)||0));let eu=null;const es=()=>eu??No;let ha=!1;const Ti=new Tg({camera:re,scene:Ts,segLength:kt.segLength,corridorHalfWidth:kt.corridorHalfWidth,segments:kt.segments,anomalies:io.map(n=>({id:n.id,effect:n.effect,segment:n.segment,label:`${n.id} ${n.effect} (${n.rule==="avert"?"외면":"직시"})`})),snapshot:()=>({night:De,done:We,total:vn,theme:Re,depth:ke,folds:lr,morning:we==="tutorial"}),relock:()=>ae.activate(),jump:n=>{n.effect!==void 0&&(eu=n.effect),n.night!==void 0&&(De=Math.max(1,Math.floor(n.night))),n.morning!==void 0&&(we=n.morning?"tutorial":"return",Lo(Zt,n.morning)),Oo(),n.theme!==void 0&&(Re=Math.max(1,Math.min(kt.segments,n.theme))),We=we==="return"?kt.segments-Re:Re-1,n.depth!==void 0&&(ke=Math.max(0,Math.min(kt.depthLimit-1,n.depth))),xi=Ct.tutBeats.length,Lr(),br(ke),Pe="walk"}});function Lr(n=!1){ag(Zt,Re);const t=we==="tutorial",e=io.filter(o=>(o.segment===Re||o.segment===0)&&o.night<=De&&!oo.has(o.id)),i=nr(De).onboarding,r=!es()&&i&&We===0,s=i&&lo===0&&(we==="return"?Re<=2:Re>=kt.segments-1);if(t)Ce=[];else if(es()){const o=io.find(l=>l.effect===es()&&(l.segment===Re||l.segment===0));Ce=o?[o]:[]}else if(e.length>0&&!r&&(s||Math.random()<Ag())){const o=Math.min(A0(Ai),e.length);Ce=[...e].sort(()=>Math.random()-.5).slice(0,o),lo+=o}else Ce=[];oo=new Set(Ce.map(o=>o.id)),Wn.clear(),Ce.some(o=>o.effect==="figure")&&(Zt.group.userData.figureAnchor=es()?Pg:Math.floor(Math.random()*qc.length)),mg(Zt),xs=-1,jc(Zt,ke),br(ke),Zc(Zt,Ce.map(o=>o.effect)),og(Zt,bs&&!t),je.duck(Ce.length>0),lg(Zt,We===vn-1,we!=="return"),cg(Zt,we==="return"&&We===0),ug(Zt,we!=="return"),hg(Zt,we==="return"),Vt.x=0,Vt.z=-.5,ae.yaw=0,ae.pitch=0;const a=t?`퇴근길 — ${Ct.segLabel(We+1,vn,Re)}`:we==="return"?`${Ct.nightLabel(De)} — 돌아가는 길 ${Ct.segLabel(We+1,vn,Re)}`:`${Ct.nightLabel(De)} — ${Ct.segLabel(We+1,vn,Re)}`;n?$t.setStatusFold(a):$t.setStatus(a)}const hn={move:!1,gaze:!1,avert:!1,hintZ:0},Fo=()=>ae.usesTouch||"ontouchstart"in window;function Oo(){We=0,vn=kt.segments,Re=1,ke=0,lr=0,Ai=0,bs=!1,wr=0,oo=new Set,lo=0,un=0,Wi=!1,xs=-1}async function Lg(){we="tutorial",Oo(),We=kt.segments-2,Re=kt.segments-1,Lo(Zt,!0),Lr(),Vt.z=-36*.24,Pe="walk",xi=0,hn.move||(hn.hintZ=Vt.z,$t.showHint(Fo()?Ct.hintMoveTouch:Ct.hintMovePc))}async function Bo(){we="return",Oo(),Re=kt.segments,Lo(Zt,!1),Lr(),Pe="walk",$t.say(nr(De).intro,4200),nr(De).onboarding&&!hn.move&&(hn.hintZ=Vt.z,$t.showHint(Fo()?Ct.hintMoveTouch:Ct.hintMovePc))}async function nu(){nr(De).onboarding&&!No&&(Rg||!ce.tut)?await Lg():await Bo()}async function zo(){Pe="transition",await $t.fadeOut(1400),await $t.blackScreen(Ct.softFail,Ct.softFailBtn),ae.activate(),await nu(),await $t.fadeIn(900)}async function Dg(){Pe="transition",await $t.fadeOut(800),await $t.blackScreen(Ct.tutShopArrive,Ct.tutShopBtn),ce.tut=!0,or(),await $t.blackScreen(Ct.tutDusk,Ct.tutDuskBtn),ae.activate(),await Bo(),await $t.fadeIn(1100)}async function Ig(){Pe="transition",await $t.fadeOut(800);const n=w0(lr),t=n==="crispy"?Ct.homeCrispy:n==="lukewarm"?Ct.homeLukewarm:Ct.homeSoggy;ce.results[De-1]=n,ce.night=De+1,or(),await $t.blackScreen(Ct.homeArrive,Ct.homeOpen);const e=De>Ei?"…도장 찍을 칸이, 이제 없다":`도장 ${"●".repeat(De)}${"○".repeat(Ei-De)}`;await $t.arrivalScene({gauge:`${Ct.homeGauge[n]} · ${e}`,result:t,epilogue:nr(De).epilogue,steps:[Ct.homeSit,Ct.homeEnd],endLabel:Ct.homeEnd,bg:n==="crispy"?"#181008":n==="lukewarm"?"#100e12":"#0a0d16",onBite:()=>{}}),ae.activate(),De+=1,await $t.blackScreen(Ct.nightOpen(De),Ct.nightOpenBtn),ae.activate(),await Bo(),await $t.fadeIn(900)}async function Ug(){Pe==="walk"&&(Pe="transition",us(Zt,1,we==="tutorial"?.008:.044),je.duck(!0),await new Promise(n=>setTimeout(n,900)),ae.yaw=0,ae.pitch=0,Vt.z=Ve*.42,$t.say(Ct.turnedBack,3400),Pe="walk")}async function Ng(){Pe==="walk"&&await ko(we==="tutorial"?Ct.carHitDay:Ct.carHit)}async function ko(n){if(Pe==="walk"){if(Pe="transition",un=0,Wi=!1,lr+=1,vn+=1,ke+=kt.foldDepthCost,Ai=Math.min(kt.swarmMax,Ai+1),ce.misses+=1,or(),je.duck(!0),await $t.fadeOut(700),We+=1,ke>=kt.depthLimit){await zo();return}bs=!0,Lr(!0),$t.say(we==="tutorial"?n:`${n}
${Ct.foldNotice}`,3800),Pe="walk",await $t.fadeIn(700)}}async function Fg(){let n=!1;const t=Ce.filter(e=>e.rule==="gaze"&&!Wn.has(e.id));if(t.length>0&&(lr+=1,vn+=1,ke+=kt.foldDepthCost,Ai=Math.min(kt.swarmMax,Ai+1),ce.misses+=1,or(),n=!0,$t.say(`${t[0].reveal}
${Ct.foldNotice}`,3800),je.duck(!0)),We+=1,ke>=kt.depthLimit){await zo();return}if(We>=vn){we==="tutorial"?await Dg():await Ig();return}bs=n,n||(Re=we==="return"?Math.max(Re-1,1):Math.min(Re+1,kt.segments)),Lr(n),Vt.z=Ve/2}const ic=new Ao,hs=new Xt,Ze=new F;function rc(n){if(ic.setFromCamera(hs,re),ic.intersectObjects(n,!0).length>0)return!0;for(const t of n)if(t.getWorldPosition(Ze),!(Ze.distanceTo(re.position)>45)&&(Ze.project(re),Ze.z<1&&Math.hypot(Ze.x-hs.x,Ze.y-hs.y)<.12))return!0;return!1}function co(n){let t=1/0;for(const e of n)e.getWorldPosition(Ze),t=Math.min(t,Ze.distanceTo(re.position));return t}const Ki=new sr,vr=new F,sc=new F,ns=new F;function ac(){let n=null;for(const t of Ce)if(!(t.rule!=="gaze"||Wn.has(t.id)))for(const e of Zt.hit[t.effect])e.traverse(i=>{if(!i.isMesh)return;i.getWorldPosition(Ze);const r=Ze.distanceTo(re.position);(!n||r<n.dist)&&(n={obj:i,dist:r})});return n}function Og(n){re.getWorldDirection(sc);let t=1/0,e=1/0;for(const i of n){if(!i.visible||(Ki.setFromObject(i),Ki.isEmpty()))continue;Ki.getCenter(vr),ns.subVectors(vr,re.position);const r=ns.length();if(r<.01)continue;t=Math.min(t,r),ns.divideScalar(r);const s=Math.max(-1,Math.min(1,ns.dot(sc)));e=Math.min(e,Math.acos(s)*180/Math.PI)}return{dist:t,deg:e}}const oc=new Ao;function Bg(n,t){for(let e=n;e;e=e.parent)if(e===t)return!0;return!1}function zg(n){for(let t=n;t;t=t.parent)if(!t.visible)return!1;return!0}function kg(){return Ce.map(n=>{const t=Zt.hit[n.effect],e=[];for(const a of t)a.traverse(o=>{o.isMesh&&e.push(o)});let i=!1,r=1/0,s=null;for(const a of e){if(Ki.setFromObject(a),Ki.isEmpty())continue;Ki.getCenter(vr),r=Math.min(r,vr.distanceTo(re.position)),oc.set(re.position,vr.clone().sub(re.position).normalize());const o=oc.intersectObject(Ts,!0).find(l=>zg(l.object));o&&t.some(l=>Bg(o.object,l))?i=!0:s===null&&o&&(s=Math.round(o.distance*10)/10)}return{id:n.id,rule:n.rule,parts:e.length,dist:Math.round(r*10)/10,clear:i,blockedAt:i?null:s}})}function iu(n,t,e=!1){if(Pe!=="walk"||vs>0||Ti.active)return;if(vs=kt.spotCooldownSec,hs.set(n/window.innerWidth*2-1,-(t/window.innerHeight)*2+1),we==="tutorial"){$t.say(Ct.spotMorning,2600);return}const i=()=>{Zc(Zt,Ce.filter(a=>!Wn.has(a.id)).map(a=>a.effect))},r=Ce.find(a=>a.rule==="avert");if(r&&(e||rc(Zt.hit[r.effect]))){ko(Ct.avertPoint);return}const s=Ce.filter(a=>a.rule==="gaze"&&!Wn.has(a.id));if(e&&s.length>0){Wn.add(s[0].id),i(),$t.say(Ct.spotOk,3e3);return}for(const a of s)if(rc(Zt.hit[a.effect])){if(co(Zt.hit[a.effect])>kt.checkDistance){$t.say(Ct.tooFar,2200);return}Wn.add(a.id),i(),$t.say(Ct.spotOk,3e3);return}Ce.some(a=>a.rule==="gaze")&&s.length===0||(ke+=kt.wasteDepthCost,jc(Zt,ke),br(ke),$t.say(Ct.spotWaste,3e3),ke>=kt.depthLimit&&zo())}ae.onPoint=(n,t)=>iu(n,t);const Qn=document.getElementById("walk-btn");if(Qn){let t=null;const e={x:0,y:0},i=r=>{r.pointerId===t&&(t=null,ae.touchForward=0,ae.touchStrafe=0,Qn.classList.remove("held"))};Qn.addEventListener("pointerdown",r=>{t=r.pointerId,ae.usesTouch=!0,ae.touchForward=1,ae.touchStrafe=0,e.x=r.clientX,e.y=r.clientY,Qn.classList.add("held"),Qn.setPointerCapture(r.pointerId)}),Qn.addEventListener("pointermove",r=>{if(r.pointerId!==t)return;const s=r.clientX-e.x,a=r.clientY-e.y,o=Math.abs(a)>=16?-Math.sign(a):0,l=Math.abs(s)>=16?Math.sign(s):0;ae.touchForward=o===0&&l===0?1:o,ae.touchStrafe=l}),Qn.addEventListener("pointerup",i),Qn.addEventListener("pointercancel",i)}const is=kt.corridorHalfWidth;function Hg(n){if(Ti.active){Ti.fly(n,ae.yaw,ae.pitch,p=>ae.isDown(p));const f=we==="tutorial"?.008:.044;if(Ti.clearView)us(Zt,0,.004);else{const p=Math.max(We===vn-1?0:Math.max(0,(-36-re.position.z)/Ve),Math.max(0,re.position.z/Ve));us(Zt,Math.min(1,p*2),f)}re.rotation.set(0,0,0),re.rotateY(ae.yaw),re.rotateX(ae.pitch),ha=!0;return}ha&&(ha=!1,Vt.x=Math.max(-is+.4,Math.min(is-.4,re.position.x)),Vt.z=Math.max(-36+.6,Math.min(Ve-.7,re.position.z)),un=0,Wi=!1),wr+=n;const t=ae.getMove(),e=Math.abs(t.forward)+Math.abs(t.strafe)>.1;je.update(n,e);const i=we==="tutorial"?.008:.044+Math.min(.018,wr/60*.0035)+Math.min(.02,ke*.0035),s=We===vn-1?0:Math.max(0,(-36-Vt.z)/Ve),a=Math.max(0,Vt.z/Ve);us(Zt,Math.min(1,Math.max(s,a)*2),i);const o=Math.sin(ae.yaw),l=Math.cos(ae.yaw),c=t.forward*kt.walkSpeed*(t.forward<0?kt.backFactor:1),u=t.strafe*kt.walkSpeed*kt.strafeFactor;if(Vt.x+=(o*-c+l*u)*n,Vt.z+=(-l*c-o*u)*n,Vt.x=Math.max(-is+.4,Math.min(is-.4,Vt.x)),Vt.z=Math.min(Ve-.7,Vt.z),vs=Math.max(0,vs-n),we==="tutorial"){for(;xi<Ct.tutBeats.length&&Ct.tutBeats[xi].theme<Re;)xi+=1;const f=Ct.tutBeats[xi];f&&f.theme===Re&&Vt.z<=f.z&&($t.say(f.text,3600),xi+=1)}if(Re===4){const f=Vt.z<O0&&Vt.z>Se-Tn-1,p=Math.floor(Zi/Co);if(!ms(Zi)&&xs!==p&&(xs=p,gg(Zt,Zi,p%2===0?1:-1),je.carPass(Gc),we!=="tutorial"&&f&&$t.say(Ct.carComing,2e3)),f&&_g(Zt)&&Math.abs(Vt.z-Zt.car.position.z)<2.4){Ng();return}}let h=!1;for(const f of Cg?[]:Ce){if(f.rule!=="avert")continue;const{dist:p,deg:_}=Og(Zt.hit[f.effect]);if(p<=kt.avertDistance&&_<=kt.avertAngleDeg){h=!0;break}}if(h){if(un+=n,!Wi&&un>=kt.avertWarnSec&&(Wi=!0,$t.say(Ct.avertWarn,2400),je.duck(!0)),br(ke+un/kt.avertGrabSec*3),un>=kt.avertGrabSec){ko(Ct.avertGrab);return}}else un>0&&(un=Math.max(0,un-n*kt.avertRecoverMul),br(ke+un/kt.avertGrabSec*3),un===0&&(Wi=!1,je.duck(Ce.length>0)));if(nr(De).onboarding&&(!hn.move&&hn.hintZ-Vt.z>6&&(hn.move=!0,$t.hideHint()),hn.move&&!hn.gaze&&Ce.some(p=>p.rule==="gaze"&&!Wn.has(p.id)&&co(Zt.hit[p.effect])<12)&&(hn.gaze=!0,$t.showHint(Fo()?Ct.hintGazeTouch:Ct.hintGazePc,5600)),hn.move&&!hn.avert&&Ce.some(p=>p.rule==="avert"&&co(Zt.hit[p.effect])<18)&&(hn.avert=!0,$t.showHint(Ct.hintAvert,6e3))),Vt.z>=Ve*.62){Ug();return}if(Vt.z<V0&&Math.abs(Vt.x)<_r+.4){Fg();return}if(Vt.z<-36+.5&&Math.abs(Vt.x)>=_r&&(Vt.z=-36+.5),Vt.z>-.5&&Math.abs(Vt.x)>=_r&&(Vt.z=-.5),Vt.z<-36||Vt.z>0){const f=Vc-.25;Vt.x=Math.max(-f,Math.min(f,Vt.x))}re.position.set(Vt.x,1.65,Vt.z),re.rotation.set(0,0,0),re.rotateY(ae.yaw),re.rotateX(ae.pitch)}let Zi=0;function ru(){const n=Math.min(_s.getDelta(),.1);Zi+=n,Pe==="walk"&&Hg(n),$t.setReticle(Pe==="walk"),Ti.update(),pg(Zt,Zi),An.render(Ts,re),requestAnimationFrame(ru)}async function Gg(){Pe!=="walk"||ua||(ua=!0,Pe="transition",je.suspend(),await $t.blackScreen("…잠깐 골목 구석에서 숨을 골랐다.","계속 걷는다"),je.resume(),ae.activate(),Pe="walk",ua=!1)}Io.classList.remove("hidden");const da=document.getElementById("settings-panel");var lc;(lc=document.getElementById("settings-btn"))==null||lc.addEventListener("click",()=>{da==null||da.classList.toggle("open")});const fa=document.getElementById("continue-info"),Mi=document.getElementById("reset-btn"),Vg="기록 삭제 · 처음부터";function su(){if(!fa||!Mi)return;const n=yg();if(fa.style.display=n?"block":"none",Mi.style.display=n?"inline-block":"none",n){const e=ce.misses>0?` 그동안 ${ce.misses}번, 골목 입구로 돌아왔다.`:"";fa.textContent=`이어하기 — ${Ct.nightLabel(ce.night)}.${e}`}const t=document.getElementById("start-btn");t&&(t.textContent=ce.tut?Ct.startBtnResume:Ct.startBtnFirst),Wg()}function Wg(){const n=document.getElementById("coupon"),t=document.querySelector("#coupon .c-stamps"),e=document.querySelector("#coupon .c-note");if(!n||!t||!e)return;n.style.display=ce.night>1?"flex":"none";const i=ce.night-1,r=Math.min(i,Ei);t.innerHTML="●".repeat(r)+`<span class="empty">${"○".repeat(Ei-r)}</span>`+(i>Ei?" ●":""),e.textContent=i>Ei?Ct.couponOverflow:"밤마다 하나씩"}let pa=!1;Mi==null||Mi.addEventListener("click",()=>{if(!pa){pa=!0,Mi.textContent="정말 삭제할까요? (한 번 더 누르면 삭제)";return}Sg(),pa=!1,Mi.textContent=Vg,De=ce.night,ti&&(ti.value=String(ce.brightness),An.toneMappingExposure=ce.brightness*ao),Uo(),su()});su();document.getElementById("start-btn").addEventListener("click",async()=>{var t;if(ir)return;document.getElementById("start").classList.add("hidden"),ir=!0,(t=document.activeElement)==null||t.blur(),je.start(),ae.activate(),Ho(),history.pushState({fries:1},""),await nu()});window.addEventListener("popstate",()=>{ir&&(history.pushState({fries:1},""),Gg())});window.addEventListener("beforeunload",n=>{ir&&Pe==="walk"&&n.preventDefault()});function Ho(){var t;(t=navigator.wakeLock)==null||t.request("screen").catch(()=>{})}document.addEventListener("visibilitychange",()=>{document.hidden?(_s.stop(),je.suspend()):(_s.start(),je.resume(),ir&&Ho())});window.addEventListener("pageshow",n=>{n.persisted&&(_s.start(),je.resume(),ir&&Ho())});document.addEventListener("gesturestart",n=>n.preventDefault());An.domElement.addEventListener("contextmenu",n=>n.preventDefault());window.addEventListener("resize",()=>{re.aspect=window.innerWidth/window.innerHeight,re.updateProjectionMatrix(),An.setSize(window.innerWidth,window.innerHeight)});window.__fries={state:()=>({phase:Pe,mode:we,night:De,done:We,total:vn,theme:Re,depth:ke,folds:lr,swarm:Ai,active:Ce.length,checked:Wn.size,avert:Ce.filter(n=>n.rule==="avert").length,gazeNear:(()=>{const n=ac();return n?Math.round(n.dist*10)/10:null})(),gazeAim:(()=>{const n=ac();return!n||(n.obj.getWorldPosition(Ze),Ze.project(re),Ze.z>=1)?null:{x:Math.round((Ze.x+1)/2*1e3)/1e3,y:Math.round((1-Ze.y)/2*1e3)/1e3}})(),stare:Math.round(un*100)/100,green:ms(Zi),carX:Zt.car.visible?Math.round(Zt.car.position.x*10)/10:null,elapsed:Math.round(wr*10)/10,x:Math.round(Vt.x*100)/100,z:Math.round(Vt.z*100)/100}),config:()=>({...kt}),admin:{on:()=>Ti.active,cam:()=>({x:re.position.x,y:re.position.y,z:re.position.z}),toggle:()=>Ti.toggle()},...No!==null?{debugSpot:()=>iu(window.innerWidth/2,window.innerHeight/2,!0),occlusion:()=>kg()}:{}};re.position.set(0,1.65,0);ru();
