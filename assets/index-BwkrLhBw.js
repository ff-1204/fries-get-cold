...
`+ym(n.getShaderSource(t),a)}else return r}function bm(n,t){const e=Tm(t);return[`vec4 ${n}( vec4 value ) {`,`	return ${e[1]}( vec4( value.rgb * ${e[0]}, value.a ) );`,"}"].join(`
