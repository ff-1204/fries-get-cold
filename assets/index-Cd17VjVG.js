...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Fn,depthTest:!1,depthWrite:!1})}function zo(){return new zn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Ga(),fragmentShader:`
		...
		`,blending:Fn,depthTest:!1,depthWrite:!1})}function Ho(){return new zn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ga(),fragmentShader:`
	...
	`}function Ff(i){let e=new WeakMap,t=null;function n(o){if(o&&o.isTexture){const l=o.mapping,c=l===Vs||l===Ws,h=l===Ci||l===Pi;if(c||h){let d=e.get(o);const f=d!==void 0?d.texture.pmremVersion:0;if(o.isRenderTargetTexture&&o.pmremVersion!==f)return t===null&&(t=new Oo(i)),d=c?t.fromEquirectangular(o,d):t.fromCubemap(o,d),d.texture.pmremVersion=o.pmremVersion,e.set(o,d),d.texture;if(d!==void 0)return d.texture;{const m=o.image;return c&&m&&m.height>0||h&&m&&r(m)?(t===null&&(t=new Oo(i)),d=c?t.fromEquirectangular(o):t.fromCubemap(o),d.texture.pmremVersion=o.pmremVersion,e.set(o,d),o.addEventListener("dispose",s),d.texture):null}}}return o}function r(o){let l=0;const c=6;for(let h=0;h<c;h++)o[h]!==void 0&&l++;return l===c}function s(o){const l=o.target;l.removeEventListener("dispose",s);const c=e.get(l);c!==void 0&&(e.delete(l),c.dispose())}function a(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:n,dispose:a}}function Of(i){const e={};function t(n){if(e[n]!==void 0)return e[n];let r;switch(n){case"WEBGL_depth_texture":r=i.getExtension("WEBGL_depth_texture")||i.getExtension("MOZ_WEBGL_depth_texture")||i.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":r=i.getExtension("EXT_texture_filter_anisotropic")||i.getExtension("MOZ_EXT_texture_filter_anisotropic")||i.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":r=i.getExtension("WEBGL_compressed_texture_s3tc")||i.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":r=i.getExtension("WEBGL_compressed_texture_pvrtc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:r=i.getExtension(n)}return e[n]=r,r}return{has:function(n){return t(n)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(n){const r=t(n);return r===null&&Ti("THREE.WebGLRenderer: "+n+" extension not supported."),r}}}function Bf(i,e,t,n){const r={},s=new WeakMap;function a(d){const f=d.target;f.index!==null&&e.remove(f.index);for(const v in f.attributes)e.remove(f.attributes[v]);f.removeEventListener("dispose",a),delete r[f.id];const m=s.get(f);m&&(e.remove(m),s.delete(f)),n.releaseStatesOfGeometry(f),f.isInstancedBufferGeometry===!0&&delete f._maxInstanceCount,t.memory.geometries--}function o(d,f){return r[f.id]===!0||(f.addEventListener("dispose",a),r[f.id]=!0,t.memory.geometries++),f}function l(d){const f=d.attributes;for(const m in f)e.update(f[m],i.ARRAY_BUFFER)}function c(d){const f=[],m=d.index,v=d.attributes.position;let M=0;if(m!==null){const A=m.array;M=m.version;for(let T=0,E=A.length;T<E;T+=3){const L=A[T+0],R=A[T+1],w=A[T+2];f.push(L,R,R,w,w,L)}}else if(v!==void 0){const A=v.array;M=v.version;for(let T=0,E=A.length/3-1;T<E;T+=3){const L=T+0,R=T+1,w=T+2;f.push(L,R,R,w,w,L)}}else return;const p=new(Ll(f)?Fl:Nl)(f,1);p.version=M;const u=s.get(d);u&&e.remove(u),s.set(d,p)}function h(d){const f=s.get(d);if(f){const m=d.index;m!==null&&f.version<m.version&&c(d)}else c(d);return s.get(d)}return{get:o,update:l,getWireframeAttribute:h}}function zf(i,e,t){let n;function r(f){n=f}let s,a;function o(f){s=f.type,a=f.bytesPerElement}function l(f,m){i.drawElements(n,m,s,f*a),t.update(m,n,1)}function c(f,m,v){v!==0&&(i.drawElementsInstanced(n,m,s,f*a,v),t.update(m,n,v))}function h(f,m,v){if(v===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,m,0,s,f,0,v);let p=0;for(let u=0;u<v;u++)p+=m[u];t.update(p,n,1)}function d(f,m,v,M){if(v===0)return;const p=e.get("WEBGL_multi_draw");if(p===null)for(let u=0;u<f.length;u++)c(f[u]/a,m[u],M[u]);else{p.multiDrawElementsInstancedWEBGL(n,m,0,s,f,0,M,0,v);let u=0;for(let A=0;A<v;A++)u+=m[A]*M[A];t.update(u,n,1)}}this.setMode=r,this.setIndex=o,this.render=l,this.renderInstances=c,this.renderMultiDraw=h,this.renderMultiDrawInstances=d}function Hf(i){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(s,a,o){switch(t.calls++,a){case i.TRIANGLES:t.triangles+=o*(s/3);break;case i.LINES:t.lines+=o*(s/2);break;case i.LINE_STRIP:t.lines+=o*(s-1);break;case i.LINE_LOOP:t.lines+=o*s;break;case i.POINTS:t.points+=o*s;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",a);break}}function r(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:r,update:n}}function Gf(i,e,t){const n=new WeakMap,r=new tt;function s(a,o,l){const c=a.morphTargetInfluences,h=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,d=h!==void 0?h.length:0;let f=n.get(o);if(f===void 0||f.count!==d){let x=function(){D.dispose(),n.delete(o),o.removeEventListener("dispose",x)};var m=x;f!==void 0&&f.texture.dispose();const v=o.morphAttributes.position!==void 0,M=o.morphAttributes.normal!==void 0,p=o.morphAttributes.color!==void 0,u=o.morphAttributes.position||[],A=o.morphAttributes.normal||[],T=o.morphAttributes.color||[];let E=0;v===!0&&(E=1),M===!0&&(E=2),p===!0&&(E=3);let L=o.attributes.position.count*E,R=1;L>e.maxTextureSize&&(R=Math.ceil(L/e.maxTextureSize),L=e.maxTextureSize);const w=new Float32Array(L*R*4*d),D=new Dl(w,L,R,d);D.type=En,D.needsUpdate=!0;const S=E*4;for(let C=0;C<d;C++){const H=u[C],O=A[C],W=T[C],K=L*R*4*C;for(let G=0;G<H.count;G++){const Z=G*S;v===!0&&(r.fromBufferAttribute(H,G),w[K+Z+0]=r.x,w[K+Z+1]=r.y,w[K+Z+2]=r.z,w[K+Z+3]=0),M===!0&&(r.fromBufferAttribute(O,G),w[K+Z+4]=r.x,w[K+Z+5]=r.y,w[K+Z+6]=r.z,w[K+Z+7]=0),p===!0&&(r.fromBufferAttribute(W,G),w[K+Z+8]=r.x,w[K+Z+9]=r.y,w[K+Z+10]=r.z,w[K+Z+11]=W.itemSize===4?r.w:1)}}f={count:d,texture:D,size:new We(L,R)},n.set(o,f),o.addEventListener("dispose",x)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)l.getUniforms().setValue(i,"morphTexture",a.morphTexture,t);else{let v=0;for(let p=0;p<c.length;p++)v+=c[p];const M=o.morphTargetsRelative?1:1-v;l.getUniforms().setValue(i,"morphTargetBaseInfluence",M),l.getUniforms().setValue(i,"morphTargetInfluences",c)}l.getUniforms().setValue(i,"morphTargetsTexture",f.texture,t),l.getUniforms().setValue(i,"morphTargetsTextureSize",f.size)}return{update:s}}function kf(i,e,t,n){let r=new WeakMap;function s(l){const c=n.render.frame,h=l.geometry,d=e.get(l,h);if(r.get(d)!==c&&(e.update(d),r.set(d,c)),l.isInstancedMesh&&(l.hasEventListener("dispose",o)===!1&&l.addEventListener("dispose",o),r.get(l)!==c&&(t.update(l.instanceMatrix,i.ARRAY_BUFFER),l.instanceColor!==null&&t.update(l.instanceColor,i.ARRAY_BUFFER),r.set(l,c))),l.isSkinnedMesh){const f=l.skeleton;r.get(f)!==c&&(f.update(),r.set(f,c))}return d}function a(){r=new WeakMap}function o(l){const c=l.target;c.removeEventListener("dispose",o),t.remove(c.instanceMatrix),c.instanceColor!==null&&t.remove(c.instanceColor)}return{update:s,dispose:a}}const Wl=new Ct,Go=new Hl(1,1),Xl=new Dl,ql=new hu,Yl=new zl,ko=[],Vo=[],Wo=new Float32Array(16),Xo=new Float32Array(9),qo=new Float32Array(4);function Ni(i,e,t){const n=i[0];if(n<=0||n>0)return i;const r=e*t;let s=ko[r];if(s===void 0&&(s=new Float32Array(r),ko[r]=s),e!==0){n.toArray(s,0);for(let a=1,o=0;a!==e;++a)o+=t,i[a].toArray(s,o)}return s}function vt(i,e){if(i.length!==e.length)return!1;for(let t=0,n=i.length;t<n;t++)if(i[t]!==e[t])return!1;return!0}function xt(i,e){for(let t=0,n=e.length;t<n;t++)i[t]=e[t]}function Xr(i,e){let t=Vo[e];t===void 0&&(t=new Int32Array(e),Vo[e]=t);for(let n=0;n!==e;++n)t[n]=i.allocateTextureUnit();return t}function Vf(i,e){const t=this.cache;t[0]!==e&&(i.uniform1f(this.addr,e),t[0]=e)}function Wf(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(vt(t,e))return;i.uniform2fv(this.addr,e),xt(t,e)}}function Xf(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(i.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(vt(t,e))return;i.uniform3fv(this.addr,e),xt(t,e)}}function qf(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(vt(t,e))return;i.uniform4fv(this.addr,e),xt(t,e)}}function Yf(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(vt(t,e))return;i.uniformMatrix2fv(this.addr,!1,e),xt(t,e)}else{if(vt(t,n))return;qo.set(n),i.uniformMatrix2fv(this.addr,!1,qo),xt(t,n)}}function Kf(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(vt(t,e))return;i.uniformMatrix3fv(this.addr,!1,e),xt(t,e)}else{if(vt(t,n))return;Xo.set(n),i.uniformMatrix3fv(this.addr,!1,Xo),xt(t,n)}}function $f(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(vt(t,e))return;i.uniformMatrix4fv(this.addr,!1,e),xt(t,e)}else{if(vt(t,n))return;Wo.set(n),i.uniformMatrix4fv(this.addr,!1,Wo),xt(t,n)}}function Zf(i,e){const t=this.cache;t[0]!==e&&(i.uniform1i(this.addr,e),t[0]=e)}function jf(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(vt(t,e))return;i.uniform2iv(this.addr,e),xt(t,e)}}function Jf(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(vt(t,e))return;i.uniform3iv(this.addr,e),xt(t,e)}}function Qf(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(vt(t,e))return;i.uniform4iv(this.addr,e),xt(t,e)}}function ep(i,e){const t=this.cache;t[0]!==e&&(i.uniform1ui(this.addr,e),t[0]=e)}function tp(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(vt(t,e))return;i.uniform2uiv(this.addr,e),xt(t,e)}}function np(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(vt(t,e))return;i.uniform3uiv(this.addr,e),xt(t,e)}}function ip(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(vt(t,e))return;i.uniform4uiv(this.addr,e),xt(t,e)}}function rp(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r);let s;this.type===i.SAMPLER_2D_SHADOW?(Go.compareFunction=Pl,s=Go):s=Wl,t.setTexture2D(e||s,r)}function sp(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTexture3D(e||ql,r)}function ap(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTextureCube(e||Yl,r)}function op(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTexture2DArray(e||Xl,r)}function lp(i){switch(i){case 5126:return Vf;case 35664:return Wf;case 35665:return Xf;case 35666:return qf;case 35674:return Yf;case 35675:return Kf;case 35676:return $f;case 5124:case 35670:return Zf;case 35667:case 35671:return jf;case 35668:case 35672:return Jf;case 35669:case 35673:return Qf;case 5125:return ep;case 36294:return tp;case 36295:return np;case 36296:return ip;case 35678:case 36198:case 36298:case 36306:case 35682:return rp;case 35679:case 36299:case 36307:return sp;case 35680:case 36300:case 36308:case 36293:return ap;case 36289:case 36303:case 36311:case 36292:return op}}function cp(i,e){i.uniform1fv(this.addr,e)}function up(i,e){const t=Ni(e,this.size,2);i.uniform2fv(this.addr,t)}function hp(i,e){const t=Ni(e,this.size,3);i.uniform3fv(this.addr,t)}function dp(i,e){const t=Ni(e,this.size,4);i.uniform4fv(this.addr,t)}function fp(i,e){const t=Ni(e,this.size,4);i.uniformMatrix2fv(this.addr,!1,t)}function pp(i,e){const t=Ni(e,this.size,9);i.uniformMatrix3fv(this.addr,!1,t)}function mp(i,e){const t=Ni(e,this.size,16);i.uniformMatrix4fv(this.addr,!1,t)}function gp(i,e){i.uniform1iv(this.addr,e)}function _p(i,e){i.uniform2iv(this.addr,e)}function vp(i,e){i.uniform3iv(this.addr,e)}function xp(i,e){i.uniform4iv(this.addr,e)}function Mp(i,e){i.uniform1uiv(this.addr,e)}function Sp(i,e){i.uniform2uiv(this.addr,e)}function Ep(i,e){i.uniform3uiv(this.addr,e)}function yp(i,e){i.uniform4uiv(this.addr,e)}function Tp(i,e,t){const n=this.cache,r=e.length,s=Xr(t,r);vt(n,s)||(i.uniform1iv(this.addr,s),xt(n,s));for(let a=0;a!==r;++a)t.setTexture2D(e[a]||Wl,s[a])}function Ap(i,e,t){const n=this.cache,r=e.length,s=Xr(t,r);vt(n,s)||(i.uniform1iv(this.addr,s),xt(n,s));for(let a=0;a!==r;++a)t.setTexture3D(e[a]||ql,s[a])}function bp(i,e,t){const n=this.cache,r=e.length,s=Xr(t,r);vt(n,s)||(i.uniform1iv(this.addr,s),xt(n,s));for(let a=0;a!==r;++a)t.setTextureCube(e[a]||Yl,s[a])}function wp(i,e,t){const n=this.cache,r=e.length,s=Xr(t,r);vt(n,s)||(i.uniform1iv(this.addr,s),xt(n,s));for(let a=0;a!==r;++a)t.setTexture2DArray(e[a]||Xl,s[a])}function Rp(i){switch(i){case 5126:return cp;case 35664:return up;case 35665:return hp;case 35666:return dp;case 35674:return fp;case 35675:return pp;case 35676:return mp;case 5124:case 35670:return gp;case 35667:case 35671:return _p;case 35668:case 35672:return vp;case 35669:case 35673:return xp;case 5125:return Mp;case 36294:return Sp;case 36295:return Ep;case 36296:return yp;case 35678:case 36198:case 36298:case 36306:case 35682:return Tp;case 35679:case 36299:case 36307:return Ap;case 35680:case 36300:case 36308:case 36293:return bp;case 36289:case 36303:case 36311:case 36292:return wp}}class Cp{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=lp(t.type)}}class Pp{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=Rp(t.type)}}class Lp{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const r=this.seq;for(let s=0,a=r.length;s!==a;++s){const o=r[s];o.setValue(e,t[o.id],n)}}}const Rs=/(\w+)(\])?(\[|\.)?/g;function Yo(i,e){i.seq.push(e),i.map[e.id]=e}function Dp(i,e,t){const n=i.name,r=n.length;for(Rs.lastIndex=0;;){const s=Rs.exec(n),a=Rs.lastIndex;let o=s[1];const l=s[2]==="]",c=s[3];if(l&&(o=o|0),c===void 0||c==="["&&a+2===r){Yo(t,c===void 0?new Cp(o,i,e):new Pp(o,i,e));break}else{let d=t.map[o];d===void 0&&(d=new Lp(o),Yo(t,d)),t=d}}}class Ir{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let r=0;r<n;++r){const s=e.getActiveUniform(t,r),a=e.getUniformLocation(t,s.name);Dp(s,a,this)}}setValue(e,t,n,r){const s=this.map[t];s!==void 0&&s.setValue(e,n,r)}setOptional(e,t,n){const r=t[n];r!==void 0&&this.setValue(e,n,r)}static upload(e,t,n,r){for(let s=0,a=t.length;s!==a;++s){const o=t[s],l=n[o.id];l.needsUpdate!==!1&&o.setValue(e,l.value,r)}}static seqWithValue(e,t){const n=[];for(let r=0,s=e.length;r!==s;++r){const a=e[r];a.id in t&&n.push(a)}return n}}function Ko(i,e,t){const n=i.createShader(e);return i.shaderSource(n,t),i.compileShader(n),n}const Up=37297;let Ip=0;function Np(i,e){const t=i.split(`
`),n=[],r=Math.max(e-6,0),s=Math.min(e+6,t.length);for(let a=r;a<s;a++){const o=a+1;n.push(`${o===e?">":" "} ${o}: ${t[a]}`)}return n.join(`
`)}const $o=new Be;function Fp(i){Ke._getMatrix($o,Ke.workingColorSpace,i);const e=`mat3( ${$o.elements.map(t=>t.toFixed(4))} )`;switch(Ke.getTransfer(i)){case Or:return[e,"LinearTransferOETF"];case et:return[e,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space: ",i),[e,"LinearTransferOETF"]}}function Zo(i,e,t){const n=i.getShaderParameter(e,i.COMPILE_STATUS),r=i.getShaderInfoLog(e).trim();if(n&&r==="")return"";const s=/ERROR: 0:(\d+)/.exec(r);if(s){const a=parseInt(s[1]);return t.toUpperCase()+`
...
`)}function Bp(i,e){let t;switch(e){case Bc:t="Linear";break;case zc:t="Reinhard";break;case Hc:t="Cineon";break;case xl:t="ACESFilmic";break;case kc:t="AgX";break;case Vc:t="Neutral";break;case Gc:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const wr=new N;function zp(){Ke.getLuminanceCoefficients(wr);const i=wr.x.toFixed(4),e=wr.y.toFixed(4),t=wr.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
#define LOW_PRECISION`),e}function Kp(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===_l?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===_c?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===xn&&(e="SHADOWMAP_TYPE_VSM"),e}function $p(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case Ci:case Pi:e="ENVMAP_TYPE_CUBE";break;case Wr:e="ENVMAP_TYPE_CUBE_UV";break}return e}function Zp(i){let e="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case Pi:e="ENVMAP_MODE_REFRACTION";break}return e}function jp(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case vl:e="ENVMAP_BLENDING_MULTIPLY";break;case Fc:e="ENVMAP_BLENDING_MIX";break;case Oc:e="ENVMAP_BLENDING_ADD";break}return e}function Jp(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function Qp(i,e,t,n){const r=i.getContext(),s=t.defines;let a=t.vertexShader,o=t.fragmentShader;const l=Kp(t),c=$p(t),h=Zp(t),d=jp(t),f=Jp(t),m=Hp(t),v=Gp(s),M=r.createProgram();let p,u,A=t.glslVersion?"#version "+t.glslVersion+`
...
한 장은 오늘 날짜. 한 장은, 내일 날짜.`,"…내일은, 안 나가도 되면 좋겠다."],tasteEnd:"불을 끄고 눕는다"};function Cm(i){return i<=0?"crispy":i<=2?"lukewarm":"soggy"}function Pm(i){return 1+Math.min(mt.swarmMax,i)}class Lm{constructor(e){this.yaw=0,this.pitch=0,this.onPoint=null,this.touchForward=0,this.touchRun=!1,this.keys=new Set,this.locked=!1,this.lookTouch=null,this.tapCandidate=null,this.usesTouch=!1,this.canvas=e,window.addEventListener("keydown",t=>this.keys.add(t.code)),window.addEventListener("keyup",t=>this.keys.delete(t.code)),window.addEventListener("blur",()=>this.keys.clear()),document.addEventListener("pointerlockchange",()=>{this.locked=document.pointerLockElement===this.canvas}),document.addEventListener("mousemove",t=>{this.locked&&this.applyLook(t.movementX,t.movementY)}),e.addEventListener("pointerdown",t=>this.onPointerDown(t)),e.addEventListener("pointermove",t=>this.onPointerMove(t)),e.addEventListener("pointerup",t=>this.onPointerEnd(t)),e.addEventListener("pointercancel",t=>this.onPointerEnd(t))}activate(){var e,t;this.usesTouch||(t=(e=this.canvas).requestPointerLock)==null||t.call(e)}applyLook(e,t){this.yaw-=e*.0024,this.pitch-=t*.0024;const r=Math.PI/2-.05;this.pitch=Math.max(-r,Math.min(r,this.pitch))}onPointerDown(e){var t,n,r;if(e.pointerType==="mouse"){if(!this.locked){(n=(t=this.canvas).requestPointerLock)==null||n.call(t);return}(r=this.onPoint)==null||r.call(this,window.innerWidth/2,window.innerHeight/2);return}this.usesTouch=!0,this.tapCandidate={id:e.pointerId,x:e.clientX,y:e.clientY,t:performance.now()},this.lookTouch||(this.lookTouch={id:e.pointerId,x:e.clientX,y:e.clientY})}onPointerMove(e){this.lookTouch&&e.pointerId===this.lookTouch.id&&(this.applyLook((e.clientX-this.lookTouch.x)*2.4,(e.clientY-this.lookTouch.y)*2.4),this.lookTouch.x=e.clientX,this.lookTouch.y=e.clientY)}onPointerEnd(e){var t;if(this.tapCandidate&&e.pointerId===this.tapCandidate.id){const n=this.tapCandidate,r=performance.now()-n.t<350,s=Math.hypot(e.clientX-n.x,e.clientY-n.y)<14;r&&s&&((t=this.onPoint)==null||t.call(this,e.clientX,e.clientY)),this.tapCandidate=null}this.lookTouch&&e.pointerId===this.lookTouch.id&&(this.lookTouch=null)}getMove(){let e=0,t=0,n=!1;return(this.keys.has("KeyW")||this.keys.has("ArrowUp"))&&(e+=1),(this.keys.has("KeyS")||this.keys.has("ArrowDown"))&&(e-=1),(this.keys.has("KeyD")||this.keys.has("ArrowRight"))&&(t+=1),(this.keys.has("KeyA")||this.keys.has("ArrowLeft"))&&(t-=1),(this.keys.has("ShiftLeft")||this.keys.has("ShiftRight"))&&(n=!0),e+=this.touchForward,this.touchRun&&(n=!0),{forward:Math.max(-1,Math.min(1,e)),strafe:Math.max(-1,Math.min(1,t)),run:n}}}class Dm{constructor(){this.status=document.getElementById("status"),this.msg=document.getElementById("msg"),this.fade=document.getElementById("fade"),this.touchHint=document.getElementById("touch-hint"),this.reticle=document.getElementById("reticle"),this.reticleShown=!1,this.msgTimer=0}setReticle(e){e!==this.reticleShown&&(this.reticleShown=e,this.reticle.style.opacity=e?"0.5":"0")}setStatus(e){this.status.textContent=e}setStatusFold(e){this.status.style.opacity="0",setTimeout(()=>{this.status.textContent=e,this.status.style.opacity="1"},320)}showTouchHint(){this.touchHint.style.display="block",setTimeout(()=>this.touchHint.style.display="none",6e3)}say(e,t=2600){this.msg.textContent=e,this.msg.style.opacity="1",window.clearTimeout(this.msgTimer),this.msgTimer=window.setTimeout(()=>{this.msg.style.opacity="0"},t)}async fadeOut(e=1200){this.fade.style.transitionDuration=`${e}ms`,this.fade.style.opacity="1",await new Promise(t=>setTimeout(t,e+60))}async fadeIn(e=1200){this.fade.style.transitionDuration=`${e}ms`,this.fade.style.opacity="0",await new Promise(t=>setTimeout(t,e+60))}async tasteScene(e){var o;(o=document.exitPointerLock)==null||o.call(document);const t=document.createElement("div");t.className="overlay",t.style.opacity="0",t.style.background=e.bg,t.style.transitionDuration="1.4s";const n=document.createElement("div");n.className="sub",n.textContent=e.gauge;const r=document.createElement("div");r.className="quote",r.style.whiteSpace="pre-line",r.style.lineHeight="2",r.style.transition="opacity 1.1s",r.textContent=e.result;const s=document.createElement("button");s.textContent="한 입",t.append(n,r,s),document.body.append(t),requestAnimationFrame(()=>t.style.opacity="1");let a=0;await new Promise(l=>{s.addEventListener("click",()=>{if(a>=2){l();return}if(e.onBite(a),a+=1,a<2){s.textContent="한 입 더";return}s.disabled=!0,s.style.opacity="0.4",setTimeout(()=>{r.style.opacity="0",setTimeout(()=>{r.textContent=e.epilogue,r.style.opacity="1",s.textContent=e.endLabel,s.disabled=!1,s.style.opacity=""},1150)},1400)})}),t.style.opacity="0",setTimeout(()=>t.remove(),1500)}async blackScreen(e,t){var a;(a=document.exitPointerLock)==null||a.call(document);const n=document.createElement("div");n.className="overlay",n.style.opacity="0",n.style.background="#000";const r=document.createElement("div");r.className="quote",r.style.whiteSpace="pre-line",r.style.lineHeight="2",r.textContent=e;const s=document.createElement("button");s.textContent=t,n.append(r,s),document.body.append(n),requestAnimationFrame(()=>n.style.opacity="1"),await new Promise(o=>{s.addEventListener("click",()=>o(),{once:!0})}),n.style.opacity="0",setTimeout(()=>n.remove(),900)}}const sl=.9;class Um{constructor(){this.ctx=null,this.master=null,this.ambGain=null,this.stepTimer=0,this.muted=!1}start(){if(this.ctx){this.ctx.resume();return}const e=new AudioContext;this.ctx=e,this.master=e.createGain(),this.master.gain.value=this.muted?0:sl,this.master.connect(e.destination);const t=e.createBufferSource();t.buffer=this.noiseBuffer(4),t.loop=!0;const n=e.createBiquadFilter();n.type="lowpass",n.frequency.value=320;const r=e.createOscillator();r.frequency.value=.07;const s=e.createGain();s.gain.value=140,r.connect(s).connect(n.frequency),this.ambGain=e.createGain(),this.ambGain.gain.value=.05,t.connect(n).connect(this.ambGain).connect(this.master),t.start(),r.start()}suspend(){var e;(e=this.ctx)==null||e.suspend()}resume(){var e;(e=this.ctx)==null||e.resume()}setMuted(e){if(this.muted=e,!this.ctx||!this.master)return;const t=this.ctx.currentTime;this.master.gain.cancelScheduledValues(t),this.master.gain.setValueAtTime(this.master.gain.value,t),this.master.gain.linearRampToValueAtTime(e?0:sl,t+.15)}duck(e){if(!this.ctx||!this.ambGain)return;const t=this.ctx.currentTime;this.ambGain.gain.cancelScheduledValues(t),this.ambGain.gain.setValueAtTime(this.ambGain.gain.value,t),this.ambGain.gain.linearRampToValueAtTime(e?.006:.05,t+2.2)}update(e,t,n){if(this.ctx){if(!t){this.stepTimer=.12;return}this.stepTimer-=e,this.stepTimer<=0&&(this.footstep(n),this.stepTimer=n?.3:.46)}}footstep(e){const t=this.ctx;if(!t||!this.master)return;const n=t.createBufferSource();n.buffer=this.noiseBuffer(.08);const r=t.createBiquadFilter();r.type="bandpass",r.frequency.value=170+Math.random()*60,r.Q.value=1.2;const s=t.createGain(),a=t.currentTime;s.gain.setValueAtTime(e?.16:.1,a),s.gain.exponentialRampToValueAtTime(.001,a+.09),n.connect(r).connect(s).connect(this.master),n.start(),n.stop(a+.1)}crunch(e){const t=this.ctx;if(!t||!this.master)return;const n=Math.max(0,Math.min(1,e)),r=n>.6?3:n>.3?2:1;for(let s=0;s<r;s++){const a=t.currentTime+s*.5,o=5+Math.floor(n*7);for(let l=0;l<o;l++){const c=t.createBufferSource();c.buffer=this.noiseBuffer(.03);const h=t.createBiquadFilter();h.type="highpass",h.frequency.value=1200+n*2500+Math.random()*800;const d=t.createGain(),f=a+l*(.028+Math.random()*.02);d.gain.setValueAtTime(1e-4,f),d.gain.exponentialRampToValueAtTime(.07+n*.06,f+.006),d.gain.exponentialRampToValueAtTime(.001,f+.03),c.connect(h).connect(d).connect(this.master),c.start(f),c.stop(f+.05)}}}noiseBuffer(e){const t=this.ctx,n=Math.max(1,Math.floor(t.sampleRate*e)),r=t.createBuffer(1,n,t.sampleRate),s=r.getChannelData(0);let a=0;for(let o=0;o<n;o++){const l=Math.random()*2-1;a=(a+.02*l)/1.02,s[o]=a*3.2}return r}}const J=mt.segLength,de=mt.corridorHalfWidth,vn=7,Kl=Math.PI/2,Im=0,$l=[[1.6,-J*.26],[-1.9,-J*.36],[2.1,-J*.49],[-1.4,-J*.58],[.9,-J*.71],[-2.1,-J*.81]],Zl=new N(-2.35,.28,-J*.46),Nm=new N(.5,.28,-J*.42),ii='"Malgun Gothic", "Apple SD Gothic Neo", sans-serif';function ka(i,e,t){const n=document.createElement("canvas");n.width=i,n.height=e;const r=n.getContext("2d");t(r);const s=new Iu(n);return s.colorSpace=Bt,s.anisotropy=4,s}function al(i){return ka(256,352,e=>{e.fillStyle="#b3ad9c",e.fillRect(0,0,256,352),e.fillStyle="#2a2620",e.textAlign="center",e.font=`bold 46px ${ii}`,e.fillText("과외",128,84),e.fillText("구합니다",128,140),e.font=`24px ${ii}`,e.fillText("수학 · 영어 — 초·중등",128,196),e.font=`bold 31px ${ii}`,e.fillText(i,128,268),e.strokeStyle="#6d675a",e.setLineDash([5,5]);for(let t=32;t<256;t+=32)e.beginPath(),e.moveTo(t,300),e.lineTo(t,352),e.stroke()})}function ol(i){return ka(512,384,e=>{e.fillStyle="#0d1220",e.fillRect(0,0,512,384),e.strokeStyle="#2a3148",e.lineWidth=10,e.strokeRect(5,5,502,374),[["희망빌라 302",i?"급구":"월세 35"],["동아주택 B01","월세 30"],["한빛빌라 201","전세 8,500"],["성원빌라 402","월세 28"]].forEach(([n,r],s)=>{const a=28+s%2*240,o=32+Math.floor(s/2)*168;e.fillStyle="#c6c1b1",e.fillRect(a,o,216,140),e.textAlign="center",e.fillStyle="#33302a",e.font=`22px ${ii}`,e.fillText(n,a+108,o+44),e.font=`bold 40px ${ii}`,e.fillText(r,a+108,o+102)})})}function ll(i){return ka(512,144,e=>{e.fillStyle="#140d05",e.fillRect(0,0,512,144),e.textAlign="center",e.fillStyle="#ffd9a0",e.font=`bold 60px ${ii}`;const t=e.measureText(i).width;t>470&&(e.font=`bold ${Math.floor(60*470/t)}px ${ii}`),e.fillText(i,256,96)})}function ge(i,e,t,n,r,s,a,o){const l=new ft(new An(i,e,t),new rn({color:n,roughness:.95}));return l.position.set(r,s,a),o.add(l),l}function Fm(i){i.background=new qe(658970),i.fog=new Na(658970,.052);const e=new Hu(2764880,1.1);i.add(e);const t=new zu(8425664,.4);t.position.set(4,10,2),i.add(t);const n=new Dt;i.add(n),ge(de*2+14,.2,J+14,1580072,0,-.1,-J/2,n),ge(1,vn,J,2304056,de+.5,vn/2,-J/2,n),ge(1,vn,J,2106938,-de-.5,vn/2,-J/2,n);const r=de-Hr+1;ge(r,vn,1,2304056,-2.7,vn/2,-J-.5,n),ge(r,vn,1,2304056,Hr+r/2,vn/2,-J-.5,n);const s=-J*.45,a=ge(.15,5,.15,3817815,de-.4,2.5,s,n),o=new Tr(16762503,22,18,1.8);o.position.set(de-.9,4.8,s),n.add(o);const l=new Tr(16757310,0,26,2);l.position.set(0,3,-J-6),n.add(l);const c=new Dt,h=new rn({color:724502,roughness:1}),d=new ft(new An(.46,1.22,.28),h);d.position.y=.9;const f=new ft(new Xi(.15,10,8),h);f.position.y=1.66,c.add(d,f),c.visible=!1,n.add(c);const m=new ft(new za(.42,.5,24),new Ia({color:9146536,transparent:!0,opacity:.32}));m.rotation.x=-Math.PI/2,m.position.set(.9,.03,-5.5),m.visible=!1,n.add(m);const v=[ll("버거버거 24시"),ll("버거버거 24시간요")],M=new rn({color:16777215,map:v[0],emissiveMap:v[0],emissive:0}),p=new ft(new An(3.4,.9,.3),M);p.position.set(0,4.6,-J+.2),n.add(p);const u=new Dt;ge(1.6,.5,1,2765122,-de+1,.25,-J*.2,u),ge(.7,.35,.6,2436157,-de+.8,.85,-J*.19,u);const A=new Dt,T=ge(.06,1.3,.06,5593968,0,.65,0,A);T.rotation.z=.5;const E=new ft(new Ba(.55,.5,8),new rn({color:7017760,roughness:.8}));E.position.set(-.35,1.35,0),E.rotation.z=.5,A.add(E),A.position.set(-de+1.8,0,-J*.24),A.visible=!1,u.add(A);const L=ge(.45,.22,.16,1843760,-de+.12,1.7,-J*.3,u),R=L.material,w=new Tr(15260080,0,6,1.8);w.position.set(-de+.5,1.7,-J*.3),u.add(w);const D=new ft(new ni(1.1,1.4),new rn({color:1119263,emissive:0}));D.position.set(de-.02,3.4,-J*.68),D.rotation.y=-Math.PI/2,u.add(D);const S=D.material,x=[al("010-4172-8956"),al("010-417-8956")],C=new rn({map:x[0],roughness:.9}),H=new ft(new ni(.55,.75),C);H.position.set(de-.01,1.55,-J*.4),H.rotation.y=-Math.PI/2,u.add(H),ge(.24,6.8,.24,2896452,de-.35,3.4,-J*.15,u),ge(.24,6.8,.24,2896452,-de+.35,3.4,-J*.72,u),ge(.035,.035,J*.85,1119261,de-.35,6.3,-J*.5,u);const O=de-.35-(-de+.35),W=-J*.15- -J*.72,K=ge(.035,.035,Math.hypot(O,W),1119261,0,6,(-J*.15+-J*.72)/2,u);K.rotation.y=Math.atan2(O,W),ge(.85,.6,.38,2764864,de-.35,2.5,-J*.58,u),ge(.85,.6,.38,2501692,-de+.35,2.2,-J*.33,u),ge(.12,2.4,1.5,1119519,-de+.05,1.2,-J*.22,u),ge(.2,.16,1.9,2896452,-de+.1,2.5,-J*.22,u);const G=new Dt,Z=ge(.08,2,2.6,1316900,de-.06,1.25,-J*.39,G),k=Z.material,ae=ge(.12,2.2,2.7,2830916,de-.18,1.25,-J*.39,G),ue=new Tr(13623528,0,8,1.8);ue.position.set(de-.9,1.3,-J*.39),G.add(ue);const ye=ge(1.7,.65,.14,1975348,de-.1,3.2,-J*.5,G),He=ye.material;ge(1.5,.6,.14,1843504,de-.1,3.4,-J*.29,G),ge(1.9,.7,.14,2106938,de-.1,3.1,-J*.62,G);const Ze=[ol(!1),ol(!0)],X=new rn({map:Ze[0],roughness:.85}),ne=new ft(new ni(1.5,1.1),X);ne.position.set(-de+.01,1.5,-J*.5),ne.rotation.y=Math.PI/2,G.add(ne);for(const fe of[-J*.3,-J*.68]){ge(.12,2.1,2.3,2765123,-de+.1,1.15,fe,G);for(let y=0;y<4;y++)ge(.13,.05,2.3,2041140,-de+.1,.45+y*.5,fe,G);const $e=ge(.85,.07,2.5,2302260,-de+.5,2.65,fe,G);$e.rotation.z=-.3}ge(.55,.14,J*.92,2238262,-de+.28,.07,-J/2,G),ge(.55,.14,J*.92,2238262,de-.28,.07,-J/2,G);const he=new Dt;for(const fe of[-J*.32,-J*.375,-J*.43,-J*.485])ge(.07,.85,1.7,3291730,-de+.85,.45,fe,he);ge(.1,2.3,.1,3817815,-de+.22,1.15,-J*.365,he),ge(.1,2.3,.1,3817815,-de+.22,1.15,-J*.42,he),ge(.08,.08,2.2,3817815,-de+.22,2.3,-J*.393,he);const ie=new Dt;ie.position.set(-de+.22,2.26,-J*.393),ge(.03,1.5,.03,5593968,0,-.75,-.22,ie),ge(.03,1.5,.03,5593968,0,-.75,.22,ie),ge(.14,.06,.55,5593968,0,-1.5,0,ie),he.add(ie);const Me=new ft(new Xi(.28,12,10),new rn({color:7173256,roughness:.85}));Me.position.copy(Zl),he.add(Me);for(const[fe,$e]of[[-J*.25,1.6],[-J*.42,2],[-J*.58,1.5]]){const y=new ft(new Xi(1,7,5),new rn({color:1251880,roughness:1}));y.scale.set($e,$e*.75,$e),y.position.set(-de-1.4,vn+.6,fe),he.add(y)}for(const fe of[-J*.21,-J*.265,-J*.54,-J*.595])ge(.07,.85,1.7,3291730,-de+.85,.45,fe,he);ge(.05,.06,J*.42,3818592,-de+.85,.88,-J*.4,he),ge(.1,2.2,1.3,1514538,de-.05,1.1,-J*.7,he);const De=new Dt;ge(.08,2.2,2.2,2436157,de-.06,1.35,-J*.32,De),ge(.9,.08,2.4,2765122,de-.5,2.5,-J*.32,De),ge(.08,2.5,.08,2765122,de-.34,1.25,-J*.29,De),ge(.08,2.5,.08,2765122,de-.34,1.25,-J*.35,De),ge(.35,.08,1.8,2765122,de-.32,.55,-J*.32,De);const Ce=[],it=[],rt=[];for(const fe of[-2.6,de-.4]){ge(.12,3.4,.12,3817815,fe,1.7,-J*.55,De),rt.push(ge(.3,.66,.24,1843760,fe,3.55,-J*.55,De));const $e=ge(.16,.16,.06,3477780,fe,3.7,-J*.55+.14,De),y=ge(.16,.16,.06,1124378,fe,3.42,-J*.55+.14,De);Ce.push($e.material),it.push(y.material)}for(let fe=0;fe<4;fe++)ge(de*2-1.2,.03,.6,8949922,0,.02,-J*.62-fe*1.15,De);ge(de*2-1.2,.03,.35,8949922,0,.02,-J*.585,De),ge(.16,.7,.16,3752282,de-.7,.35,-J*.24,De),ge(.16,.7,.16,3752282,de-.7,.35,-J*.4,De),ge(.5,.14,J*.9,2304056,de-.25,.07,-J/2,De);const Ue=new Dt;ge(.14,.6,1.5,2106938,-de+.1,3.1,-J*.25,Ue),ge(1.6,.7,.14,1975348,de-.1,3.35,-J*.33,Ue),ge(.14,.55,1.3,1843504,-de+.1,2.9,-J*.47,Ue),ge(1.8,.6,.14,2106938,de-.1,3.15,-J*.6,Ue);const b=new Dt,St=new rn({color:9146536,roughness:.9}),Xe=new An(.8,1.15,.06);for(const fe of[1,-1]){const $e=new ft(Xe,St);$e.position.set(0,.56,fe*.16),$e.rotation.x=-fe*.26,b.add($e)}b.position.set(-de+.75,0,-J*.55),b.rotation.y=Kl,Ue.add(b),ge(de*2+.6,.55,.05,2039856,0,4.4,-J*.12,Ue);const Je=ge(.8,.07,2.2,2827060,de-.5,2.6,-J*.36,Ue);Je.rotation.z=.3;const Se=ge(.8,.07,2,2433332,-de+.5,2.55,-J*.68,Ue);Se.rotation.z=-.3,ge(.5,1.7,.16,2304574,de-.45,3.6,-J*.5,Ue),ge(.5,1.7,.16,2041142,-de+.45,3.4,-J*.3,Ue),ge(.55,.4,.55,2501694,de-.6,.2,-J*.42,Ue),ge(.5,.38,.5,2304056,de-.62,.59,-J*.43,Ue),ge(.45,.45,.45,2764868,-de+.7,.22,-J*.7,Ue);const ke=[u,G,he,De,Ue];for(const fe of ke)fe.visible=!1,n.add(fe);return{group:n,themes:ke,ambient:e,foldMark:m,lampLight:o,shopGlow:l,shopSign:p,shopSignMat:M,umbrella:A,sensorMat:R,sensorLight:w,windowMat:S,flyerMat:C,flyerTex:x,laundryShutter:ae,laundryMat:k,laundryLight:ue,storeSignMat:He,realtyMat:X,realtyTex:Ze,swingPivot:ie,ball:Me,trafficRed:Ce,trafficGreen:it,sign:b,shopTex:v,figure:c,hit:{umbrella:[A],sensor_on:[L],window_red:[D],flyer_digits:[H],laundry_open:[ae,Z],sign_lit:[ye],realty_urgent:[ne],swing:[ie],lamp_flicker:[a],ball_out:[Me],traffic_red:rt,sign_turn:[b],shop_typo:[p],figure:[c]}}}function Om(i,e){i.themes.forEach((t,n)=>t.visible=n===e-1)}const cl=[22,16,11,7,4,2];function jl(i,e){const t=cl[Math.min(e,cl.length-1)];i.group.userData.lampBase=t,i.lampLight.intensity=t,i.ambient.intensity=Math.max(.55,1.1-e*.09)}function Bm(i,e){i.foldMark.visible=e}const ul={umbrella:{reset:i=>{i.umbrella.visible=!1},apply:i=>{i.umbrella.visible=!0}},sensor_on:{reset:i=>{i.sensorMat.emissive.setHex(0),i.sensorLight.intensity=0},apply:i=>{i.sensorMat.emissive.setHex(13615780),i.sensorLight.intensity=4}},window_red:{reset:i=>{i.windowMat.emissive.setHex(0)},apply:i=>{i.windowMat.emissive.setHex(7999504)}},laundry_open:{reset:i=>{i.laundryShutter.position.y=1.25,i.laundryShutter.scale.y=1,i.laundryMat.emissive.setHex(0),i.laundryLight.intensity=0},apply:i=>{i.laundryShutter.position.y=2,i.laundryShutter.scale.y=.42,i.laundryMat.emissive.setHex(7833487),i.laundryLight.intensity=6}},sign_lit:{reset:i=>{i.storeSignMat.emissive.setHex(0)},apply:i=>{i.storeSignMat.emissive.setHex(7214100)}},swing:{reset:i=>{i.swingPivot.rotation.x=0}},lamp_flicker:{reset:i=>{i.lampLight.intensity=i.group.userData.lampBase??22}},traffic_red:{reset:()=>{}},ball_out:{reset:i=>{i.ball.position.copy(Zl)},apply:i=>{i.ball.position.copy(Nm)}},sign_turn:{reset:i=>{i.sign.rotation.y=Kl},apply:i=>{i.sign.rotation.y=Im}},flyer_digits:{reset:i=>{i.flyerMat.map=i.flyerTex[0]},apply:i=>{i.flyerMat.map=i.flyerTex[1]}},realty_urgent:{reset:i=>{i.realtyMat.map=i.realtyTex[0]},apply:i=>{i.realtyMat.map=i.realtyTex[1]}},shop_typo:{reset:i=>{i.shopSignMat.map=i.shopTex[0],i.shopSignMat.emissiveMap=i.shopTex[0]},apply:i=>{i.shopSignMat.map=i.shopTex[1],i.shopSignMat.emissiveMap=i.shopTex[1]}},figure:{reset:i=>{i.figure.visible=!1},apply:i=>{const[e,t]=$l[i.group.userData.figureAnchor??0];i.figure.position.set(e,0,t),i.figure.rotation.y=Math.random()<.5?Math.PI:Math.PI*.85,i.figure.visible=!0}}};function zm(i,e){var t,n;for(const r of Object.values(ul))r.reset(i);i.group.userData.effects=e;for(const r of e)(n=(t=ul[r]).apply)==null||n.call(t,i)}function Hm(i,e){i.shopGlow.intensity=e?30:4,i.shopSign.visible=e,i.shopSignMat.emissive.setHex(e?16777215:0)}const Gm=9049622,km=3111498;function Vm(i,e){const t=i.group.userData.effects??[];if(t.includes("lamp_flicker")){const n=i.group.userData.lampBase??22,r=e%1.6,s=!(r<.12||r>.24&&r<.36);i.lampLight.intensity=s?n:Math.min(2,n)}if(t.includes("swing")&&(i.swingPivot.rotation.x=Math.sin(e*2.2)*.38),i.themes[3].visible){const n=t.includes("traffic_red"),r=e%5.6,s=!n&&r<3.2,a=n||r>=3.2;for(const o of i.trafficGreen)o.emissive.setHex(s?km:0);for(const o of i.trafficRed)o.emissive.setHex(a?Gm:0)}}const Va="fries.save.v1",Gr={night:1,misses:0,results:[],brightness:1,muted:!1};function Wm(i){const e={...Gr,results:[]};if(typeof i!="object"||i===null)return e;const t=i;return typeof t.night=="number"&&Number.isInteger(t.night)&&t.night>=1&&t.night<=99&&(e.night=t.night),typeof t.misses=="number"&&Number.isInteger(t.misses)&&t.misses>=0&&(e.misses=t.misses),Array.isArray(t.results)&&(e.results=t.results.slice(0,99).map(n=>n==="crispy"||n==="lukewarm"||n==="soggy"?n:null)),typeof t.brightness=="number"&&t.brightness>=.6&&t.brightness<=1.9&&(e.brightness=t.brightness),typeof t.muted=="boolean"&&(e.muted=t.muted),e}function Xm(){try{const i=localStorage.getItem(Va);return i?Wm(JSON.parse(i)):{...Gr,results:[]}}catch{return{...Gr,results:[]}}}const dt=Xm();function qr(){try{localStorage.setItem(Va,JSON.stringify(dt))}catch{}}function qm(){Object.assign(dt,Gr,{results:[]});try{localStorage.removeItem(Va)}catch{}}function Jl(){return dt.night>1||dt.misses>0}const Ym=document.getElementById("app"),tn=new wm({antialias:!0});tn.setPixelRatio(Math.min(window.devicePixelRatio,2));tn.setSize(window.innerWidth,window.innerHeight);tn.toneMapping=xl;Ym.appendChild(tn.domElement);const Un=document.getElementById("bright"),Wa=document.getElementById("start");let Ql=0;function hl(){window.clearTimeout(Ql),Wa.classList.add("peek")}function Cs(){Wa.classList.remove("peek")}Un&&(Un.value=String(dt.brightness),tn.toneMappingExposure=dt.brightness,Un.addEventListener("pointerdown",hl),window.addEventListener("pointerup",Cs),window.addEventListener("pointercancel",Cs),Un.addEventListener("input",()=>{tn.toneMappingExposure=parseFloat(Un.value),dt.brightness=parseFloat(Un.value),qr(),hl(),Ql=window.setTimeout(Cs,1e3)}));const Xa=new Pu,Vt=new zt(72,window.innerWidth/window.innerHeight,.1,120),an=Fm(Xa),gt=new Lm(tn.domElement),_t=new Dm,nn=new Um,kr=new ku,bi=document.getElementById("sound-btn");function qa(){nn.setMuted(dt.muted),bi&&(bi.textContent=dt.muted?"🔇":"🔊",bi.setAttribute("aria-label",dt.muted?"소리 켜기":"소리 끄기"))}function ec(){dt.muted=!dt.muted,qr(),qa()}bi==null||bi.addEventListener("click",ec);window.addEventListener("keydown",i=>{i.code==="KeyM"&&ec()});qa();let en="gate",ir=!1,Ps=!1,Jt=dt.night,ri=0,Ui=mt.segments,Sn=1,bn=0,Yr=0,Ya=!1,Zi=0,Vr=0,ji=0,$t=[];const wi=new Set;let Ea=new Set,ya=0;const Et={x:0,z:0};function Km(){return Math.min(.8,mt.baseAnomalyChance+ji/60*mt.chancePerMinute)}const Wi=new URLSearchParams(location.search).get("a");function tc(i=!1){Om(an,Sn);const e=rl.filter(s=>(s.segment===Sn||s.segment===0)&&s.night<=Jt&&!Ea.has(s.id)),t=!Wi&&Jt===1&&ri===0,n=Jt===1&&Sn>=mt.segments-1&&ya===0;if(Wi){const s=rl.find(a=>a.effect===Wi&&(a.segment===Sn||a.segment===0));$t=s?[s]:[]}else if(e.length>0&&!t&&(n||Math.random()<Km())){const s=Math.min(Pm(Zi),e.length);$t=[...e].sort(()=>Math.random()-.5).slice(0,s),ya+=s}else $t=[];Ea=new Set($t.map(s=>s.id)),wi.clear(),$t.some(s=>s.effect==="figure")&&(an.group.userData.figureAnchor=Wi?2:Math.floor(Math.random()*$l.length)),jl(an,bn),zm(an,$t.map(s=>s.effect)),Bm(an,Ya),nn.duck($t.length>0),Hm(an,ri===Ui-1),Et.x=0,Et.z=0,gt.yaw=0,gt.pitch=0;const r=`${ut.nightLabel(Jt)} — ${ut.segLabel(ri+1,Ui,Sn)}`;i?_t.setStatusFold(r):_t.setStatus(r)}async function Ka(){ri=0,Ui=mt.segments,Sn=1,bn=0,Yr=0,Zi=0,Ya=!1,ji=0,Ea=new Set,ya=0,tc(),en="walk",_t.say(ut.intros[Math.min(Jt-1,ut.intros.length-1)])}async function nc(){en="transition",await _t.fadeOut(1400),await _t.blackScreen(ut.softFail,ut.softFailBtn),gt.activate(),await Ka(),await _t.fadeIn(900)}async function $m(){en="transition",await _t.fadeOut(800),await _t.blackScreen(`${ut.shopArrive}

${ut.shopBuy}`,"봉투를 받는다 (3,200원)");const i=Cm(Yr),e=i==="crispy"?ut.resultCrispy:i==="lukewarm"?ut.resultLukewarm:ut.resultSoggy;dt.results[Jt-1]=i,dt.night=Jt+1,qr(),await _t.blackScreen(ut.homeArrive,ut.homeOpen);const t=i==="crispy"?.95:i==="lukewarm"?.55:.25;await _t.tasteScene({gauge:ut.tasteGauge[i],result:e,epilogue:ut.epilogues[Math.min(Jt-1,ut.epilogues.length-1)],endLabel:ut.tasteEnd,bg:i==="crispy"?"#181008":i==="lukewarm"?"#100e12":"#0a0d16",onBite:n=>nn.crunch(Math.max(.05,t*(1-n*.18)))}),gt.activate(),Jt+=1,await Ka(),await _t.fadeIn(900)}async function Zm(){let i=!1;const e=$t.filter(t=>!wi.has(t.id));if(e.length>0&&(Yr+=1,Ui+=1,bn+=mt.foldDepthCost,Zi=Math.min(mt.swarmMax,Zi+1),dt.misses+=1,qr(),i=!0,_t.say(`${e[0].reveal}
${ut.foldNotice}`,3800),nn.duck(!0)),ri+=1,bn>=mt.depthLimit){await nc();return}if(ri>=Ui){await $m();return}Ya=i,i||(Sn=Math.min(Sn+1,mt.segments)),tc(i)}const dl=new Vu,Nr=new We,In=new N;function jm(i){if(dl.setFromCamera(Nr,Vt),dl.intersectObjects(i,!0).length>0)return!0;for(const e of i)if(e.getWorldPosition(In),!(In.distanceTo(Vt.position)>45)&&(In.project(Vt),In.z<1&&Math.hypot(In.x-Nr.x,In.y-Nr.y)<.12))return!0;return!1}function Jm(i){let e=1/0;for(const t of i)t.getWorldPosition(In),e=Math.min(e,In.distanceTo(Vt.position));return e}function ic(i,e,t=!1){if(en!=="walk"||Vr>0)return;Vr=mt.spotCooldownSec,Nr.set(i/window.innerWidth*2-1,-(e/window.innerHeight)*2+1);const n=$t.filter(r=>!wi.has(r.id));if(t&&n.length>0){wi.add(n[0].id),_t.say(ut.spotOk,3e3);return}for(const r of n)if(jm(an.hit[r.effect])){if(Jm(an.hit[r.effect])>mt.checkDistance){_t.say(ut.tooFar,2200);return}wi.add(r.id),_t.say(ut.spotOk,3e3);return}$t.length>0&&n.length===0||(bn+=mt.wasteDepthCost,jl(an,bn),_t.say(ut.spotWaste,3e3),bn>=mt.depthLimit&&nc())}gt.onPoint=(i,e)=>ic(i,e);const Kt=document.getElementById("walk-btn");if(Kt){let i=null,e=0;const t=n=>{n.pointerId===i&&(i=null,gt.touchForward=0,gt.touchRun=!1,Kt.classList.remove("held","run"),Kt.textContent="걷는다")};Kt.addEventListener("pointerdown",n=>{i=n.pointerId,e=n.clientY,gt.usesTouch=!0,gt.touchForward=1,Kt.classList.add("held"),Kt.setPointerCapture(n.pointerId)}),Kt.addEventListener("pointermove",n=>{if(n.pointerId!==i)return;const r=e-n.clientY>48;r!==gt.touchRun&&(gt.touchRun=r,Kt.classList.toggle("run",r),Kt.textContent=r?"달린다":"걷는다")}),Kt.addEventListener("pointerup",t),Kt.addEventListener("pointercancel",t)}const fl=mt.corridorHalfWidth;function Qm(i){ji+=i;const e=gt.getMove(),t=e.run?mt.runSpeed:mt.walkSpeed,n=Math.abs(e.forward)+Math.abs(e.strafe)>.1;nn.update(i,n,e.run),Xa.fog.density=.052+Math.min(.018,ji/60*.0035)+Math.min(.02,bn*.0035);const r=Math.sin(gt.yaw),s=Math.cos(gt.yaw);if(Et.x+=(r*-e.forward+s*e.strafe)*t*i,Et.z+=(-s*e.forward-r*e.strafe)*t*i,Et.x=Math.max(-fl+.4,Math.min(fl-.4,Et.x)),Et.z=Math.min(.5,Et.z),Vr=Math.max(0,Vr-i),Et.z<-36-.5&&Math.abs(Et.x)<Hr+.4){Zm();return}Et.z<-36+.4&&Math.abs(Et.x)>=Hr&&(Et.z=-36+.4),Vt.position.set(Et.x,1.65,Et.z),Vt.rotation.set(0,0,0),Vt.rotateY(gt.yaw),Vt.rotateX(gt.pitch)}let pl=0;function rc(){const i=Math.min(kr.getDelta(),.1);pl+=i,en==="walk"&&Qm(i),_t.setReticle(en==="walk"),Vm(an,pl),tn.render(Xa,Vt),requestAnimationFrame(rc)}async function eg(){en!=="walk"||Ps||(Ps=!0,en="transition",nn.suspend(),await _t.blackScreen("…잠깐 골목 구석에서 숨을 골랐다.","계속 걷는다"),nn.resume(),gt.activate(),en="walk",Ps=!1)}const sc=document.getElementById("wake"),ac=document.getElementById("prologue"),Fr=document.getElementById("phone"),ml=document.getElementById("prologue-msg"),Kn=document.getElementById("prologue-btn");function oc(){Wa.classList.remove("hidden")}Jl()?oc():sc.classList.remove("hidden");document.getElementById("wake-btn").addEventListener("click",()=>{sc.classList.add("hidden"),ac.classList.remove("hidden"),setTimeout(()=>Fr.classList.add("on"),500)});let Rr=0;Kn.addEventListener("click",()=>{Rr===0?(Rr=1,Fr.classList.remove("on"),Kn.style.visibility="hidden",setTimeout(()=>{Fr.classList.add("on"),Kn.textContent="…다시 끈다",Kn.style.visibility="visible"},2600)):Rr===1?(Rr=2,Fr.classList.remove("on"),Kn.style.visibility="hidden",setTimeout(()=>{ml.textContent='"감자튀김 하나에 만육천칠백 원은 좀 아니지."',ml.style.opacity="1",Kn.textContent="이불을 걷는다",Kn.style.visibility="visible"},1100)):(ac.classList.add("hidden"),oc())});const Ls=document.getElementById("settings-panel");var gl;(gl=document.getElementById("settings-btn"))==null||gl.addEventListener("click",()=>{Ls==null||Ls.classList.toggle("open")});const Ds=document.getElementById("continue-info"),Qn=document.getElementById("reset-btn"),tg="기록 삭제 · 처음부터";function lc(){if(!Ds||!Qn)return;const i=Jl();if(Ds.style.display=i?"block":"none",Qn.style.display=i?"inline-block":"none",i){const e=dt.misses>0?` 그동안 ${dt.misses}번, 침대에서 눈을 떴다.`:"";Ds.textContent=`이어하기 — 밤 ${dt.night}.${e}`}}let Us=!1;Qn==null||Qn.addEventListener("click",()=>{if(!Us){Us=!0,Qn.textContent="정말 삭제할까요? (한 번 더 누르면 삭제)";return}qm(),Us=!1,Qn.textContent=tg,Jt=dt.night,Un&&(Un.value=String(dt.brightness),tn.toneMappingExposure=dt.brightness),qa(),lc()});lc();document.getElementById("start-btn").addEventListener("click",async()=>{document.getElementById("start").classList.add("hidden"),ir=!0,nn.start(),gt.activate(),$a(),history.pushState({fries:1},""),(gt.usesTouch||"ontouchstart"in window)&&_t.showTouchHint(),await Ka()});window.addEventListener("popstate",()=>{ir&&(history.pushState({fries:1},""),eg())});window.addEventListener("beforeunload",i=>{ir&&en==="walk"&&i.preventDefault()});function $a(){var e;(e=navigator.wakeLock)==null||e.request("screen").catch(()=>{})}document.addEventListener("visibilitychange",()=>{document.hidden?(kr.stop(),nn.suspend()):(kr.start(),nn.resume(),ir&&$a())});window.addEventListener("pageshow",i=>{i.persisted&&(kr.start(),nn.resume(),ir&&$a())});document.addEventListener("gesturestart",i=>i.preventDefault());tn.domElement.addEventListener("contextmenu",i=>i.preventDefault());window.addEventListener("resize",()=>{Vt.aspect=window.innerWidth/window.innerHeight,Vt.updateProjectionMatrix(),tn.setSize(window.innerWidth,window.innerHeight)});window.__fries={state:()=>({phase:en,night:Jt,done:ri,total:Ui,theme:Sn,depth:bn,folds:Yr,swarm:Zi,active:$t.length,checked:wi.size,elapsed:Math.round(ji*10)/10,x:Math.round(Et.x*100)/100,z:Math.round(Et.z*100)/100}),config:()=>({...mt}),...Wi!==null?{debugSpot:()=>ic(window.innerWidth/2,window.innerHeight/2,!0)}:{}};Vt.position.set(0,1.65,0);rc();
