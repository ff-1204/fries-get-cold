...
`)+`
`+d);const T=w+m+o,S=w+d+a,R=Kl(s,s.VERTEX_SHADER,T),E=Kl(s,s.FRAGMENT_SHADER,S);s.attachShader(_,R),s.attachShader(_,E),e.index0AttributeName!==void 0?s.bindAttribLocation(_,0,e.index0AttributeName):e.morphTargets===!0&&s.bindAttribLocation(_,0,"position"),s.linkProgram(_);function b(L){if(n.debug.checkShaderErrors){const O=s.getProgramInfoLog(_).trim(),B=s.getShaderInfoLog(R).trim(),Y=s.getShaderInfoLog(E).trim();let Z=!0,V=!0;if(s.getProgramParameter(_,s.LINK_STATUS)===!1)if(Z=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(s,_,R,E);else{const q=jl(s,R,"vertex"),X=jl(s,E,"fragment");console.error("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(_,s.VALIDATE_STATUS)+`
...
}`;class N0{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(t,e,i){if(this.texture===null){const s=new en,r=t.properties.get(s);r.__webglTexture=e.texture,(e.depthNear!==i.depthNear||e.depthFar!==i.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=s}}getMesh(t){if(this.texture!==null&&this.mesh===null){const e=t.cameras[0].viewport,i=new ri({vertexShader:I0,fragmentShader:U0,uniforms:{depthColor:{value:this.texture},depthWidth:{value:e.z},depthHeight:{value:e.w}}});this.mesh=new ot(new Le(20,20),i)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class F0 extends rs{constructor(t,e){super();const i=this;let s=null,r=1,o=null,a="local-floor",l=1,c=null,u=null,h=null,f=null,p=null,g=null;const _=new N0,m=e.getContextAttributes();let d=null,w=null;const T=[],S=[],R=new Kt;let E=null;const b=new hn;b.viewport=new de;const P=new hn;P.viewport=new de;const y=[b,P],x=new ed;let L=null,O=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(K){let st=T[K];return st===void 0&&(st=new no,T[K]=st),st.getTargetRaySpace()},this.getControllerGrip=function(K){let st=T[K];return st===void 0&&(st=new no,T[K]=st),st.getGripSpace()},this.getHand=function(K){let st=T[K];return st===void 0&&(st=new no,T[K]=st),st.getHandSpace()};function B(K){const st=S.indexOf(K.inputSource);if(st===-1)return;const St=T[st];St!==void 0&&(St.update(K.inputSource,K.frame,c||o),St.dispatchEvent({type:K.type,data:K.inputSource}))}function Y(){s.removeEventListener("select",B),s.removeEventListener("selectstart",B),s.removeEventListener("selectend",B),s.removeEventListener("squeeze",B),s.removeEventListener("squeezestart",B),s.removeEventListener("squeezeend",B),s.removeEventListener("end",Y),s.removeEventListener("inputsourceschange",Z);for(let K=0;K<T.length;K++){const st=S[K];st!==null&&(S[K]=null,T[K].disconnect(st))}L=null,O=null,_.reset(),t.setRenderTarget(d),p=null,f=null,h=null,s=null,w=null,oe.stop(),i.isPresenting=!1,t.setPixelRatio(E),t.setSize(R.width,R.height,!1),i.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(K){r=K,i.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(K){a=K,i.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||o},this.setReferenceSpace=function(K){c=K},this.getBaseLayer=function(){return f!==null?f:p},this.getBinding=function(){return h},this.getFrame=function(){return g},this.getSession=function(){return s},this.setSession=async function(K){if(s=K,s!==null){if(d=t.getRenderTarget(),s.addEventListener("select",B),s.addEventListener("selectstart",B),s.addEventListener("selectend",B),s.addEventListener("squeeze",B),s.addEventListener("squeezestart",B),s.addEventListener("squeezeend",B),s.addEventListener("end",Y),s.addEventListener("inputsourceschange",Z),m.xrCompatible!==!0&&await e.makeXRCompatible(),E=t.getPixelRatio(),t.getSize(R),typeof XRWebGLBinding<"u"&&"createProjectionLayer"in XRWebGLBinding.prototype){let St=null,ht=null,bt=null;m.depth&&(bt=m.stencil?e.DEPTH24_STENCIL8:e.DEPTH_COMPONENT24,St=m.stencil?Rs:As,ht=m.stencil?ws:Ai);const Zt={colorFormat:e.RGBA8,depthFormat:bt,scaleFactor:r};h=new XRWebGLBinding(s,e),f=h.createProjectionLayer(Zt),s.updateRenderState({layers:[f]}),t.setPixelRatio(1),t.setSize(f.textureWidth,f.textureHeight,!1),w=new Ri(f.textureWidth,f.textureHeight,{format:En,type:Dn,depthTexture:new kc(f.textureWidth,f.textureHeight,ht,void 0,void 0,void 0,void 0,void 0,void 0,St),stencilBuffer:m.stencil,colorSpace:t.outputColorSpace,samples:m.antialias?4:0,resolveDepthBuffer:f.ignoreDepthValues===!1,resolveStencilBuffer:f.ignoreDepthValues===!1})}else{const St={antialias:m.antialias,alpha:!0,depth:m.depth,stencil:m.stencil,framebufferScaleFactor:r};p=new XRWebGLLayer(s,e,St),s.updateRenderState({baseLayer:p}),t.setPixelRatio(1),t.setSize(p.framebufferWidth,p.framebufferHeight,!1),w=new Ri(p.framebufferWidth,p.framebufferHeight,{format:En,type:Dn,colorSpace:t.outputColorSpace,stencilBuffer:m.stencil,resolveDepthBuffer:p.ignoreDepthValues===!1,resolveStencilBuffer:p.ignoreDepthValues===!1})}w.isXRRenderTarget=!0,this.setFoveation(l),c=null,o=await s.requestReferenceSpace(a),oe.setContext(s),oe.start(),i.isPresenting=!0,i.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(s!==null)return s.environmentBlendMode},this.getDepthTexture=function(){return _.getDepthTexture()};function Z(K){for(let st=0;st<K.removed.length;st++){const St=K.removed[st],ht=S.indexOf(St);ht>=0&&(S[ht]=null,T[ht].disconnect(St))}for(let st=0;st<K.added.length;st++){const St=K.added[st];let ht=S.indexOf(St);if(ht===-1){for(let Zt=0;Zt<T.length;Zt++)if(Zt>=S.length){S.push(St),ht=Zt;break}else if(S[Zt]===null){S[Zt]=St,ht=Zt;break}if(ht===-1)break}const bt=T[ht];bt&&bt.connect(St)}}const V=new N,q=new N;function X(K,st,St){V.setFromMatrixPosition(st.matrixWorld),q.setFromMatrixPosition(St.matrixWorld);const ht=V.distanceTo(q),bt=st.projectionMatrix.elements,Zt=St.projectionMatrix.elements,yt=bt[14]/(bt[10]-1),qt=bt[14]/(bt[10]+1),Te=(bt[9]+1)/bt[5],se=(bt[9]-1)/bt[5],D=(bt[8]-1)/bt[0],$e=(Zt[8]+1)/Zt[0],re=yt*D,ge=yt*$e,Et=ht/(-D+$e),ee=Et*-D;if(st.matrixWorld.decompose(K.position,K.quaternion,K.scale),K.translateX(ee),K.translateZ(Et),K.matrixWorld.compose(K.position,K.quaternion,K.scale),K.matrixWorldInverse.copy(K.matrixWorld).invert(),bt[10]===-1)K.projectionMatrix.copy(st.projectionMatrix),K.projectionMatrixInverse.copy(st.projectionMatrixInverse);else{const Pt=yt+Et,kt=qt+Et,Ne=re-ee,A=ge+(ht-ee),v=Te*qt/kt*Pt,z=se*qt/kt*Pt;K.projectionMatrix.makePerspective(Ne,A,v,z,Pt,kt),K.projectionMatrixInverse.copy(K.projectionMatrix).invert()}}function rt(K,st){st===null?K.matrixWorld.copy(K.matrix):K.matrixWorld.multiplyMatrices(st.matrixWorld,K.matrix),K.matrixWorldInverse.copy(K.matrixWorld).invert()}this.updateCamera=function(K){if(s===null)return;let st=K.near,St=K.far;_.texture!==null&&(_.depthNear>0&&(st=_.depthNear),_.depthFar>0&&(St=_.depthFar)),x.near=P.near=b.near=st,x.far=P.far=b.far=St,(L!==x.near||O!==x.far)&&(s.updateRenderState({depthNear:x.near,depthFar:x.far}),L=x.near,O=x.far),b.layers.mask=K.layers.mask|2,P.layers.mask=K.layers.mask|4,x.layers.mask=b.layers.mask|P.layers.mask;const ht=K.parent,bt=x.cameras;rt(x,ht);for(let Zt=0;Zt<bt.length;Zt++)rt(bt[Zt],ht);bt.length===2?X(x,b,P):x.projectionMatrix.copy(b.projectionMatrix),ut(K,x,ht)};function ut(K,st,St){St===null?K.matrix.copy(st.matrixWorld):(K.matrix.copy(St.matrixWorld),K.matrix.invert(),K.matrix.multiply(st.matrixWorld)),K.matrix.decompose(K.position,K.quaternion,K.scale),K.updateMatrixWorld(!0),K.projectionMatrix.copy(st.projectionMatrix),K.projectionMatrixInverse.copy(st.projectionMatrixInverse),K.isPerspectiveCamera&&(K.fov=aa*2*Math.atan(1/K.projectionMatrix.elements[5]),K.zoom=1)}this.getCamera=function(){return x},this.getFoveation=function(){if(!(f===null&&p===null))return l},this.setFoveation=function(K){l=K,f!==null&&(f.fixedFoveation=K),p!==null&&p.fixedFoveation!==void 0&&(p.fixedFoveation=K)},this.hasDepthSensing=function(){return _.texture!==null},this.getDepthSensingMesh=function(){return _.getMesh(x)};let xt=null;function Ht(K,st){if(u=st.getViewerPose(c||o),g=st,u!==null){const St=u.views;p!==null&&(t.setRenderTargetFramebuffer(w,p.framebuffer),t.setRenderTarget(w));let ht=!1;St.length!==x.cameras.length&&(x.cameras.length=0,ht=!0);for(let yt=0;yt<St.length;yt++){const qt=St[yt];let Te=null;if(p!==null)Te=p.getViewport(qt);else{const D=h.getViewSubImage(f,qt);Te=D.viewport,yt===0&&(t.setRenderTargetTextures(w,D.colorTexture,D.depthStencilTexture),t.setRenderTarget(w))}let se=y[yt];se===void 0&&(se=new hn,se.layers.enable(yt),se.viewport=new de,y[yt]=se),se.matrix.fromArray(qt.transform.matrix),se.matrix.decompose(se.position,se.quaternion,se.scale),se.projectionMatrix.fromArray(qt.projectionMatrix),se.projectionMatrixInverse.copy(se.projectionMatrix).invert(),se.viewport.set(Te.x,Te.y,Te.width,Te.height),yt===0&&(x.matrix.copy(se.matrix),x.matrix.decompose(x.position,x.quaternion,x.scale)),ht===!0&&x.cameras.push(se)}const bt=s.enabledFeatures;if(bt&&bt.includes("depth-sensing")&&s.depthUsage=="gpu-optimized"&&h){const yt=h.getDepthInformation(St[0]);yt&&yt.isValid&&yt.texture&&_.init(t,yt,s.renderState)}}for(let St=0;St<T.length;St++){const ht=S[St],bt=T[St];ht!==null&&bt!==void 0&&bt.update(ht,st,c||o)}xt&&xt(K,st),st.detectedPlanes&&i.dispatchEvent({type:"planesdetected",data:st}),g=null}const oe=new Xc;oe.setAnimationLoop(Ht),this.setAnimationLoop=function(K){xt=K},this.dispose=function(){}}}const pi=new In,O0=new Se;function B0(n,t){function e(m,d){m.matrixAutoUpdate===!0&&m.updateMatrix(),d.value.copy(m.matrix)}function i(m,d){d.color.getRGB(m.fogColor.value,Oc(n)),d.isFog?(m.fogNear.value=d.near,m.fogFar.value=d.far):d.isFogExp2&&(m.fogDensity.value=d.density)}function s(m,d,w,T,S){d.isMeshBasicMaterial||d.isMeshLambertMaterial?r(m,d):d.isMeshToonMaterial?(r(m,d),h(m,d)):d.isMeshPhongMaterial?(r(m,d),u(m,d)):d.isMeshStandardMaterial?(r(m,d),f(m,d),d.isMeshPhysicalMaterial&&p(m,d,S)):d.isMeshMatcapMaterial?(r(m,d),g(m,d)):d.isMeshDepthMaterial?r(m,d):d.isMeshDistanceMaterial?(r(m,d),_(m,d)):d.isMeshNormalMaterial?r(m,d):d.isLineBasicMaterial?(o(m,d),d.isLineDashedMaterial&&a(m,d)):d.isPointsMaterial?l(m,d,w,T):d.isSpriteMaterial?c(m,d):d.isShadowMaterial?(m.color.value.copy(d.color),m.opacity.value=d.opacity):d.isShaderMaterial&&(d.uniformsNeedUpdate=!1)}function r(m,d){m.opacity.value=d.opacity,d.color&&m.diffuse.value.copy(d.color),d.emissive&&m.emissive.value.copy(d.emissive).multiplyScalar(d.emissiveIntensity),d.map&&(m.map.value=d.map,e(d.map,m.mapTransform)),d.alphaMap&&(m.alphaMap.value=d.alphaMap,e(d.alphaMap,m.alphaMapTransform)),d.bumpMap&&(m.bumpMap.value=d.bumpMap,e(d.bumpMap,m.bumpMapTransform),m.bumpScale.value=d.bumpScale,d.side===tn&&(m.bumpScale.value*=-1)),d.normalMap&&(m.normalMap.value=d.normalMap,e(d.normalMap,m.normalMapTransform),m.normalScale.value.copy(d.normalScale),d.side===tn&&m.normalScale.value.negate()),d.displacementMap&&(m.displacementMap.value=d.displacementMap,e(d.displacementMap,m.displacementMapTransform),m.displacementScale.value=d.displacementScale,m.displacementBias.value=d.displacementBias),d.emissiveMap&&(m.emissiveMap.value=d.emissiveMap,e(d.emissiveMap,m.emissiveMapTransform)),d.specularMap&&(m.specularMap.value=d.specularMap,e(d.specularMap,m.specularMapTransform)),d.alphaTest>0&&(m.alphaTest.value=d.alphaTest);const w=t.get(d),T=w.envMap,S=w.envMapRotation;T&&(m.envMap.value=T,pi.copy(S),pi.x*=-1,pi.y*=-1,pi.z*=-1,T.isCubeTexture&&T.isRenderTargetTexture===!1&&(pi.y*=-1,pi.z*=-1),m.envMapRotation.value.setFromMatrix4(O0.makeRotationFromEuler(pi)),m.flipEnvMap.value=T.isCubeTexture&&T.isRenderTargetTexture===!1?-1:1,m.reflectivity.value=d.reflectivity,m.ior.value=d.ior,m.refractionRatio.value=d.refractionRatio),d.lightMap&&(m.lightMap.value=d.lightMap,m.lightMapIntensity.value=d.lightMapIntensity,e(d.lightMap,m.lightMapTransform)),d.aoMap&&(m.aoMap.value=d.aoMap,m.aoMapIntensity.value=d.aoMapIntensity,e(d.aoMap,m.aoMapTransform))}function o(m,d){m.diffuse.value.copy(d.color),m.opacity.value=d.opacity,d.map&&(m.map.value=d.map,e(d.map,m.mapTransform))}function a(m,d){m.dashSize.value=d.dashSize,m.totalSize.value=d.dashSize+d.gapSize,m.scale.value=d.scale}function l(m,d,w,T){m.diffuse.value.copy(d.color),m.opacity.value=d.opacity,m.size.value=d.size*w,m.scale.value=T*.5,d.map&&(m.map.value=d.map,e(d.map,m.uvTransform)),d.alphaMap&&(m.alphaMap.value=d.alphaMap,e(d.alphaMap,m.alphaMapTransform)),d.alphaTest>0&&(m.alphaTest.value=d.alphaTest)}function c(m,d){m.diffuse.value.copy(d.color),m.opacity.value=d.opacity,m.rotation.value=d.rotation,d.map&&(m.map.value=d.map,e(d.map,m.mapTransform)),d.alphaMap&&(m.alphaMap.value=d.alphaMap,e(d.alphaMap,m.alphaMapTransform)),d.alphaTest>0&&(m.alphaTest.value=d.alphaTest)}function u(m,d){m.specular.value.copy(d.specular),m.shininess.value=Math.max(d.shininess,1e-4)}function h(m,d){d.gradientMap&&(m.gradientMap.value=d.gradientMap)}function f(m,d){m.metalness.value=d.metalness,d.metalnessMap&&(m.metalnessMap.value=d.metalnessMap,e(d.metalnessMap,m.metalnessMapTransform)),m.roughness.value=d.roughness,d.roughnessMap&&(m.roughnessMap.value=d.roughnessMap,e(d.roughnessMap,m.roughnessMapTransform)),d.envMap&&(m.envMapIntensity.value=d.envMapIntensity)}function p(m,d,w){m.ior.value=d.ior,d.sheen>0&&(m.sheenColor.value.copy(d.sheenColor).multiplyScalar(d.sheen),m.sheenRoughness.value=d.sheenRoughness,d.sheenColorMap&&(m.sheenColorMap.value=d.sheenColorMap,e(d.sheenColorMap,m.sheenColorMapTransform)),d.sheenRoughnessMap&&(m.sheenRoughnessMap.value=d.sheenRoughnessMap,e(d.sheenRoughnessMap,m.sheenRoughnessMapTransform))),d.clearcoat>0&&(m.clearcoat.value=d.clearcoat,m.clearcoatRoughness.value=d.clearcoatRoughness,d.clearcoatMap&&(m.clearcoatMap.value=d.clearcoatMap,e(d.clearcoatMap,m.clearcoatMapTransform)),d.clearcoatRoughnessMap&&(m.clearcoatRoughnessMap.value=d.clearcoatRoughnessMap,e(d.clearcoatRoughnessMap,m.clearcoatRoughnessMapTransform)),d.clearcoatNormalMap&&(m.clearcoatNormalMap.value=d.clearcoatNormalMap,e(d.clearcoatNormalMap,m.clearcoatNormalMapTransform),m.clearcoatNormalScale.value.copy(d.clearcoatNormalScale),d.side===tn&&m.clearcoatNormalScale.value.negate())),d.dispersion>0&&(m.dispersion.value=d.dispersion),d.iridescence>0&&(m.iridescence.value=d.iridescence,m.iridescenceIOR.value=d.iridescenceIOR,m.iridescenceThicknessMinimum.value=d.iridescenceThicknessRange[0],m.iridescenceThicknessMaximum.value=d.iridescenceThicknessRange[1],d.iridescenceMap&&(m.iridescenceMap.value=d.iridescenceMap,e(d.iridescenceMap,m.iridescenceMapTransform)),d.iridescenceThicknessMap&&(m.iridescenceThicknessMap.value=d.iridescenceThicknessMap,e(d.iridescenceThicknessMap,m.iridescenceThicknessMapTransform))),d.transmission>0&&(m.transmission.value=d.transmission,m.transmissionSamplerMap.value=w.texture,m.transmissionSamplerSize.value.set(w.width,w.height),d.transmissionMap&&(m.transmissionMap.value=d.transmissionMap,e(d.transmissionMap,m.transmissionMapTransform)),m.thickness.value=d.thickness,d.thicknessMap&&(m.thicknessMap.value=d.thicknessMap,e(d.thicknessMap,m.thicknessMapTransform)),m.attenuationDistance.value=d.attenuationDistance,m.attenuationColor.value.copy(d.attenuationColor)),d.anisotropy>0&&(m.anisotropyVector.value.set(d.anisotropy*Math.cos(d.anisotropyRotation),d.anisotropy*Math.sin(d.anisotropyRotation)),d.anisotropyMap&&(m.anisotropyMap.value=d.anisotropyMap,e(d.anisotropyMap,m.anisotropyMapTransform))),m.specularIntensity.value=d.specularIntensity,m.specularColor.value.copy(d.specularColor),d.specularColorMap&&(m.specularColorMap.value=d.specularColorMap,e(d.specularColorMap,m.specularColorMapTransform)),d.specularIntensityMap&&(m.specularIntensityMap.value=d.specularIntensityMap,e(d.specularIntensityMap,m.specularIntensityMapTransform))}function g(m,d){d.matcap&&(m.matcap.value=d.matcap)}function _(m,d){const w=t.get(d).light;m.referencePosition.value.setFromMatrixPosition(w.matrixWorld),m.nearDistance.value=w.shadow.camera.near,m.farDistance.value=w.shadow.camera.far}return{refreshFogUniforms:i,refreshMaterialUniforms:s}}function z0(n,t,e,i){let s={},r={},o=[];const a=n.getParameter(n.MAX_UNIFORM_BUFFER_BINDINGS);function l(w,T){const S=T.program;i.uniformBlockBinding(w,S)}function c(w,T){let S=s[w.id];S===void 0&&(g(w),S=u(w),s[w.id]=S,w.addEventListener("dispose",m));const R=T.program;i.updateUBOMapping(w,R);const E=t.render.frame;r[w.id]!==E&&(f(w),r[w.id]=E)}function u(w){const T=h();w.__bindingPointIndex=T;const S=n.createBuffer(),R=w.__size,E=w.usage;return n.bindBuffer(n.UNIFORM_BUFFER,S),n.bufferData(n.UNIFORM_BUFFER,R,E),n.bindBuffer(n.UNIFORM_BUFFER,null),n.bindBufferBase(n.UNIFORM_BUFFER,T,S),S}function h(){for(let w=0;w<a;w++)if(o.indexOf(w)===-1)return o.push(w),w;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function f(w){const T=s[w.id],S=w.uniforms,R=w.__cache;n.bindBuffer(n.UNIFORM_BUFFER,T);for(let E=0,b=S.length;E<b;E++){const P=Array.isArray(S[E])?S[E]:[S[E]];for(let y=0,x=P.length;y<x;y++){const L=P[y];if(p(L,E,y,R)===!0){const O=L.__offset,B=Array.isArray(L.value)?L.value:[L.value];let Y=0;for(let Z=0;Z<B.length;Z++){const V=B[Z],q=_(V);typeof V=="number"||typeof V=="boolean"?(L.__data[0]=V,n.bufferSubData(n.UNIFORM_BUFFER,O+Y,L.__data)):V.isMatrix3?(L.__data[0]=V.elements[0],L.__data[1]=V.elements[1],L.__data[2]=V.elements[2],L.__data[3]=0,L.__data[4]=V.elements[3],L.__data[5]=V.elements[4],L.__data[6]=V.elements[5],L.__data[7]=0,L.__data[8]=V.elements[6],L.__data[9]=V.elements[7],L.__data[10]=V.elements[8],L.__data[11]=0):(V.toArray(L.__data,Y),Y+=q.storage/Float32Array.BYTES_PER_ELEMENT)}n.bufferSubData(n.UNIFORM_BUFFER,O,L.__data)}}}n.bindBuffer(n.UNIFORM_BUFFER,null)}function p(w,T,S,R){const E=w.value,b=T+"_"+S;if(R[b]===void 0)return typeof E=="number"||typeof E=="boolean"?R[b]=E:R[b]=E.clone(),!0;{const P=R[b];if(typeof E=="number"||typeof E=="boolean"){if(P!==E)return R[b]=E,!0}else if(P.equals(E)===!1)return P.copy(E),!0}return!1}function g(w){const T=w.uniforms;let S=0;const R=16;for(let b=0,P=T.length;b<P;b++){const y=Array.isArray(T[b])?T[b]:[T[b]];for(let x=0,L=y.length;x<L;x++){const O=y[x],B=Array.isArray(O.value)?O.value:[O.value];for(let Y=0,Z=B.length;Y<Z;Y++){const V=B[Y],q=_(V),X=S%R,rt=X%q.boundary,ut=X+rt;S+=rt,ut!==0&&R-ut<q.storage&&(S+=R-ut),O.__data=new Float32Array(q.storage/Float32Array.BYTES_PER_ELEMENT),O.__offset=S,S+=q.storage}}}const E=S%R;return E>0&&(S+=R-E),w.__size=S,w.__cache={},this}function _(w){const T={boundary:0,storage:0};return typeof w=="number"||typeof w=="boolean"?(T.boundary=4,T.storage=4):w.isVector2?(T.boundary=8,T.storage=8):w.isVector3||w.isColor?(T.boundary=16,T.storage=12):w.isVector4?(T.boundary=16,T.storage=16):w.isMatrix3?(T.boundary=48,T.storage=48):w.isMatrix4?(T.boundary=64,T.storage=64):w.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",w),T}function m(w){const T=w.target;T.removeEventListener("dispose",m);const S=o.indexOf(T.__bindingPointIndex);o.splice(S,1),n.deleteBuffer(s[T.id]),delete s[T.id],delete r[T.id]}function d(){for(const w in s)n.deleteBuffer(s[w]);o=[],s={},r={}}return{bind:l,update:c,dispose:d}}class H0{constructor(t={}){const{canvas:e=mh(),context:i=null,depth:s=!0,stencil:r=!1,alpha:o=!1,antialias:a=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:u="default",failIfMajorPerformanceCaveat:h=!1,reverseDepthBuffer:f=!1}=t;this.isWebGLRenderer=!0;let p;if(i!==null){if(typeof WebGLRenderingContext<"u"&&i instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");p=i.getContextAttributes().alpha}else p=o;const g=new Uint32Array(4),_=new Int32Array(4);let m=null,d=null;const w=[],T=[];this.domElement=e,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=ii,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const S=this;let R=!1;this._outputColorSpace=Je;let E=0,b=0,P=null,y=-1,x=null;const L=new de,O=new de;let B=null;const Y=new $t(0);let Z=0,V=e.width,q=e.height,X=1,rt=null,ut=null;const xt=new de(0,0,V,q),Ht=new de(0,0,V,q);let oe=!1;const K=new Ra;let st=!1,St=!1;const ht=new Se,bt=new Se,Zt=new N,yt=new de,qt={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let Te=!1;function se(){return P===null?X:1}let D=i;function $e(M,U){return e.getContext(M,U)}try{const M={alpha:!0,depth:s,stencil:r,antialias:a,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:u,failIfMajorPerformanceCaveat:h};if("setAttribute"in e&&e.setAttribute("data-engine",`three.js r${_a}`),e.addEventListener("webglcontextlost",gt,!1),e.addEventListener("webglcontextrestored",nt,!1),e.addEventListener("webglcontextcreationerror",J,!1),D===null){const U="webgl2";if(D=$e(U,M),D===null)throw $e(U)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(M){throw console.error("THREE.WebGLRenderer: "+M.message),M}let re,ge,Et,ee,Pt,kt,Ne,A,v,z,j,Q,$,wt,ct,Mt,At,tt,pt,It,Dt,at,Ft,I;function dt(){re=new Zp(D),re.init(),at=new D0(D,re),ge=new Vp(D,re,t,at),Et=new P0(D,re),ge.reverseDepthBuffer&&f&&Et.buffers.depth.setReversed(!0),ee=new Qp(D),Pt=new _0,kt=new L0(D,re,Et,Pt,ge,at,ee),Ne=new Xp(S),A=new Kp(S),v=new sd(D),Ft=new kp(D,v),z=new jp(D,v,ee,Ft),j=new em(D,z,v,ee),pt=new tm(D,ge,kt),Mt=new Wp(Pt),Q=new g0(S,Ne,A,re,ge,Ft,Mt),$=new B0(S,Pt),wt=new x0,ct=new b0(re),tt=new Hp(S,Ne,A,Et,j,p,l),At=new R0(S,j,ge),I=new z0(D,ee,ge,Et),It=new Gp(D,re,ee),Dt=new Jp(D,re,ee),ee.programs=Q.programs,S.capabilities=ge,S.extensions=re,S.properties=Pt,S.renderLists=wt,S.shadowMap=At,S.state=Et,S.info=ee}dt();const et=new F0(S,D);this.xr=et,this.getContext=function(){return D},this.getContextAttributes=function(){return D.getContextAttributes()},this.forceContextLoss=function(){const M=re.get("WEBGL_lose_context");M&&M.loseContext()},this.forceContextRestore=function(){const M=re.get("WEBGL_lose_context");M&&M.restoreContext()},this.getPixelRatio=function(){return X},this.setPixelRatio=function(M){M!==void 0&&(X=M,this.setSize(V,q,!1))},this.getSize=function(M){return M.set(V,q)},this.setSize=function(M,U,k=!0){if(et.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}V=M,q=U,e.width=Math.floor(M*X),e.height=Math.floor(U*X),k===!0&&(e.style.width=M+"px",e.style.height=U+"px"),this.setViewport(0,0,M,U)},this.getDrawingBufferSize=function(M){return M.set(V*X,q*X).floor()},this.setDrawingBufferSize=function(M,U,k){V=M,q=U,X=k,e.width=Math.floor(M*k),e.height=Math.floor(U*k),this.setViewport(0,0,M,U)},this.getCurrentViewport=function(M){return M.copy(L)},this.getViewport=function(M){return M.copy(xt)},this.setViewport=function(M,U,k,G){M.isVector4?xt.set(M.x,M.y,M.z,M.w):xt.set(M,U,k,G),Et.viewport(L.copy(xt).multiplyScalar(X).round())},this.getScissor=function(M){return M.copy(Ht)},this.setScissor=function(M,U,k,G){M.isVector4?Ht.set(M.x,M.y,M.z,M.w):Ht.set(M,U,k,G),Et.scissor(O.copy(Ht).multiplyScalar(X).round())},this.getScissorTest=function(){return oe},this.setScissorTest=function(M){Et.setScissorTest(oe=M)},this.setOpaqueSort=function(M){rt=M},this.setTransparentSort=function(M){ut=M},this.getClearColor=function(M){return M.copy(tt.getClearColor())},this.setClearColor=function(){tt.setClearColor(...arguments)},this.getClearAlpha=function(){return tt.getClearAlpha()},this.setClearAlpha=function(){tt.setClearAlpha(...arguments)},this.clear=function(M=!0,U=!0,k=!0){let G=0;if(M){let F=!1;if(P!==null){const it=P.texture.format;F=it===Ea||it===ya||it===Sa}if(F){const it=P.texture.type,ft=it===Dn||it===Ai||it===bs||it===ws||it===xa||it===Ma,vt=tt.getClearColor(),mt=tt.getClearAlpha(),Ut=vt.r,Nt=vt.g,Rt=vt.b;ft?(g[0]=Ut,g[1]=Nt,g[2]=Rt,g[3]=mt,D.clearBufferuiv(D.COLOR,0,g)):(_[0]=Ut,_[1]=Nt,_[2]=Rt,_[3]=mt,D.clearBufferiv(D.COLOR,0,_))}else G|=D.COLOR_BUFFER_BIT}U&&(G|=D.DEPTH_BUFFER_BIT),k&&(G|=D.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),D.clear(G)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){e.removeEventListener("webglcontextlost",gt,!1),e.removeEventListener("webglcontextrestored",nt,!1),e.removeEventListener("webglcontextcreationerror",J,!1),tt.dispose(),wt.dispose(),ct.dispose(),Pt.dispose(),Ne.dispose(),A.dispose(),j.dispose(),Ft.dispose(),I.dispose(),Q.dispose(),et.dispose(),et.removeEventListener("sessionstart",$a),et.removeEventListener("sessionend",Ka),ai.stop()};function gt(M){M.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),R=!0}function nt(){console.log("THREE.WebGLRenderer: Context Restored."),R=!1;const M=ee.autoReset,U=At.enabled,k=At.autoUpdate,G=At.needsUpdate,F=At.type;dt(),ee.autoReset=M,At.enabled=U,At.autoUpdate=k,At.needsUpdate=G,At.type=F}function J(M){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",M.statusMessage)}function _t(M){const U=M.target;U.removeEventListener("dispose",_t),Ot(U)}function Ot(M){xe(M),Pt.remove(M)}function xe(M){const U=Pt.get(M).programs;U!==void 0&&(U.forEach(function(k){Q.releaseProgram(k)}),M.isShaderMaterial&&Q.releaseShaderCache(M))}this.renderBufferDirect=function(M,U,k,G,F,it){U===null&&(U=qt);const ft=F.isMesh&&F.matrixWorld.determinant()<0,vt=yu(M,U,k,G,F);Et.setMaterial(G,ft);let mt=k.index,Ut=1;if(G.wireframe===!0){if(mt=z.getWireframeAttribute(k),mt===void 0)return;Ut=2}const Nt=k.drawRange,Rt=k.attributes.position;let Yt=Nt.start*Ut,ue=(Nt.start+Nt.count)*Ut;it!==null&&(Yt=Math.max(Yt,it.start*Ut),ue=Math.min(ue,(it.start+it.count)*Ut)),mt!==null?(Yt=Math.max(Yt,0),ue=Math.min(ue,mt.count)):Rt!=null&&(Yt=Math.max(Yt,0),ue=Math.min(ue,Rt.count));const Ce=ue-Yt;if(Ce<0||Ce===1/0)return;Ft.setup(F,G,vt,k,mt);let Me,pe=It;if(mt!==null&&(Me=v.get(mt),pe=Dt,pe.setIndex(Me)),F.isMesh)G.wireframe===!0?(Et.setLineWidth(G.wireframeLinewidth*se()),pe.setMode(D.LINES)):pe.setMode(D.TRIANGLES);else if(F.isLine){let Lt=G.linewidth;Lt===void 0&&(Lt=1),Et.setLineWidth(Lt*se()),F.isLineSegments?pe.setMode(D.LINES):F.isLineLoop?pe.setMode(D.LINE_LOOP):pe.setMode(D.LINE_STRIP)}else F.isPoints?pe.setMode(D.POINTS):F.isSprite&&pe.setMode(D.TRIANGLES);if(F.isBatchedMesh)if(F._multiDrawInstances!==null)$i("THREE.WebGLRenderer: renderMultiDrawInstances has been deprecated and will be removed in r184. Append to renderMultiDraw arguments and use indirection."),pe.renderMultiDrawInstances(F._multiDrawStarts,F._multiDrawCounts,F._multiDrawCount,F._multiDrawInstances);else if(re.get("WEBGL_multi_draw"))pe.renderMultiDraw(F._multiDrawStarts,F._multiDrawCounts,F._multiDrawCount);else{const Lt=F._multiDrawStarts,be=F._multiDrawCounts,ne=F._multiDrawCount,an=mt?v.get(mt).bytesPerElement:1,Li=Pt.get(G).currentProgram.getUniforms();for(let ln=0;ln<ne;ln++)Li.setValue(D,"_gl_DrawID",ln),pe.render(Lt[ln]/an,be[ln])}else if(F.isInstancedMesh)pe.renderInstances(Yt,Ce,F.count);else if(k.isInstancedBufferGeometry){const Lt=k._maxInstanceCount!==void 0?k._maxInstanceCount:1/0,be=Math.min(k.instanceCount,Lt);pe.renderInstances(Yt,Ce,be)}else pe.render(Yt,Ce)};function ae(M,U,k){M.transparent===!0&&M.side===Rn&&M.forceSinglePass===!1?(M.side=tn,M.needsUpdate=!0,Bs(M,U,k),M.side=si,M.needsUpdate=!0,Bs(M,U,k),M.side=Rn):Bs(M,U,k)}this.compile=function(M,U,k=null){k===null&&(k=M),d=ct.get(k),d.init(U),T.push(d),k.traverseVisible(function(F){F.isLight&&F.layers.test(U.layers)&&(d.pushLight(F),F.castShadow&&d.pushShadow(F))}),M!==k&&M.traverseVisible(function(F){F.isLight&&F.layers.test(U.layers)&&(d.pushLight(F),F.castShadow&&d.pushShadow(F))}),d.setupLights();const G=new Set;return M.traverse(function(F){if(!(F.isMesh||F.isPoints||F.isLine||F.isSprite))return;const it=F.material;if(it)if(Array.isArray(it))for(let ft=0;ft<it.length;ft++){const vt=it[ft];ae(vt,k,F),G.add(vt)}else ae(it,k,F),G.add(it)}),d=T.pop(),G},this.compileAsync=function(M,U,k=null){const G=this.compile(M,U,k);return new Promise(F=>{function it(){if(G.forEach(function(ft){Pt.get(ft).currentProgram.isReady()&&G.delete(ft)}),G.size===0){F(M);return}setTimeout(it,10)}re.get("KHR_parallel_shader_compile")!==null?it():setTimeout(it,10)})};let gn=null;function Un(M){gn&&gn(M)}function $a(){ai.stop()}function Ka(){ai.start()}const ai=new Xc;ai.setAnimationLoop(Un),typeof self<"u"&&ai.setContext(self),this.setAnimationLoop=function(M){gn=M,et.setAnimationLoop(M),M===null?ai.stop():ai.start()},et.addEventListener("sessionstart",$a),et.addEventListener("sessionend",Ka),this.render=function(M,U){if(U!==void 0&&U.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(R===!0)return;if(M.matrixWorldAutoUpdate===!0&&M.updateMatrixWorld(),U.parent===null&&U.matrixWorldAutoUpdate===!0&&U.updateMatrixWorld(),et.enabled===!0&&et.isPresenting===!0&&(et.cameraAutoUpdate===!0&&et.updateCamera(U),U=et.getCamera()),M.isScene===!0&&M.onBeforeRender(S,M,U,P),d=ct.get(M,T.length),d.init(U),T.push(d),bt.multiplyMatrices(U.projectionMatrix,U.matrixWorldInverse),K.setFromProjectionMatrix(bt),St=this.localClippingEnabled,st=Mt.init(this.clippingPlanes,St),m=wt.get(M,w.length),m.init(),w.push(m),et.enabled===!0&&et.isPresenting===!0){const it=S.xr.getDepthSensingMesh();it!==null&&Lr(it,U,-1/0,S.sortObjects)}Lr(M,U,0,S.sortObjects),m.finish(),S.sortObjects===!0&&m.sort(rt,ut),Te=et.enabled===!1||et.isPresenting===!1||et.hasDepthSensing()===!1,Te&&tt.addToRenderList(m,M),this.info.render.frame++,st===!0&&Mt.beginShadows();const k=d.state.shadowsArray;At.render(k,M,U),st===!0&&Mt.endShadows(),this.info.autoReset===!0&&this.info.reset();const G=m.opaque,F=m.transmissive;if(d.setupLights(),U.isArrayCamera){const it=U.cameras;if(F.length>0)for(let ft=0,vt=it.length;ft<vt;ft++){const mt=it[ft];ja(G,F,M,mt)}Te&&tt.render(M);for(let ft=0,vt=it.length;ft<vt;ft++){const mt=it[ft];Za(m,M,mt,mt.viewport)}}else F.length>0&&ja(G,F,M,U),Te&&tt.render(M),Za(m,M,U);P!==null&&b===0&&(kt.updateMultisampleRenderTarget(P),kt.updateRenderTargetMipmap(P)),M.isScene===!0&&M.onAfterRender(S,M,U),Ft.resetDefaultState(),y=-1,x=null,T.pop(),T.length>0?(d=T[T.length-1],st===!0&&Mt.setGlobalState(S.clippingPlanes,d.state.camera)):d=null,w.pop(),w.length>0?m=w[w.length-1]:m=null};function Lr(M,U,k,G){if(M.visible===!1)return;if(M.layers.test(U.layers)){if(M.isGroup)k=M.renderOrder;else if(M.isLOD)M.autoUpdate===!0&&M.update(U);else if(M.isLight)d.pushLight(M),M.castShadow&&d.pushShadow(M);else if(M.isSprite){if(!M.frustumCulled||K.intersectsSprite(M)){G&&yt.setFromMatrixPosition(M.matrixWorld).applyMatrix4(bt);const ft=j.update(M),vt=M.material;vt.visible&&m.push(M,ft,vt,k,yt.z,null)}}else if((M.isMesh||M.isLine||M.isPoints)&&(!M.frustumCulled||K.intersectsObject(M))){const ft=j.update(M),vt=M.material;if(G&&(M.boundingSphere!==void 0?(M.boundingSphere===null&&M.computeBoundingSphere(),yt.copy(M.boundingSphere.center)):(ft.boundingSphere===null&&ft.computeBoundingSphere(),yt.copy(ft.boundingSphere.center)),yt.applyMatrix4(M.matrixWorld).applyMatrix4(bt)),Array.isArray(vt)){const mt=ft.groups;for(let Ut=0,Nt=mt.length;Ut<Nt;Ut++){const Rt=mt[Ut],Yt=vt[Rt.materialIndex];Yt&&Yt.visible&&m.push(M,ft,Yt,k,yt.z,Rt)}}else vt.visible&&m.push(M,ft,vt,k,yt.z,null)}}const it=M.children;for(let ft=0,vt=it.length;ft<vt;ft++)Lr(it[ft],U,k,G)}function Za(M,U,k,G){const F=M.opaque,it=M.transmissive,ft=M.transparent;d.setupLightsView(k),st===!0&&Mt.setGlobalState(S.clippingPlanes,k),G&&Et.viewport(L.copy(G)),F.length>0&&Os(F,U,k),it.length>0&&Os(it,U,k),ft.length>0&&Os(ft,U,k),Et.buffers.depth.setTest(!0),Et.buffers.depth.setMask(!0),Et.buffers.color.setMask(!0),Et.setPolygonOffset(!1)}function ja(M,U,k,G){if((k.isScene===!0?k.overrideMaterial:null)!==null)return;d.state.transmissionRenderTarget[G.id]===void 0&&(d.state.transmissionRenderTarget[G.id]=new Ri(1,1,{generateMipmaps:!0,type:re.has("EXT_color_buffer_half_float")||re.has("EXT_color_buffer_float")?Ds:Dn,minFilter:Ti,samples:4,stencilBuffer:r,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:ie.workingColorSpace}));const it=d.state.transmissionRenderTarget[G.id],ft=G.viewport||L;it.setSize(ft.z*S.transmissionResolutionScale,ft.w*S.transmissionResolutionScale);const vt=S.getRenderTarget(),mt=S.getActiveCubeFace(),Ut=S.getActiveMipmapLevel();S.setRenderTarget(it),S.getClearColor(Y),Z=S.getClearAlpha(),Z<1&&S.setClearColor(16777215,.5),S.clear(),Te&&tt.render(k);const Nt=S.toneMapping;S.toneMapping=ii;const Rt=G.viewport;if(G.viewport!==void 0&&(G.viewport=void 0),d.setupLightsView(G),st===!0&&Mt.setGlobalState(S.clippingPlanes,G),Os(M,k,G),kt.updateMultisampleRenderTarget(it),kt.updateRenderTargetMipmap(it),re.has("WEBGL_multisampled_render_to_texture")===!1){let Yt=!1;for(let ue=0,Ce=U.length;ue<Ce;ue++){const Me=U[ue],pe=Me.object,Lt=Me.geometry,be=Me.material,ne=Me.group;if(be.side===Rn&&pe.layers.test(G.layers)){const an=be.side;be.side=tn,be.needsUpdate=!0,Ja(pe,k,G,Lt,be,ne),be.side=an,be.needsUpdate=!0,Yt=!0}}Yt===!0&&(kt.updateMultisampleRenderTarget(it),kt.updateRenderTargetMipmap(it))}S.setRenderTarget(vt,mt,Ut),S.setClearColor(Y,Z),Rt!==void 0&&(G.viewport=Rt),S.toneMapping=Nt}function Os(M,U,k){const G=U.isScene===!0?U.overrideMaterial:null;for(let F=0,it=M.length;F<it;F++){const ft=M[F],vt=ft.object,mt=ft.geometry,Ut=ft.group;let Nt=ft.material;Nt.allowOverride===!0&&G!==null&&(Nt=G),vt.layers.test(k.layers)&&Ja(vt,U,k,mt,Nt,Ut)}}function Ja(M,U,k,G,F,it){M.onBeforeRender(S,U,k,G,F,it),M.modelViewMatrix.multiplyMatrices(k.matrixWorldInverse,M.matrixWorld),M.normalMatrix.getNormalMatrix(M.modelViewMatrix),F.onBeforeRender(S,U,k,G,M,it),F.transparent===!0&&F.side===Rn&&F.forceSinglePass===!1?(F.side=tn,F.needsUpdate=!0,S.renderBufferDirect(k,U,G,F,M,it),F.side=si,F.needsUpdate=!0,S.renderBufferDirect(k,U,G,F,M,it),F.side=Rn):S.renderBufferDirect(k,U,G,F,M,it),M.onAfterRender(S,U,k,G,F,it)}function Bs(M,U,k){U.isScene!==!0&&(U=qt);const G=Pt.get(M),F=d.state.lights,it=d.state.shadowsArray,ft=F.state.version,vt=Q.getParameters(M,F.state,it,U,k),mt=Q.getProgramCacheKey(vt);let Ut=G.programs;G.environment=M.isMeshStandardMaterial?U.environment:null,G.fog=U.fog,G.envMap=(M.isMeshStandardMaterial?A:Ne).get(M.envMap||G.environment),G.envMapRotation=G.environment!==null&&M.envMap===null?U.environmentRotation:M.envMapRotation,Ut===void 0&&(M.addEventListener("dispose",_t),Ut=new Map,G.programs=Ut);let Nt=Ut.get(mt);if(Nt!==void 0){if(G.currentProgram===Nt&&G.lightsStateVersion===ft)return tl(M,vt),Nt}else vt.uniforms=Q.getUniforms(M),M.onBeforeCompile(vt,S),Nt=Q.acquireProgram(vt,mt),Ut.set(mt,Nt),G.uniforms=vt.uniforms;const Rt=G.uniforms;return(!M.isShaderMaterial&&!M.isRawShaderMaterial||M.clipping===!0)&&(Rt.clippingPlanes=Mt.uniform),tl(M,vt),G.needsLights=Tu(M),G.lightsStateVersion=ft,G.needsLights&&(Rt.ambientLightColor.value=F.state.ambient,Rt.lightProbe.value=F.state.probe,Rt.directionalLights.value=F.state.directional,Rt.directionalLightShadows.value=F.state.directionalShadow,Rt.spotLights.value=F.state.spot,Rt.spotLightShadows.value=F.state.spotShadow,Rt.rectAreaLights.value=F.state.rectArea,Rt.ltc_1.value=F.state.rectAreaLTC1,Rt.ltc_2.value=F.state.rectAreaLTC2,Rt.pointLights.value=F.state.point,Rt.pointLightShadows.value=F.state.pointShadow,Rt.hemisphereLights.value=F.state.hemi,Rt.directionalShadowMap.value=F.state.directionalShadowMap,Rt.directionalShadowMatrix.value=F.state.directionalShadowMatrix,Rt.spotShadowMap.value=F.state.spotShadowMap,Rt.spotLightMatrix.value=F.state.spotLightMatrix,Rt.spotLightMap.value=F.state.spotLightMap,Rt.pointShadowMap.value=F.state.pointShadowMap,Rt.pointShadowMatrix.value=F.state.pointShadowMatrix),G.currentProgram=Nt,G.uniformsList=null,Nt}function Qa(M){if(M.uniformsList===null){const U=M.currentProgram.getUniforms();M.uniformsList=mr.seqWithValue(U.seq,M.uniforms)}return M.uniformsList}function tl(M,U){const k=Pt.get(M);k.outputColorSpace=U.outputColorSpace,k.batching=U.batching,k.batchingColor=U.batchingColor,k.instancing=U.instancing,k.instancingColor=U.instancingColor,k.instancingMorph=U.instancingMorph,k.skinning=U.skinning,k.morphTargets=U.morphTargets,k.morphNormals=U.morphNormals,k.morphColors=U.morphColors,k.morphTargetsCount=U.morphTargetsCount,k.numClippingPlanes=U.numClippingPlanes,k.numIntersection=U.numClipIntersection,k.vertexAlphas=U.vertexAlphas,k.vertexTangents=U.vertexTangents,k.toneMapping=U.toneMapping}function yu(M,U,k,G,F){U.isScene!==!0&&(U=qt),kt.resetTextureUnits();const it=U.fog,ft=G.isMeshStandardMaterial?U.environment:null,vt=P===null?S.outputColorSpace:P.isXRRenderTarget===!0?P.texture.colorSpace:es,mt=(G.isMeshStandardMaterial?A:Ne).get(G.envMap||ft),Ut=G.vertexColors===!0&&!!k.attributes.color&&k.attributes.color.itemSize===4,Nt=!!k.attributes.tangent&&(!!G.normalMap||G.anisotropy>0),Rt=!!k.morphAttributes.position,Yt=!!k.morphAttributes.normal,ue=!!k.morphAttributes.color;let Ce=ii;G.toneMapped&&(P===null||P.isXRRenderTarget===!0)&&(Ce=S.toneMapping);const Me=k.morphAttributes.position||k.morphAttributes.normal||k.morphAttributes.color,pe=Me!==void 0?Me.length:0,Lt=Pt.get(G),be=d.state.lights;if(st===!0&&(St===!0||M!==x)){const Ke=M===x&&G.id===y;Mt.setState(G,M,Ke)}let ne=!1;G.version===Lt.__version?(Lt.needsLights&&Lt.lightsStateVersion!==be.state.version||Lt.outputColorSpace!==vt||F.isBatchedMesh&&Lt.batching===!1||!F.isBatchedMesh&&Lt.batching===!0||F.isBatchedMesh&&Lt.batchingColor===!0&&F.colorTexture===null||F.isBatchedMesh&&Lt.batchingColor===!1&&F.colorTexture!==null||F.isInstancedMesh&&Lt.instancing===!1||!F.isInstancedMesh&&Lt.instancing===!0||F.isSkinnedMesh&&Lt.skinning===!1||!F.isSkinnedMesh&&Lt.skinning===!0||F.isInstancedMesh&&Lt.instancingColor===!0&&F.instanceColor===null||F.isInstancedMesh&&Lt.instancingColor===!1&&F.instanceColor!==null||F.isInstancedMesh&&Lt.instancingMorph===!0&&F.morphTexture===null||F.isInstancedMesh&&Lt.instancingMorph===!1&&F.morphTexture!==null||Lt.envMap!==mt||G.fog===!0&&Lt.fog!==it||Lt.numClippingPlanes!==void 0&&(Lt.numClippingPlanes!==Mt.numPlanes||Lt.numIntersection!==Mt.numIntersection)||Lt.vertexAlphas!==Ut||Lt.vertexTangents!==Nt||Lt.morphTargets!==Rt||Lt.morphNormals!==Yt||Lt.morphColors!==ue||Lt.toneMapping!==Ce||Lt.morphTargetsCount!==pe)&&(ne=!0):(ne=!0,Lt.__version=G.version);let an=Lt.currentProgram;ne===!0&&(an=Bs(G,U,F));let Li=!1,ln=!1,hs=!1;const ye=an.getUniforms(),fn=Lt.uniforms;if(Et.useProgram(an.program)&&(Li=!0,ln=!0,hs=!0),G.id!==y&&(y=G.id,ln=!0),Li||x!==M){Et.buffers.depth.getReversed()?(ht.copy(M.projectionMatrix),_h(ht),vh(ht),ye.setValue(D,"projectionMatrix",ht)):ye.setValue(D,"projectionMatrix",M.projectionMatrix),ye.setValue(D,"viewMatrix",M.matrixWorldInverse);const nn=ye.map.cameraPosition;nn!==void 0&&nn.setValue(D,Zt.setFromMatrixPosition(M.matrixWorld)),ge.logarithmicDepthBuffer&&ye.setValue(D,"logDepthBufFC",2/(Math.log(M.far+1)/Math.LN2)),(G.isMeshPhongMaterial||G.isMeshToonMaterial||G.isMeshLambertMaterial||G.isMeshBasicMaterial||G.isMeshStandardMaterial||G.isShaderMaterial)&&ye.setValue(D,"isOrthographic",M.isOrthographicCamera===!0),x!==M&&(x=M,ln=!0,hs=!0)}if(F.isSkinnedMesh){ye.setOptional(D,F,"bindMatrix"),ye.setOptional(D,F,"bindMatrixInverse");const Ke=F.skeleton;Ke&&(Ke.boneTexture===null&&Ke.computeBoneTexture(),ye.setValue(D,"boneTexture",Ke.boneTexture,kt))}F.isBatchedMesh&&(ye.setOptional(D,F,"batchingTexture"),ye.setValue(D,"batchingTexture",F._matricesTexture,kt),ye.setOptional(D,F,"batchingIdTexture"),ye.setValue(D,"batchingIdTexture",F._indirectTexture,kt),ye.setOptional(D,F,"batchingColorTexture"),F._colorsTexture!==null&&ye.setValue(D,"batchingColorTexture",F._colorsTexture,kt));const pn=k.morphAttributes;if((pn.position!==void 0||pn.normal!==void 0||pn.color!==void 0)&&pt.update(F,k,an),(ln||Lt.receiveShadow!==F.receiveShadow)&&(Lt.receiveShadow=F.receiveShadow,ye.setValue(D,"receiveShadow",F.receiveShadow)),G.isMeshGouraudMaterial&&G.envMap!==null&&(fn.envMap.value=mt,fn.flipEnvMap.value=mt.isCubeTexture&&mt.isRenderTargetTexture===!1?-1:1),G.isMeshStandardMaterial&&G.envMap===null&&U.environment!==null&&(fn.envMapIntensity.value=U.environmentIntensity),ln&&(ye.setValue(D,"toneMappingExposure",S.toneMappingExposure),Lt.needsLights&&Eu(fn,hs),it&&G.fog===!0&&$.refreshFogUniforms(fn,it),$.refreshMaterialUniforms(fn,G,X,q,d.state.transmissionRenderTarget[M.id]),mr.upload(D,Qa(Lt),fn,kt)),G.isShaderMaterial&&G.uniformsNeedUpdate===!0&&(mr.upload(D,Qa(Lt),fn,kt),G.uniformsNeedUpdate=!1),G.isSpriteMaterial&&ye.setValue(D,"center",F.center),ye.setValue(D,"modelViewMatrix",F.modelViewMatrix),ye.setValue(D,"normalMatrix",F.normalMatrix),ye.setValue(D,"modelMatrix",F.matrixWorld),G.isShaderMaterial||G.isRawShaderMaterial){const Ke=G.uniformsGroups;for(let nn=0,Dr=Ke.length;nn<Dr;nn++){const li=Ke[nn];I.update(li,an),I.bind(li,an)}}return an}function Eu(M,U){M.ambientLightColor.needsUpdate=U,M.lightProbe.needsUpdate=U,M.directionalLights.needsUpdate=U,M.directionalLightShadows.needsUpdate=U,M.pointLights.needsUpdate=U,M.pointLightShadows.needsUpdate=U,M.spotLights.needsUpdate=U,M.spotLightShadows.needsUpdate=U,M.rectAreaLights.needsUpdate=U,M.hemisphereLights.needsUpdate=U}function Tu(M){return M.isMeshLambertMaterial||M.isMeshToonMaterial||M.isMeshPhongMaterial||M.isMeshStandardMaterial||M.isShadowMaterial||M.isShaderMaterial&&M.lights===!0}this.getActiveCubeFace=function(){return E},this.getActiveMipmapLevel=function(){return b},this.getRenderTarget=function(){return P},this.setRenderTargetTextures=function(M,U,k){const G=Pt.get(M);G.__autoAllocateDepthBuffer=M.resolveDepthBuffer===!1,G.__autoAllocateDepthBuffer===!1&&(G.__useRenderToTexture=!1),Pt.get(M.texture).__webglTexture=U,Pt.get(M.depthTexture).__webglTexture=G.__autoAllocateDepthBuffer?void 0:k,G.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(M,U){const k=Pt.get(M);k.__webglFramebuffer=U,k.__useDefaultFramebuffer=U===void 0};const bu=D.createFramebuffer();this.setRenderTarget=function(M,U=0,k=0){P=M,E=U,b=k;let G=!0,F=null,it=!1,ft=!1;if(M){const mt=Pt.get(M);if(mt.__useDefaultFramebuffer!==void 0)Et.bindFramebuffer(D.FRAMEBUFFER,null),G=!1;else if(mt.__webglFramebuffer===void 0)kt.setupRenderTarget(M);else if(mt.__hasExternalTextures)kt.rebindTextures(M,Pt.get(M.texture).__webglTexture,Pt.get(M.depthTexture).__webglTexture);else if(M.depthBuffer){const Rt=M.depthTexture;if(mt.__boundDepthTexture!==Rt){if(Rt!==null&&Pt.has(Rt)&&(M.width!==Rt.image.width||M.height!==Rt.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");kt.setupDepthRenderbuffer(M)}}const Ut=M.texture;(Ut.isData3DTexture||Ut.isDataArrayTexture||Ut.isCompressedArrayTexture)&&(ft=!0);const Nt=Pt.get(M).__webglFramebuffer;M.isWebGLCubeRenderTarget?(Array.isArray(Nt[U])?F=Nt[U][k]:F=Nt[U],it=!0):M.samples>0&&kt.useMultisampledRTT(M)===!1?F=Pt.get(M).__webglMultisampledFramebuffer:Array.isArray(Nt)?F=Nt[k]:F=Nt,L.copy(M.viewport),O.copy(M.scissor),B=M.scissorTest}else L.copy(xt).multiplyScalar(X).floor(),O.copy(Ht).multiplyScalar(X).floor(),B=oe;if(k!==0&&(F=bu),Et.bindFramebuffer(D.FRAMEBUFFER,F)&&G&&Et.drawBuffers(M,F),Et.viewport(L),Et.scissor(O),Et.setScissorTest(B),it){const mt=Pt.get(M.texture);D.framebufferTexture2D(D.FRAMEBUFFER,D.COLOR_ATTACHMENT0,D.TEXTURE_CUBE_MAP_POSITIVE_X+U,mt.__webglTexture,k)}else if(ft){const mt=Pt.get(M.texture),Ut=U;D.framebufferTextureLayer(D.FRAMEBUFFER,D.COLOR_ATTACHMENT0,mt.__webglTexture,k,Ut)}else if(M!==null&&k!==0){const mt=Pt.get(M.texture);D.framebufferTexture2D(D.FRAMEBUFFER,D.COLOR_ATTACHMENT0,D.TEXTURE_2D,mt.__webglTexture,k)}y=-1},this.readRenderTargetPixels=function(M,U,k,G,F,it,ft,vt=0){if(!(M&&M.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let mt=Pt.get(M).__webglFramebuffer;if(M.isWebGLCubeRenderTarget&&ft!==void 0&&(mt=mt[ft]),mt){Et.bindFramebuffer(D.FRAMEBUFFER,mt);try{const Ut=M.textures[vt],Nt=Ut.format,Rt=Ut.type;if(!ge.textureFormatReadable(Nt)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!ge.textureTypeReadable(Rt)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}U>=0&&U<=M.width-G&&k>=0&&k<=M.height-F&&(M.textures.length>1&&D.readBuffer(D.COLOR_ATTACHMENT0+vt),D.readPixels(U,k,G,F,at.convert(Nt),at.convert(Rt),it))}finally{const Ut=P!==null?Pt.get(P).__webglFramebuffer:null;Et.bindFramebuffer(D.FRAMEBUFFER,Ut)}}},this.readRenderTargetPixelsAsync=async function(M,U,k,G,F,it,ft,vt=0){if(!(M&&M.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let mt=Pt.get(M).__webglFramebuffer;if(M.isWebGLCubeRenderTarget&&ft!==void 0&&(mt=mt[ft]),mt)if(U>=0&&U<=M.width-G&&k>=0&&k<=M.height-F){Et.bindFramebuffer(D.FRAMEBUFFER,mt);const Ut=M.textures[vt],Nt=Ut.format,Rt=Ut.type;if(!ge.textureFormatReadable(Nt))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!ge.textureTypeReadable(Rt))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const Yt=D.createBuffer();D.bindBuffer(D.PIXEL_PACK_BUFFER,Yt),D.bufferData(D.PIXEL_PACK_BUFFER,it.byteLength,D.STREAM_READ),M.textures.length>1&&D.readBuffer(D.COLOR_ATTACHMENT0+vt),D.readPixels(U,k,G,F,at.convert(Nt),at.convert(Rt),0);const ue=P!==null?Pt.get(P).__webglFramebuffer:null;Et.bindFramebuffer(D.FRAMEBUFFER,ue);const Ce=D.fenceSync(D.SYNC_GPU_COMMANDS_COMPLETE,0);return D.flush(),await gh(D,Ce,4),D.bindBuffer(D.PIXEL_PACK_BUFFER,Yt),D.getBufferSubData(D.PIXEL_PACK_BUFFER,0,it),D.deleteBuffer(Yt),D.deleteSync(Ce),it}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(M,U=null,k=0){const G=Math.pow(2,-k),F=Math.floor(M.image.width*G),it=Math.floor(M.image.height*G),ft=U!==null?U.x:0,vt=U!==null?U.y:0;kt.setTexture2D(M,0),D.copyTexSubImage2D(D.TEXTURE_2D,k,0,0,ft,vt,F,it),Et.unbindTexture()};const wu=D.createFramebuffer(),Au=D.createFramebuffer();this.copyTextureToTexture=function(M,U,k=null,G=null,F=0,it=null){it===null&&(F!==0?($i("WebGLRenderer: copyTextureToTexture function signature has changed to support src and dst mipmap levels."),it=F,F=0):it=0);let ft,vt,mt,Ut,Nt,Rt,Yt,ue,Ce;const Me=M.isCompressedTexture?M.mipmaps[it]:M.image;if(k!==null)ft=k.max.x-k.min.x,vt=k.max.y-k.min.y,mt=k.isBox3?k.max.z-k.min.z:1,Ut=k.min.x,Nt=k.min.y,Rt=k.isBox3?k.min.z:0;else{const pn=Math.pow(2,-F);ft=Math.floor(Me.width*pn),vt=Math.floor(Me.height*pn),M.isDataArrayTexture?mt=Me.depth:M.isData3DTexture?mt=Math.floor(Me.depth*pn):mt=1,Ut=0,Nt=0,Rt=0}G!==null?(Yt=G.x,ue=G.y,Ce=G.z):(Yt=0,ue=0,Ce=0);const pe=at.convert(U.format),Lt=at.convert(U.type);let be;U.isData3DTexture?(kt.setTexture3D(U,0),be=D.TEXTURE_3D):U.isDataArrayTexture||U.isCompressedArrayTexture?(kt.setTexture2DArray(U,0),be=D.TEXTURE_2D_ARRAY):(kt.setTexture2D(U,0),be=D.TEXTURE_2D),D.pixelStorei(D.UNPACK_FLIP_Y_WEBGL,U.flipY),D.pixelStorei(D.UNPACK_PREMULTIPLY_ALPHA_WEBGL,U.premultiplyAlpha),D.pixelStorei(D.UNPACK_ALIGNMENT,U.unpackAlignment);const ne=D.getParameter(D.UNPACK_ROW_LENGTH),an=D.getParameter(D.UNPACK_IMAGE_HEIGHT),Li=D.getParameter(D.UNPACK_SKIP_PIXELS),ln=D.getParameter(D.UNPACK_SKIP_ROWS),hs=D.getParameter(D.UNPACK_SKIP_IMAGES);D.pixelStorei(D.UNPACK_ROW_LENGTH,Me.width),D.pixelStorei(D.UNPACK_IMAGE_HEIGHT,Me.height),D.pixelStorei(D.UNPACK_SKIP_PIXELS,Ut),D.pixelStorei(D.UNPACK_SKIP_ROWS,Nt),D.pixelStorei(D.UNPACK_SKIP_IMAGES,Rt);const ye=M.isDataArrayTexture||M.isData3DTexture,fn=U.isDataArrayTexture||U.isData3DTexture;if(M.isDepthTexture){const pn=Pt.get(M),Ke=Pt.get(U),nn=Pt.get(pn.__renderTarget),Dr=Pt.get(Ke.__renderTarget);Et.bindFramebuffer(D.READ_FRAMEBUFFER,nn.__webglFramebuffer),Et.bindFramebuffer(D.DRAW_FRAMEBUFFER,Dr.__webglFramebuffer);for(let li=0;li<mt;li++)ye&&(D.framebufferTextureLayer(D.READ_FRAMEBUFFER,D.COLOR_ATTACHMENT0,Pt.get(M).__webglTexture,F,Rt+li),D.framebufferTextureLayer(D.DRAW_FRAMEBUFFER,D.COLOR_ATTACHMENT0,Pt.get(U).__webglTexture,it,Ce+li)),D.blitFramebuffer(Ut,Nt,ft,vt,Yt,ue,ft,vt,D.DEPTH_BUFFER_BIT,D.NEAREST);Et.bindFramebuffer(D.READ_FRAMEBUFFER,null),Et.bindFramebuffer(D.DRAW_FRAMEBUFFER,null)}else if(F!==0||M.isRenderTargetTexture||Pt.has(M)){const pn=Pt.get(M),Ke=Pt.get(U);Et.bindFramebuffer(D.READ_FRAMEBUFFER,wu),Et.bindFramebuffer(D.DRAW_FRAMEBUFFER,Au);for(let nn=0;nn<mt;nn++)ye?D.framebufferTextureLayer(D.READ_FRAMEBUFFER,D.COLOR_ATTACHMENT0,pn.__webglTexture,F,Rt+nn):D.framebufferTexture2D(D.READ_FRAMEBUFFER,D.COLOR_ATTACHMENT0,D.TEXTURE_2D,pn.__webglTexture,F),fn?D.framebufferTextureLayer(D.DRAW_FRAMEBUFFER,D.COLOR_ATTACHMENT0,Ke.__webglTexture,it,Ce+nn):D.framebufferTexture2D(D.DRAW_FRAMEBUFFER,D.COLOR_ATTACHMENT0,D.TEXTURE_2D,Ke.__webglTexture,it),F!==0?D.blitFramebuffer(Ut,Nt,ft,vt,Yt,ue,ft,vt,D.COLOR_BUFFER_BIT,D.NEAREST):fn?D.copyTexSubImage3D(be,it,Yt,ue,Ce+nn,Ut,Nt,ft,vt):D.copyTexSubImage2D(be,it,Yt,ue,Ut,Nt,ft,vt);Et.bindFramebuffer(D.READ_FRAMEBUFFER,null),Et.bindFramebuffer(D.DRAW_FRAMEBUFFER,null)}else fn?M.isDataTexture||M.isData3DTexture?D.texSubImage3D(be,it,Yt,ue,Ce,ft,vt,mt,pe,Lt,Me.data):U.isCompressedArrayTexture?D.compressedTexSubImage3D(be,it,Yt,ue,Ce,ft,vt,mt,pe,Me.data):D.texSubImage3D(be,it,Yt,ue,Ce,ft,vt,mt,pe,Lt,Me):M.isDataTexture?D.texSubImage2D(D.TEXTURE_2D,it,Yt,ue,ft,vt,pe,Lt,Me.data):M.isCompressedTexture?D.compressedTexSubImage2D(D.TEXTURE_2D,it,Yt,ue,Me.width,Me.height,pe,Me.data):D.texSubImage2D(D.TEXTURE_2D,it,Yt,ue,ft,vt,pe,Lt,Me);D.pixelStorei(D.UNPACK_ROW_LENGTH,ne),D.pixelStorei(D.UNPACK_IMAGE_HEIGHT,an),D.pixelStorei(D.UNPACK_SKIP_PIXELS,Li),D.pixelStorei(D.UNPACK_SKIP_ROWS,ln),D.pixelStorei(D.UNPACK_SKIP_IMAGES,hs),it===0&&U.generateMipmaps&&D.generateMipmap(be),Et.unbindTexture()},this.copyTextureToTexture3D=function(M,U,k=null,G=null,F=0){return $i('WebGLRenderer: copyTextureToTexture3D function has been deprecated. Use "copyTextureToTexture" instead.'),this.copyTextureToTexture(M,U,k,G,F)},this.initRenderTarget=function(M){Pt.get(M).__webglFramebuffer===void 0&&kt.setupRenderTarget(M)},this.initTexture=function(M){M.isCubeTexture?kt.setTextureCube(M,0):M.isData3DTexture?kt.setTexture3D(M,0):M.isDataArrayTexture||M.isCompressedArrayTexture?kt.setTexture2DArray(M,0):kt.setTexture2D(M,0),Et.unbindTexture()},this.resetState=function(){E=0,b=0,P=null,Et.reset(),Ft.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return Gn}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(t){this._outputColorSpace=t;const e=this.getContext();e.drawingBufferColorSpace=ie._getDrawingBufferColorSpace(t),e.unpackColorSpace=ie._getUnpackColorSpace()}}const k0=[{id:"H-001",night:1,segment:1,category:"OBJ",rule:"gaze",effect:"blood_trail",reveal:"…바닥의 검붉은 자국은, 원래 없던 것이었다."},{id:"H-002",night:2,segment:1,category:"OBJ",rule:"gaze",effect:"skull",reveal:"…배출장 위에 놓여 있던 것. 그건, 쓰레기가 아니었다."},{id:"H-003",night:2,segment:1,category:"HUM",rule:"avert",effect:"face_window",reveal:"…창문에서 내려다보던 얼굴. 그 집은, 빈집이다."},{id:"H-004",night:1,segment:2,category:"OBJ",rule:"gaze",effect:"handprints",reveal:"…세탁소 셔터의 손자국들은, 안쪽에서 찍힌 것이었다."},{id:"H-005",night:1,segment:3,category:"HUM",rule:"avert",effect:"swing_figure",reveal:"…그네에 앉아 있던 것은, 아이가 아니었다."},{id:"H-006",night:2,segment:3,category:"HUM",rule:"avert",effect:"eyes",reveal:"…펜스 뒤 어둠에서, 눈이 이쪽을 보고 있었다."},{id:"H-007",night:1,segment:4,category:"HUM",rule:"avert",effect:"bus_figure",reveal:"…정류장에 앉아 있던 사람. 버스는, 새벽에 안 다닌다."},{id:"H-008",night:1,segment:5,category:"OBJ",rule:"gaze",effect:"drag_mark",reveal:"…무언가를 끌고 간 자국이, 어둠 쪽으로 이어져 있었다."},{id:"H-009",night:2,segment:0,category:"HUM",rule:"avert",effect:"figure",reveal:"…등을 돌리고 서 있던 사람. 다시 봤을 때는, 없었다."},{id:"H-010",night:3,segment:1,category:"OBJ",rule:"gaze",effect:"shoes",reveal:"…계단 앞에 가지런히 놓인 신발은, 누구의 것도 아니었다."},{id:"H-011",night:3,segment:2,category:"LGT",rule:"gaze",effect:"shutter_glow",reveal:"…닫힌 셔터 밑에서 새어 나오던 빛은, 안에서 켠 것이었다."},{id:"H-012",night:3,segment:3,category:"HUM",rule:"avert",effect:"slide_figure",reveal:"…미끄럼틀 지붕 위에 서 있던 것은, 올라갈 수 없는 자리에 있었다."},{id:"H-015",night:3,segment:5,category:"OBJ",rule:"gaze",effect:"open_shutter",reveal:"…반쯤 올라간 셔터 안은, 불도 사람도 없었다."},{id:"H-016",night:4,segment:4,category:"OBJ",rule:"gaze",effect:"bench_shoes",reveal:"…벤치 위에 신발만 가지런히. 신고 갈 사람이, 없었다."},{id:"H-017",night:5,segment:2,category:"LGT",rule:"gaze",effect:"sign_lit",reveal:"…다 꺼진 상가에서, 그 간판 하나만 켜져 있었다."},{id:"H-013",night:4,segment:1,category:"HUM",rule:"avert",effect:"bike_figure",reveal:"…오토바이에 걸터앉아 있던 것은, 내가 지나갈 때까지 그대로였다."},{id:"H-014",night:4,segment:4,category:"HUM",rule:"avert",effect:"across_figure",reveal:"…길 건너에 서 있던 것은, 신호가 바뀌어도 건너지 않았다."},{id:"H-019",night:2,segment:2,category:"OBJ",rule:"gaze",effect:"lone_shadow",reveal:"…가로등 밑에, 그림자만 있었다. 그걸 만든 것은 없었다."},{id:"H-020",night:3,segment:3,category:"HUM",rule:"avert",effect:"fence_hands",reveal:"…펜스를 잡은 손이, 넷이었다."}],G0=[{night:1,onboarding:!0,intro:`튀김을 먹고 나왔다. 배가 부르다.
...
`))??[];for(const i of t.slice(1)){const s=/\/([\w.-]+\.ts)(?:\?[^:]*)?:(\d+):\d+/.exec(i);if(s&&s[1]!=="kit.ts"){n.userData.src=`${s[1]}:${s[2]}`;return}}}function ug(n){let t=n>>>0;return()=>(t=t*1664525+1013904223>>>0,t/4294967296)}function Es(n,t,e){const i=ug(e),s=new Float32Array(t*t);for(let l=0;l<s.length;l++)s[l]=i();const r=new Float32Array(n*n),o=n/t,a=l=>l*l*(3-2*l);for(let l=0;l<n;l++){const c=l/o,u=Math.floor(c)%t,h=(u+1)%t,f=a(c-Math.floor(c));for(let p=0;p<n;p++){const g=p/o,_=Math.floor(g)%t,m=(_+1)%t,d=a(g-Math.floor(g)),w=s[u*t+_]+(s[u*t+m]-s[u*t+_])*d,T=s[h*t+_]+(s[h*t+m]-s[h*t+_])*d;r[l*n+p]=w+(T-w)*f}}return r}const hg=256;function Jc(n){const t=hg,e=new Float32Array(t*t).fill(1);n(e,t);const i=document.createElement("canvas");i.width=i.height=t;const s=i.getContext("2d"),r=s.createImageData(t,t);for(let a=0;a<e.length;a++){const l=Math.max(0,Math.min(1,e[a]))*255;r.data[a*4]=r.data[a*4+1]=r.data[a*4+2]=l,r.data[a*4+3]=255}s.putImageData(r,0,0);const o=new Ca(i);return o.wrapS=o.wrapT=Ts,o.colorSpace=Je,o}function dg(){return Jc((n,t)=>{const e=Es(t,8,7311),i=Es(t,64,4409);for(let s=0;s<n.length;s++)n[s]=1-(e[s]-.5)*.15-(i[s]-.5)*.14})}function fg(){return Jc((n,t)=>{const e=Es(t,6,1187),i=Es(t,24,9041),s=Es(t,48,2273);for(let r=0;r<t;r++)for(let o=0;o<t;o++){const a=r*t+o,l=i[r%8*t+o];n[a]=1-(e[a]-.5)*.12-(l-.5)*.09-(s[a]-.5)*.06}})}function pg(){const e=document.createElement("canvas");e.width=512,e.height=256;const i=e.getContext("2d"),s=i.createLinearGradient(0,0,0,256);s.addColorStop(0,"#8d92bd"),s.addColorStop(.16,"#a89cc0"),s.addColorStop(.3,"#c9a8bd"),s.addColorStop(.4,"#e8bcc2"),s.addColorStop(.47,"#f5cdc6"),s.addColorStop(.52,"#eec4b4"),s.addColorStop(1,"#b08b7a"),i.fillStyle=s,i.fillRect(0,0,512,256);const r=512*.75,o=256*.4,a=i.createRadialGradient(r,o,0,r,o,512*.34);a.addColorStop(0,"rgba(255, 244, 214, 0.95)"),a.addColorStop(.06,"rgba(255, 226, 172, 0.80)"),a.addColorStop(.2,"rgba(250, 196, 158, 0.45)"),a.addColorStop(.55,"rgba(238, 180, 168, 0.16)"),a.addColorStop(1,"rgba(230, 175, 175, 0)"),i.fillStyle=a,i.fillRect(0,0,512,256);const l=new Ca(e);return l.wrapS=Ts,l.wrapT=ti,l.colorSpace=Je,l}function cc(n,t,e,i){const s=t.clone();s.needsUpdate=!0,s.repeat.set(e,i);const r=new Xt({color:n,roughness:.95,map:s});return r.userData.surface=!0,r}function Ct(n,t,e,i,s,r,o,a){const l=new ot(new Wt(n,t,e),new Xt({color:i,roughness:.95}));return l.position.set(s,r,o),jc(l),a.add(l),l}function W(n,t,e,i,s,r,o,a){const l=new ot(new Wt(t,e,i),n);return l.position.set(s,r,o),jc(l),a.add(l),l}const Tt=n=>new Xt({color:n,roughness:.95});function mg(){return{blood:new Xt({color:7017492,roughness:.16,metalness:.25,emissive:3346190}),bloodWall:new Xt({color:1902345,roughness:.5}),darkFigure:new Xt({color:724502,roughness:1,flatShading:!0}),pale:new Xt({color:12169892,roughness:.9,emissive:1381391})}}const C=Jt.segLength,H=Jt.corridorHalfWidth,Qt=7,Ee=-C*.68,yn=3.2,po=-C*.585,Na=9,gg=3.5,Qc=6;function Cs(n){return n%Na<Qc}function _g(n){const t=n%Na;return t>=gg&&t<Qc}const da=44,tu=3.8,vg=18,xg=9,Mg=4.6,qe=9,Fe=3.4,eu=1.5,Sg=-36-qe/2,yg=[1.8,qe/2],nu=12371672,Fa=8160924,iu=3.2,Eg=16764829,Tg=7.5,bg=6244134,wg=16755566,Ag=8213296,Rg=13951730,Cg=7176344,Pg=4,Lg=11,su=Math.PI/2,Dg=0,ru=[[1.6,-C*.26],[-1.9,-C*.36],[2.1,-C*.49],[-1.4,-C*.58],[.9,-C*.71],[-2.1,-C*.81]],ou=new N(-2.35,.28,-C*.46),Ig=new N(.5,.28,-C*.42),Ps=[26,20,14,9,5.5,3],Ci=658970,au=15713222,lu=14269629,Ze=-C-6.6;function uc(n=!1){const t=new te,e={road:Tt(1580072),wall:Tt(2304056),shutter:Tt(2765123),tile:Tt(7236190),steel:Tt(9080470),dark:Tt(1317154),awning:Tt(8133922)},i=new Xt({color:16757310,emissive:16757310,emissiveIntensity:.55,roughness:.4});W(e.road,12,.2,12,0,-.18,Ze+3.4,t);const s=8,r=3.6,o=Ze-r;W(e.tile,s,3.4,.2,0,1.7,o,t);for(const p of[-1,1])W(e.tile,.2,3.4,r,p*(s/2),1.7,Ze-r/2,t);W(e.dark,s+.4,.25,r,0,3.5,Ze-r/2,t),W(e.dark,s+.4,1.1,.4,0,3,Ze,t);const a=W(e.awning,s+1,.12,1.5,0,2.62,Ze+.75,t);a.rotation.x=-.16,W(e.steel,s-1,1.05,.7,0,.525,Ze-.5,t),W(e.tile,s-.8,.08,.85,0,1.09,Ze-.5,t);for(const p of[-1,1]){W(e.steel,1.25,.95,.85,p*1.5,1.5,o+.75,t);const g=new ot(new Wt(1.02,.05,.62),i);g.position.set(p*1.5,1.99,o+.75),t.add(g),W(e.steel,.06,.5,.06,p*1.5,2.25,o+1.1,t)}W(e.dark,3.6,.55,1.1,0,2.75,o+.75,t);const l=new ot(new Le(2.7,1),new Xt({map:lg(),roughness:.9}));l.position.set(-1.5,1.92,Ze-.25),t.add(l);const c=new ot(new Le(1.15,.62),new Xt({map:ag(),roughness:.9}));c.position.set(1.85,1.92,Ze-.25),t.add(c);const u=new ot(new Le(.72,.9),new Xt({map:cg(),roughness:.95}));u.position.set(2.6,1.75,o+.11),t.add(u);for(const p of[2.15,2.62])W(e.steel,2.2,.06,.34,2.6,p,o+.28,t);const h=4.6,f=Ze+3.4;for(const p of[-1,1]){W(e.wall,.5,7,7.6,p*h,3.5,f,t),W(e.shutter,.16,2.4,5.4,p*(h-.32),1.2,f,t);for(let _=0;_<4;_++)W(e.dark,.17,.05,5.4,p*(h-.32),.5+_*.55,f,t);const g=W(e.awning,.9,.1,5.6,p*(h-.6),2.75,f,t);g.rotation.z=p*-.24}W(e.wall,s+6,4.2,.6,0,5.5,Ze+.15,t);for(const p of[-2.4,0,2.4])W(e.dark,1.3,1,.1,p,5.2,Ze-.2,t);if(n){const p=ha(`감자튀김 전문점!!
ff-1204`),g=new Xt({color:16777215,map:p,emissiveMap:p,emissive:16777215}),_=Tt(1314053),m=new ot(new Wt(3.4,.9,.3),[_,_,_,_,g,_]);m.position.set(0,4.3,Ze+.55),t.add(m);const d=new Ln(16757310,20,26,2);d.position.set(0,3,Ze+.6),t.add(d)}return t.visible=!1,t}const Oe=-C-6;function Ug(){const n=new te,t={road:Tt(1580072),wall:Tt(2304056),villa:Tt(2501694),trim:Tt(2896452),door:Tt(1119519),dark:Tt(1317154),crate:Tt(2765122)},e=new Xt({color:16767392,emissive:16762503,emissiveIntensity:1}),i=new Xt({color:6970434,emissive:16757310,emissiveIntensity:.35,roughness:.6}),s=new Xt({color:3814440,emissive:16757310,emissiveIntensity:.18}),r=4.6,o=Oe+3.4;W(t.road,12,.2,12,0,-.18,o,n);for(const u of[-1,1])W(t.wall,.5,7,7.6,u*r,3.5,o,n);const a=9;W(t.villa,a,7,.6,0,3.5,Oe-.3,n),W(t.trim,a+.6,.3,.9,0,7.1,Oe-.3,n),W(t.trim,3.4,.22,1.3,0,2.62,Oe+.45,n);for(const u of[-1,1])W(t.trim,.16,2.5,.16,u*1.5,1.25,Oe+.95,n);W(t.trim,2.3,2.5,.2,0,1.25,Oe+.02,n),W(t.door,1.6,2.2,.14,0,1.1,Oe+.1,n);const l=new ot(new Wt(.44,1.05,.06),i);l.position.set(0,1.52,Oe+.17),n.add(l);for(const u of[1.16,1.52,1.88])W(t.door,.5,.05,.09,0,u,Oe+.19,n);W(t.trim,.46,.1,.26,0,2.53,Oe+.19,n);const c=new ot(new Wt(.3,.11,.14),e);c.position.set(0,2.44,Oe+.17),n.add(c),W(t.trim,1,.55,.16,-1.75,1.35,Oe+.05,n);for(let u=0;u<3;u++)W(t.dark,.26,.34,.04,-2.05+u*.3,1.35,Oe+.14,n);return W(t.trim,.5,.26,.06,1.7,2.15,Oe+.03,n),[3.6,5.1,6.3].forEach((u,h)=>{W(t.dark,.9,1.1,.12,2.6,u,Oe+.02,n);const f=new ot(new Wt(.8,1,.06),h===1?s:t.dark);f.position.set(-2.6,u,Oe+.02),n.add(f)}),W(t.trim,.85,.6,.4,3,4.4,Oe+.2,n),W(t.crate,1.7,.5,1,-3.3,.25,Oe+1.5,n),W(t.crate,.75,.36,.62,-3.5,.86,Oe+1.45,n),n.visible=!1,n}function Ng(){return{wall:Tt(2106938),portal:Tt(2304056),deck:Tt(1711915),base:Tt(1448741),trim:Tt(2436157),girder:Tt(1317154),groove:Tt(1119517),road:Tt(1580072),fog:[.22,.32,.45,.6,.75].map(n=>new ns({color:263690,transparent:!0,opacity:n,depthWrite:!1,fog:!1,side:Rn}))}}let Fg=null;const cu=()=>Fg??(Fg=Ng());function hc(n,t,e,i,s){const r=new te,o=p=>n+t*p,a=eu,l=qe/2,c=qe+2,u=o(l+1);W(i.road,20,.2,qe+6,0,-.1,o(l),r);for(const p of[2.2,4.4])W(i.groove,a*2+.6,.04,.08,0,.02,o(p),r);for(const p of[-1,1]){const g=p*(a+.45);W(i.wall,.9,Fe,c,g,Fe/2,u,r),W(i.base,1,.5,c,p*(a+.43),.25,u,r),W(i.trim,1,.14,c,p*(a+.43),Fe-.3,u,r);for(const _ of[1.2,2.6,4,5.4])W(i.groove,.07,Fe-1,.09,p*(a-.02),(Fe+.5)/2,o(_),r);W(i.groove,.34,.06,c,p*(a-.17),.035,u,r)}W(i.deck,a*2+2,.9,c,0,Fe+.45,u,r);for(const p of[1,3,5,7])W(i.girder,a*2+1.2,.3,.4,0,Fe-.13,o(p),r);const h=.125;for(const p of[-1,1])W(i.portal,.78,Fe+.62,.85,p*(a+.39),(Fe+.62)/2,o(h),r);W(i.portal,a*2+1.9,.62,.9,0,Fe+.31,o(h),r),W(i.trim,a*2+2.4,.16,1.12,0,Fe+.7,o(h-.08),r);for(const p of[.1,qe-.1])W(i.portal,20,.62,.62,0,Fe+1,o(p),r),W(i.portal,20,1.15,.44,0,Fe+1.89,o(p),r);for(let p=-3.6;p<=3.61;p+=.9)W(i.trim,.16,.6,.3,p,Fe+2.76,o(.1),r);W(i.trim,20,.16,.38,0,Fe+3.14,o(.1),r);for(const p of yg)W(i.girder,.44,.16,.24,0,Fe-.44,o(p),r),W(s,.3,.05,.15,0,Fe-.545,o(p),r);const f=new Ln(nu,iu,11,2);return f.position.set(0,Fe-.7,o(l)),r.add(f),[3.2,4.2,5.2,6.4,7.8].forEach((p,g)=>{const _=new ot(new Le(14,11),i.fog[g]);_.position.set(0,Fe/2,o(p)),r.add(_)}),W(i.portal,20,Qt,1,0,Qt/2,o(qe+e),r),{group:r,light:f}}function Og(n,t){const i=[[2.85,-C*.16],[-2.85,-C*.42],[2.85,-C*.63],[2.85,-C*.93]];for(const[c,u]of i){W(t.pole,.26,9.4,.26,c,9.4/2,u,n);const h=Math.sign(c);W(t.arm,1.5,.1,.1,c-h*.7,9.4-.75,u,n),W(t.arm,1.1,.09,.09,c-h*.5,9.4-1.5,u,n)}W(t.arm,.46,.72,.46,2.85-.5,9.4-2.7,-C*.63,n);const s=[],r=(c,u,h,f,p,g,_)=>{let d=c,w=u,T=h;for(let S=1;S<=6;S++){const R=S/6,E=c+(f-c)*R,b=h+(g-h)*R,P=u+(p-u)*R-_*4*R*(1-R);s.push(d,w,T,E,P,b),d=E,w=P,T=b}},o=9.4-.75;for(const[c,u]of[[-1.3,0],[-.7,-.06],[-.1,.02],[-.95,-.72]])r(2.85+c,o+u,-C*.16,2.85+c,o+u,-C*.63,.55),r(2.85+c,o+u,-C*.63,2.85+c,o+u,-C*.93,.36),r(2.85+c,o+u,-C*.16,2.85+c,o+u+.3,1.5,.3),r(2.85+c,o+u,-C*.93,2.85+c,o+u+.3,-C-1.5,.3);r(2.85-.7,o,-C*.16,-2.85+.7,o-.9,-C*.42,.7),r(2.85-.7,o-.75,-C*.63,-2.85+.7,o-1.5,-C*.42,.6),r(-2.85+.7,o-.9,-C*.42,2.85-.7,o-.4,-C*.93,.8),r(2.85-.7,o-1.5,-C*.63,3,4.6,-C*.52,.15),r(-2.85+.7,o-1.5,-C*.42,-3,4.2,-C*.34,.15);const a=new dn;a.setAttribute("position",new Pe(s,3));const l=new $h(a,new Hc({color:1316381,transparent:!0,opacity:.92}));n.add(l)}function Bg(n){const t=a=>{const l=Tt(a);return l.userData.keepColor=!0,l},e=t(3625007),i=t(4283448),s=t(2900775),r=(()=>{let a=20817;return()=>(a=a*1664525+1013904223>>>0)/4294967296})(),o=(a,l,c,u,h,f)=>{for(let p=0;p<f;p++){const g=r()*Math.PI*2,_=r()*r(),m=Math.cos(g)*_*u,d=Math.sin(g)*_*h,w=.26+(1-_)*.42,T=[e,i,s][p%3];W(T,.09+r()*.11,w*(.8+r()*.5),w*(.8+r()*.5),a,l+d,c+m,n)}};o(-3.05,Qt+.5,-12.8,1.9,.95,16),o(3.05,Qt+.35,-31.8,1.5,.8,13),o(3.02,Qt+.45,-6.2,1.3,.75,11)}function zg(n,t){n.background=new $t(Ci),n.fog=new Aa(Ci,.044);const e=new td(3752286,2.2);n.add(e);const i=new Qh(8425664,.75);i.position.set(4,10,2),n.add(i);const s=new te;n.add(s);const r=new ot(new rn(80,24,16),new ns({map:pg(),side:tn,fog:!1,depthWrite:!1}));r.position.set(0,0,-C/2),r.renderOrder=-1,r.visible=!1,n.add(r);const o=2.5,a=3,l=dg(),c=fg(),u=H*2+14,h=C+14;W(cc(1580072,l,u/o,h/o),u,.2,h,0,-.1,-C/2,s);const f=21.28,p=C+(Ee-yn),g=(yt,qt)=>cc(yt,c,qt/a,Qt/a);for(const[yt,qt]of[[H+.5,2304056],[-H-.5,2106938]])W(g(qt,f),1,Qt,f,yt,Qt/2,-f/2,s),W(g(qt,p),1,Qt,p,yt,Qt/2,Ee-yn-p/2,s);Og(s,{pole:Tt(2830400),arm:Tt(2304056)}),Bg(s);const _=H-ys+1;for(const yt of[-C-.5,.5])for(const qt of[-1,1])Ct(_,Qt,1,2304056,qt*(ys+_/2),Qt/2,yt,s);const m=cu(),d=new Xt({color:2830912,emissive:Fa}),w=hc(-C,-1,4,m,d),T=hc(0,1,.6,m,d),S=w.group,R=T.group;s.add(R),s.add(S);const E=[w.light,T.light],b=-C*.45,P=Ct(.15,5,.15,3817815,H-.4,2.5,b,s);Ct(.62,.1,.1,3817815,H-.7,4.95,b,s);const x=Ct(.5,.14,.26,2765122,H-.9,4.86,b,s).material;x.emissive.setHex(3811858);const L=new Ln(16762503,22,18,1.8);L.position.set(H-.9,4.8,b),s.add(L);const O=new Ln(16757310,0,26,2);O.position.set(0,3,-C-6),s.add(O);const B=new te,Y=new ot(new Wt(.46,1.22,.28),t.darkFigure);Y.position.y=.9;const Z=new ot(new rn(.15,10,8),t.darkFigure);Z.position.y=1.66;for(const yt of[-.27,.27]){const qt=new ot(new Wt(.09,.14,.1),t.pale);qt.position.set(yt,.74,.02),B.add(qt)}const V=new ot(new Wt(.15,.1,.1),t.pale);V.position.set(0,1.5,-.02),B.add(V),B.add(Y,Z),B.visible=!1,s.add(B);const q=new ot(new Da(.42,.5,24),new ns({color:9146536,transparent:!0,opacity:.32}));q.rotation.x=-Math.PI/2,q.position.set(.9,.03,-5.5),q.visible=!1,s.add(q);const X=[ha(`감자튀김 전문점!!
ff-1204`),ha(`감자튀김 전문점이요
ff-1204`)],rt=new Xt({color:16777215,map:X[0],emissiveMap:X[0],emissive:0}),ut=Tt(1314053),xt=new ot(new Wt(3.4,.9,.3),[ut,ut,ut,ut,rt,ut]);xt.position.set(0,4.6,-C+.2),s.add(xt);const Ht=uc(),oe=Ug();s.add(Ht,oe);const K=uc(!0);K.rotation.y=Math.PI,K.position.z=-C,s.add(K);const st=new te,St=new ot(new Wt(4.1,.95,1.75),new Xt({color:1448484,roughness:.7}));St.position.y=.72;const ht=new ot(new Wt(2.1,.62,1.6),new Xt({color:1119261,roughness:.7}));ht.position.set(-.25,1.45,0),st.add(St,ht);const bt=new Xt({color:16774872,emissive:16773320});for(const yt of[-.6,.6]){const qt=new ot(new Wt(.14,.22,.3),bt);qt.position.set(2.02,.78,yt),st.add(qt)}const Zt=new Ln(16771512,0,16,2);return Zt.position.set(2.6,.9,0),st.add(Zt),st.position.set(0,0,Ee),st.visible=!1,s.add(st),{refs:{group:s,scene:n,moon:i,skyDome:r,tunnel:S,backTunnel:R,tunnelLights:E,tunnelLampMat:d,car:st,carLight:Zt,ambient:e,stretchMark:q,lampLight:L,lampHeadMat:x,shopGlow:O,shopSign:xt,shopSignMat:rt,shopTex:X,shopFront:Ht,homeFront:oe,shopBack:K,figure:B},hit:{lamp_flicker:[P],shop_typo:[xt],figure:[B]}}}function Hg(n,t){const e=cu(),i=yn,s=Mg,r=xg,o=c=>n*(vg+c),a=o(r/2+1);for(const c of[-1,1])W(e.wall,r+2,s,.9,a,s/2,Ee+c*(i+.45),t),W(e.base,r+2,.5,1,a,.25,Ee+c*(i+.43),t);W(e.deck,r+2,.9,i*2+2,a,s+.45,Ee,t);for(const c of[1.4,4])W(e.girder,.4,.3,i*2+1.2,o(c),s-.13,Ee,t);for(const c of[-1,1])W(e.portal,.85,s+.62,.78,o(.1),(s+.62)/2,Ee+c*(i+.39),t);W(e.portal,.9,.62,i*2+1.9,o(.1),s+.31,Ee,t),W(e.trim,1.12,.16,i*2+2.4,o(.02),s+.7,Ee,t);const l=new Xt({color:2830912,emissive:Fa});W(e.girder,.24,.16,.5,o(1.5),s-.44,Ee,t),W(l,.17,.05,.38,o(1.5),s-.55,Ee,t),W(e.portal,1,Qt-(s+.9),i*2+2,o(.5),(s+.9+Qt)/2,Ee,t),[1.2,2.4,3.8,5.4,7].forEach((c,u)=>{const h=new ot(new Le(i*2+1,s+.8),e.fog[u]);h.position.set(o(c),s/2,Ee),h.rotation.y=Math.PI/2,t.add(h)}),W(e.portal,1,Qt,i*2+2,o(r+2),Qt/2,Ee,t)}function kg(n){Ct(1,Qt,yn*2,2304056,H+.5,Qt/2,Ee,n),Ct(1,Qt,yn*2,2106938,-H-.5,Qt/2,Ee,n)}function Gg(n){const t=new te,e=new te,i=[[2.05,-C*.455,.34],[1.5,-C*.45,.28],[.95,-C*.443,.3],[.4,-C*.432,.24],[-.15,-C*.425,.27],[-.75,-C*.415,.2],[-1.35,-C*.408,.23],[-1.9,-C*.4,.15]];for(const[V,q,X]of i){const rt=new ot(new Ns(X,14),n.blood);rt.rotation.x=-Math.PI/2,rt.position.set(V,.015,q),e.add(rt)}const s=new ot(new Le(2,2.5),n.bloodWall);s.position.set(H-.06,1.15,-C*.458),s.rotation.y=-Math.PI/2,e.add(s),e.visible=!1,t.add(e);const r=new te,o=new Xt({color:14077884,roughness:.85,emissive:1512976,flatShading:!0}),a=new ot(new rn(.17,12,10),o);a.position.y=.14,a.scale.set(1,.92,1.08);const l=new ot(new Wt(.2,.09,.16),o);l.position.set(0,-.02,.04);const c=new Xt({color:658450,roughness:1,flatShading:!0});for(const V of[-.062,.062]){const q=new ot(new rn(.042,8,6),c);q.position.set(V,.15,.145),r.add(q)}r.add(a,l),r.position.set(-H+.8,1.06,-C*.33),r.scale.setScalar(1.38),r.rotation.y=Math.PI/6,r.visible=!1,t.add(r);const u=sg(),h=new ot(new Le(1,1.28),new Xt({map:u,emissiveMap:u,emissive:4867644}));h.position.set(H-.03,3.4,-C*.68),h.rotation.y=-Math.PI/2,h.visible=!1,t.add(h),Ct(1.6,.5,1,2765122,-H+1,.25,-C*.34,t),Ct(.7,.35,.6,2436157,-H+.8,.85,-C*.33,t);const f=new te,p=Ct(.06,1.3,.06,5593968,0,.65,0,f);p.rotation.z=.5;const g=new ot(new La(.55,.5,8),new Xt({color:7017760,roughness:.8,flatShading:!0}));g.position.set(-.35,1.35,0),g.rotation.z=.5,f.add(g),f.position.set(-H+1.8,0,-C*.38),f.visible=!1,t.add(f);const _=Ct(.45,.22,.16,1843760,-H+.12,1.7,-C*.3,t),m=_.material,d=new Ln(15260080,0,6,1.8);d.position.set(-H+.5,1.7,-C*.3),t.add(d);const w=new ot(new Le(1.1,1.4),new Xt({color:1119263,emissive:0}));w.position.set(H-.02,3.4,-C*.68),w.rotation.y=-Math.PI/2,t.add(w);const T=w.material,S=[ac("010-4172-8956"),ac("010-417-8956")],R=new Xt({map:S[0],roughness:.9}),E=new ot(new Le(.55,.75),R);E.position.set(H-.01,1.55,-C*.4),E.rotation.y=-Math.PI/2,t.add(E),Ct(.24,6.8,.24,2896452,H-.35,3.4,-C*.15,t),Ct(.24,6.8,.24,2896452,-H+.35,3.4,-C*.72,t),Ct(.035,.035,C*.85,1119261,H-.35,6.3,-C*.5,t);const b=H-.35-(-H+.35),P=-C*.15- -C*.72,y=Ct(.035,.035,Math.hypot(b,P),1119261,0,6,(-C*.15+-C*.72)/2,t);y.rotation.y=Math.atan2(b,P),Ct(.85,.6,.38,2764864,H-.35,2.5,-C*.58,t),Ct(.85,.6,.38,2501692,-H+.35,2.2,-C*.33,t),Ct(.12,2.4,1.5,1119519,-H+.05,1.2,-C*.22,t),Ct(.2,.16,1.9,2896452,-H+.1,2.5,-C*.22,t);const x={pipe:Tt(3752282),meter:Tt(2896452),dark:Tt(1119519),prop:Tt(2501694),paper:Tt(4868690)};for(const[V,q]of[[-1,-C*.52],[1,-C*.24],[-1,-C*.82]])W(x.pipe,.14,5.2,.14,V*(H-.16),2.6,q,t);W(x.pipe,.1,.1,C*.36,-H+.16,2.9,-C*.67,t),W(x.pipe,.1,.1,C*.3,H-.16,2.75,-C*.38,t),W(x.dark,.12,2.4,1.5,H-.05,1.2,-C*.86,t),W(x.meter,.2,.16,1.9,H-.1,2.5,-C*.86,t),W(x.meter,.16,.6,.9,H-.12,1.7,-C*.78,t);for(let V=0;V<4;V++)W(x.prop,.14,.26,.22,H-.14,1.45,-C*.75+V*.28,t);W(x.meter,.16,.55,.8,-H+.12,1.75,-C*.29,t),W(x.prop,.42,.55,1.5,H-.42,.42,-C*.66,t),W(x.prop,.3,.35,.3,H-.42,.9,-C*.62,t),W(x.prop,.5,.42,.5,-H+.35,.21,-C*.62,t),W(x.prop,.45,.38,.45,-H+.38,.6,-C*.63,t);for(const[V,q,X]of[[-1,-C*.72,1.5],[1,-C*.48,1.35],[-1,-C*.46,1.9]])W(x.paper,.02,.34,.24,V*(H-.02),X,q,t);const L=new te;for(const V of[-.11,.11]){const q=W(Tt(14210248),.24,.11,.34,0,.055,0,L);q.position.x=V}L.position.set(H-.55,0,-C*.86+.15),L.visible=!1,t.add(L);const O=new te,B=new ot(new Wt(.4,.72,.26),n.darkFigure);B.position.y=1.24;const Y=new ot(new rn(.14,10,8),n.darkFigure);Y.position.set(0,1.74,.02);const Z=new ot(new Wt(.34,.5,.5),n.darkFigure);Z.position.set(0,.78,.24);for(const V of[-.17,.17]){const q=new ot(new Wt(.1,.11,.15),n.pale);q.position.set(V,1.16,.3),O.add(q)}return O.add(B,Y,Z),O.position.set(H-.42,0,-C*.655),O.visible=!1,t.add(O),{group:t,refs:{umbrella:f,sensorMat:m,sensorLight:d,windowMat:T,flyerMat:R,flyerTex:S,bloodTrail:e,skull:r,facePlane:h,shoes:L,bikeFigure:O},hit:{umbrella:[f],sensor_on:[_],window_red:[w],flyer_digits:[E],blood_trail:[e],skull:[r],face_window:[h],shoes:[L],bike_figure:[O]}}}function Vg(){const n=new te,t=Ct(.08,2,2.6,1316900,H-.06,1.25,-C*.39,n),e=t.material,i=Ct(.12,2.2,2.7,2830916,H-.18,1.25,-C*.39,n),s=new Ln(13623528,0,8,1.8);s.position.set(H-.9,1.3,-C*.39),n.add(s);const r=new ot(new Le(2.4,1.7),new Xt({map:rg(),transparent:!0,roughness:1}));r.position.set(H-.25,1.25,-C*.39),r.rotation.y=-Math.PI/2,r.visible=!1,n.add(r);const o=Ct(1.7,.65,.14,1975348,H-.1,3.2,-C*.5,n),a=o.material;Ct(1.5,.6,.14,1843504,H-.1,3.4,-C*.29,n),Ct(1.9,.7,.14,2106938,H-.1,3.1,-C*.62,n);const l=[lc(!1),lc(!0)],c=new Xt({map:l[0],roughness:.85}),u=new ot(new Le(1.5,1.1),c);u.position.set(-H+.01,1.5,-C*.5),u.rotation.y=Math.PI/2,n.add(u);const h={shutter:Tt(2765123),slat:Tt(2041140),awning:Tt(2302260),curb:Tt(2238262),sign:Tt(2106938),steel:Tt(3752282),prop:Tt(2501694),dark:Tt(1514538)};for(const[P,y]of[[-1,-C*.3],[-1,-C*.68],[-1,-C*.86],[1,-C*.19],[1,-C*.76]]){const x=P*(H-.1);W(h.shutter,.12,2.1,2.3,x,1.15,y,n);for(let O=0;O<4;O++)W(h.slat,.13,.05,2.3,x,.45+O*.5,y,n);const L=W(h.awning,.85,.07,2.5,P*(H-.5),2.65,y,n);L.rotation.z=P*.3,W(h.sign,.14,.5,2,P*(H-.12),3.05,y,n)}const f=-C*.68,p=new Xt({color:1119260,roughness:1}),g=new ot(new Le(1.7,2),p);g.rotation.x=-Math.PI/2,g.position.set(-1.45,.02,f),n.add(g);const _=new Xt({color:1119260}),m=new ot(new Wt(.06,.1,2.1),_);m.position.set(-2.7,.18,f),n.add(m);const d=new Ln(16769192,0,6.5,2);d.position.set(-2.1,.5,f),n.add(d),W(h.curb,.55,.14,C*.92,-H+.28,.07,-C/2,n),W(h.curb,.55,.14,C*.92,H-.28,.07,-C/2,n),W(h.dark,.9,.3,1.8,-H+.55,.02,-C*.44,n);for(const P of[-C*.41,-C*.47])W(h.steel,.06,.9,.06,-H+1,.45,P,n);W(h.steel,.06,.06,1.3,-H+1,.88,-C*.44,n);for(const[P,y]of[[1,-C*.42],[1,-C*.58],[-1,-C*.55]])W(h.prop,.5,.42,.8,P*(H-.28),1.9,y,n);W(h.steel,.16,4.6,.16,H-.2,2.3,-C*.35,n),W(h.steel,.12,.12,C*.4,H-.2,2.55,-C*.55,n);const w=W(h.prop,.16,1,.7,-H+.32,.5,-C*.24,n);w.rotation.z=-.12;for(const[P,y]of[[-C*.63,.34],[-C*.66,.28]])W(h.prop,.42,y,.6,-H+.34,y/2,P,n);const T=new te,S=new ns({color:263691}),R=new ot(new Le(2.7,.98),S);R.rotation.x=-Math.PI/2,R.position.set(.75,.02,-C*.45);const E=new ot(new Ns(.42,16),S);E.rotation.x=-Math.PI/2,E.position.set(-.78,.02,-C*.45);const b=new ot(new Le(1.25,.34),S);return b.rotation.x=-Math.PI/2,b.rotation.z=-.55,b.position.set(.7,.02,-C*.417),T.add(R,E,b),T.visible=!1,n.add(T),{group:n,refs:{laundryShutter:i,laundryMat:e,laundryLight:s,storeSignMat:a,realtyMat:c,realtyTex:l,handprints:r,shutterGlowMat:p,shutterGlowSlitMat:_,shutterGlowLight:d,loneShadow:T},hit:{laundry_open:[i,t],sign_lit:[o],realty_urgent:[u],handprints:[r],shutter_glow:[g,m],lone_shadow:[T]}}}function Wg(n){const t=new te;for(const E of[-C*.32,-C*.375,-C*.43,-C*.485])Ct(.07,.85,1.7,3291730,-H+.85,.45,E,t);Ct(.1,2.3,.1,3817815,-H+.22,1.15,-C*.365,t),Ct(.1,2.3,.1,3817815,-H+.22,1.15,-C*.42,t),Ct(.08,.08,2.2,3817815,-H+.22,2.3,-C*.393,t);const e=new te;e.position.set(-H+.22,2.26,-C*.393),Ct(.03,1.5,.03,5593968,0,-.75,-.22,e),Ct(.03,1.5,.03,5593968,0,-.75,.22,e),Ct(.14,.06,.55,5593968,0,-1.5,0,e),t.add(e);const i=new ot(new rn(.28,12,10),new Xt({color:7173256,roughness:.85,flatShading:!0}));i.position.copy(ou),t.add(i);const s=new te,r=new ot(new Wt(.4,.62,.26),n.darkFigure);r.position.y=1.12;const o=new ot(new rn(.13,10,8),n.darkFigure);o.position.set(.05,1.56,0);const a=new ot(new Wt(.34,.52,.16),n.darkFigure);a.position.set(.2,.56,0),a.rotation.z=.25;for(const E of[-.19,.19]){const b=new ot(new Wt(.09,.13,.1),n.pale);b.position.set(E,1.3,.02),s.add(b)}s.add(r,o,a),s.position.set(-H+.22,0,-C*.393),s.visible=!1,t.add(s);const l=new te,c=new Xt({color:724502,emissive:9410220,emissiveIntensity:.9,flatShading:!0});for(const E of[-.09,.09]){const b=new ot(new rn(.045,8,6),c);b.position.x=E,l.add(b)}l.position.set(-H+.38,1.42,-C*.55),l.visible=!1,t.add(l);const u=new Xt({color:1251880,roughness:1,flatShading:!0});for(const[E,b]of[[-C*.25,1.6],[-C*.42,2],[-C*.58,1.5],[-C*.78,1.8]]){const P=new ot(new rn(1,7,5),u);P.scale.set(b,b*.75,b),P.position.set(-H-1.4,Qt+.6,E),t.add(P)}const h={fence:Tt(3291730),rail:Tt(3818592),gear:Tt(2765648),wall2:Tt(2041140),dark:Tt(1514538),prop:Tt(2501694)},f=W(h.gear,.13,4.6,.13,-H-1.7,2.3,-C*.5,t);f.name="놀이터 보안등";const p=new Xt({color:2831430,roughness:.6,emissive:3491946}),g=new ot(new Wt(.44,.18,.44),p);g.position.set(-H-1.7,4.55,-C*.5),t.add(g);const _=new Ln(10467032,6.5,12,2);_.position.set(-H-1.4,4.2,-C*.5),t.add(_),W(h.gear,.12,2.6,.12,-H-2.2,Qt+.6,-C*.34,t),W(h.gear,1.9,.12,.9,-H-2.9,Qt+1.7,-C*.34,t);const m=W(h.gear,2.6,.1,.7,-H-3.4,Qt+.5,-C*.34,t);m.rotation.z=.5;const d=new te,w=new ot(new Wt(.42,1.2,.26),n.darkFigure);w.position.y=.6;const T=new ot(new rn(.15,10,8),n.darkFigure);T.position.y=1.35;for(const E of[-.11,.11]){const b=new ot(new Wt(.11,.07,.2),n.pale);b.position.set(E,.035,.03),d.add(b)}d.add(w,T),d.position.set(-H+.15,Qt,-C*.36),d.visible=!1,t.add(d);for(const E of[-C*.62,-C*.7])W(h.gear,.09,1.8,.09,-H-2,Qt+.3,E,t),W(h.gear,.09,1.8,.09,-H-3.4,Qt+.3,E,t);for(const E of[Qt-.5,Qt+.4,Qt+1.2])W(h.gear,1.5,.09,.09,-H-2.7,E,-C*.66,t);for(const E of[-C*.15,-C*.21,-C*.265,-C*.54,-C*.595,-C*.65,-C*.72,-C*.79,-C*.86])W(h.fence,.07,.85,1.7,-H+.85,.45,E,t);W(h.rail,.05,.06,C*.78,-H+.85,.88,-C*.5,t),W(h.prop,.5,.1,1.6,-H+.5,.45,-C*.24,t);for(const E of[-C*.215,-C*.265])W(h.prop,.45,.45,.08,-H+.5,.22,E,t);W(h.prop,.42,.7,.42,-H+.45,.35,-C*.75,t),W(h.dark,.1,2.2,1.3,H-.05,1.1,-C*.7,t),W(h.wall2,.16,.2,1.6,H-.12,2.3,-C*.7,t),W(h.wall2,.14,.5,.4,H-.1,1.5,-C*.58,t);for(const E of[-C*.3,-C*.38,-C*.46])W(h.prop,.34,.3,.34,H-.25,2.3,E,t),W(h.gear,.3,.34,.3,H-.25,2.6,E,t);W(h.wall2,.5,.16,C*.5,H-.3,2.12,-C*.4,t),W(h.prop,.3,.75,.3,H-.25,.37,-C*.86,t),W(h.wall2,.12,1.1,.5,H-.08,1.6,-C*.86,t);const S=new te,R=new Xt({color:12169892,roughness:.9,emissive:1381391});for(const[E,b]of[[-H+.85,-C*.3],[-H+.85,-C*.345],[-H+.85,-C*.62],[-H+.85,-C*.665]]){const P=new ot(new Wt(.1,.12,.17),R);P.position.set(E,.9,b),S.add(P);for(let y=0;y<4;y++){const x=new ot(new Wt(.11,.035,.032),R);x.position.set(E+.05,.855,b-.06+y*.04),x.rotation.z=-.5,S.add(x)}}return S.visible=!1,t.add(S),{group:t,refs:{swingPivot:e,ball:i,swingFigure:s,eyes:l,slideFigure:d,fenceHands:S},hit:{swing:[e],ball_out:[i],swing_figure:[s],eyes:[l],slide_figure:[d],fence_hands:[S]}}}function Xg(n){const t=new te;Ct(.08,2.2,2.2,2436157,H-.06,1.35,-C*.32,t),Ct(.9,.08,2.4,2765122,H-.5,2.5,-C*.32,t),Ct(.08,2.5,.08,2765122,H-.34,1.25,-C*.29,t),Ct(.08,2.5,.08,2765122,H-.34,1.25,-C*.35,t),Ct(.35,.08,1.8,2765122,H-.32,.55,-C*.32,t);const i=Ct(.62,.06,1.7,2765122,H-.5,2.4,-C*.32,t).material;i.emissive.setHex(9414340);const s=new Ln(12374250,9,8.5,2);s.position.set(H-.7,2.2,-C*.32),t.add(s);const r=new te,o=new ot(new Wt(.42,.6,.26),n.darkFigure);o.position.y=.95;const a=new ot(new rn(.13,10,8),n.darkFigure);a.position.set(-.06,1.38,0);const l=new ot(new Wt(.4,.5,.18),n.darkFigure);l.position.set(-.2,.35,0),r.add(o,a,l),r.position.set(H-.42,0,-C*.32),r.visible=!1,t.add(r);const c=new te,u=new ot(new Wt(.44,1.2,.26),n.darkFigure);u.position.y=.9;const h=new ot(new rn(.15,10,8),n.darkFigure);h.position.y=1.64;for(const S of[-.26,.26]){const R=new ot(new Wt(.09,.14,.1),n.pale);R.position.set(S,.72,.03),c.add(R)}c.add(u,h),c.position.set(-1.1,0,Ee-yn-.6),c.visible=!1,t.add(c);const f=[],p=[],g=[],_=-C*.55,m=Ee-yn-.9;for(const[S,R,E]of[[H-.4,m,1],[-2.6,_,-1]]){Ct(.12,3.4,.12,3817815,S,1.7,R,t),g.push(Ct(.3,.66,.24,1843760,S,3.55,R,t));const b=Ct(.16,.16,.06,3477780,S,3.7,R+.14*E,t),P=Ct(.16,.16,.06,1124378,S,3.42,R+.14*E,t);f.push(b.material),p.push(P.material)}Ct(60,.2,yn*2,1843244,0,-.1,Ee,t);for(const S of[-1,1])Ct(15,Qt,1,2304056,S*11,Qt/2,Ee-yn-.5,t),Ct(15,Qt,1,2106938,S*11,Qt/2,Ee+yn+.5,t),Hg(S,t);for(let S=0;S<4;S++)Ct(H*2-1.2,.03,.6,8949922,0,.02,-C*.62-S*1.15,t);Ct(H*2-1.2,.03,.35,8949922,0,.02,-C*.585,t),Ct(.16,.7,.16,3752282,H-.7,.35,-C*.24,t),Ct(.16,.7,.16,3752282,H-.7,.35,-C*.4,t),Ct(.5,.14,4,2304056,H-.25,.07,-C*.32,t);const d=new Xt({map:og(),roughness:.95}),w=new ot(new Le(6.4,1.1),d);w.position.set(0,5.25,-C+.25),t.add(w);const T=new te;for(const S of[-.19,.19]){const R=Ct(.24,.11,.34,14210248,0,.055,S,T);R.position.z=S}return T.position.set(H-.32,.59,-C*.32+.62),T.visible=!1,t.add(T),{group:t,refs:{trafficRed:f,trafficGreen:p,busFigure:r,banner:w,boothLight:s,boothTubeMat:i,acrossFigure:c,benchShoes:T},hit:{traffic_red:g,bus_figure:[r],across_figure:[c],bench_shoes:[T]}}}function qg(n){const t=new te;Ct(.14,.6,1.5,2106938,-H+.1,3.1,-C*.25,t),Ct(1.6,.7,.14,1975348,H-.1,3.35,-C*.33,t),Ct(.14,.55,1.3,1843504,-H+.1,2.9,-C*.47,t),Ct(1.8,.6,.14,2106938,H-.1,3.15,-C*.6,t);const e=new te,i=Tt(2962246),s=new Wt(.8,1.15,.06);for(const R of[1,-1]){const E=new ot(s,i);E.position.set(0,.56,R*.16),E.rotation.x=-R*.26,e.add(E)}e.position.set(-H+.75,0,-C*.55),e.rotation.y=su,t.add(e);const r=new te,o=new ot(new Ns(.42,16),n.blood);o.rotation.x=-Math.PI/2,o.position.set(1.75,.015,-C*.452);const a=new ot(new Le(.4,5.4),n.blood);a.rotation.x=-Math.PI/2,a.rotation.z=1.16,a.position.set(-.35,.015,-C*.437);const l=new ot(new Le(1.4,1.9),n.bloodWall);l.position.set(H-.38,.9,-C*.452),l.rotation.y=-Math.PI/2;const c=new Xt({color:11055293,roughness:.4,emissive:1448480});for(const[R,E,b]of[[-.34,.66,.34],[.24,.98,.42]]){const P=new ot(new Wt(.16+b,.26,.72),c);P.position.set(H-.28-b/2,E,-C*.452+R),P.rotation.z=.18,r.add(P)}r.add(o,a,l),r.visible=!1,t.add(r);const u={front:Tt(2304056),shutter:Tt(2765123),slat:Tt(2041140),awning:Tt(2827060),signB:Tt(2106938),crate:Tt(2501694),steel:Tt(3817815),wire:Tt(1119261)};W(u.signB,H*2+.6,.55,.05,0,4.4,-C*.12,t);const h=[[1,-C*.2,3],[-1,-C*.33,3.4],[1,-C*.46,3.2],[-1,-C*.58,3],[1,-C*.71,3.4],[-1,-C*.83,3.2]],f=2,p=new te;t.add(p),h.forEach(([R,E,b],P)=>{const y=R*(H-.1),x=P===f?p:t;W(u.front,.2,4.2,b,y,2.1,E,t),W(u.shutter,.16,2.3,b-.5,R*(H-.26),1.15,E,x);for(let O=0;O<4;O++)W(u.slat,.17,.05,b-.5,R*(H-.26),.5+O*.5,E,x);const L=W(u.awning,.95,.08,b+.2,R*(H-.55),2.72,E,t);L.rotation.z=R*-.28,W(u.signB,.14,.62,b-.8,R*(H-.12),3.42,E,t),P%2===1&&W(u.signB,.5,1.5,.16,R*(H-.45),3.3,E+1.1,t),W(u.steel,.4,.08,b-1.2,R*(H-.2),.78,E,t);for(const O of[-1,1])W(u.steel,.06,.78,.06,R*(H-.2),.39,E+O*(b/2-.8),t)});const g=[[H-.2,.18,-C*.42,.44],[H-.22,.53,-C*.43,.4],[-H+.2,.2,-C*.7,.42],[-H+.22,.18,-C*.26,.44],[H-.24,.17,-C*.63,.4],[-H+.2,.54,-C*.71,.36]];for(const[R,E,b,P]of g)W(u.crate,P,P*.78,P,R,E,b,t);for(const R of[-C*.28,-C*.52,-C*.76]){W(u.wire,H*2+.4,.035,.035,0,4.05,R,t);for(let E=-2;E<=2;E++)W(u.crate,.09,.13,.09,E*1.15,3.95,R,t)}const[,_,m]=h[f],d=m-.5,w=new te;W(u.shutter,.16,.95,d,H-.26,1.83,_,w);for(let R=0;R<2;R++)W(u.slat,.17,.05,d,H-.26,1.55+R*.4,_,w);W(Tt(263690),.06,1.35,d,H-.36,.68,_,w);const T=new Xt({color:10134192,roughness:.45,emissive:1316637}),S=new ot(new Wt(.26,.17,d),T);return S.position.set(H-.28,1.33,_),w.add(S),w.visible=!1,t.add(w),{group:t,refs:{sign:e,dragMark:r,openShutter:w,closedShutter:p},hit:{sign_turn:[e],drag_mark:[r],open_shutter:[w]}}}function Xe(n){return{reset:t=>{n(t).visible=!1},apply:t=>{n(t).visible=!0}}}const dc={shoes:Xe(n=>n.shoes),bench_shoes:Xe(n=>n.benchShoes),bike_figure:Xe(n=>n.bikeFigure),lone_shadow:Xe(n=>n.loneShadow),fence_hands:Xe(n=>n.fenceHands),slide_figure:Xe(n=>n.slideFigure),across_figure:Xe(n=>n.acrossFigure),open_shutter:{reset:n=>{n.openShutter.visible=!1,n.closedShutter.visible=!0},apply:n=>{n.openShutter.visible=!0,n.closedShutter.visible=!1}},shutter_glow:{reset:n=>{n.shutterGlowMat.color.setHex(1119260),n.shutterGlowSlitMat.emissive.setHex(0),n.shutterGlowLight.intensity=0},apply:n=>{n.shutterGlowMat.color.setHex(9077362),n.shutterGlowSlitMat.emissive.setHex(16764810),n.shutterGlowLight.intensity=5.5}},umbrella:Xe(n=>n.umbrella),sensor_on:{reset:n=>{n.sensorMat.emissive.setHex(0),n.sensorLight.intensity=0},apply:n=>{n.sensorMat.emissive.setHex(13615780),n.sensorLight.intensity=4}},window_red:{reset:n=>{n.windowMat.emissive.setHex(0)},apply:n=>{n.windowMat.emissive.setHex(7999504)}},laundry_open:{reset:n=>{n.laundryShutter.position.y=1.25,n.laundryShutter.scale.y=1,n.laundryMat.emissive.setHex(0),n.laundryLight.intensity=0},apply:n=>{n.laundryShutter.position.y=2,n.laundryShutter.scale.y=.42,n.laundryMat.emissive.setHex(7833487),n.laundryLight.intensity=6}},sign_lit:{reset:n=>{n.storeSignMat.emissive.setHex(0)},apply:n=>{n.storeSignMat.emissive.setHex(7214100)}},swing:{reset:n=>{n.swingPivot.rotation.x=0}},lamp_flicker:{reset:n=>{n.lampLight.intensity=n.group.userData.morning?0:n.group.userData.lampBase??Ps[0]}},traffic_red:{reset:()=>{}},ball_out:{reset:n=>{n.ball.position.copy(ou)},apply:n=>{n.ball.position.copy(Ig)}},sign_turn:{reset:n=>{n.sign.rotation.y=su},apply:n=>{n.sign.rotation.y=Dg}},flyer_digits:{reset:n=>{n.flyerMat.map=n.flyerTex[0]},apply:n=>{n.flyerMat.map=n.flyerTex[1]}},realty_urgent:{reset:n=>{n.realtyMat.map=n.realtyTex[0]},apply:n=>{n.realtyMat.map=n.realtyTex[1]}},shop_typo:{reset:n=>{n.shopSignMat.map=n.shopTex[0],n.shopSignMat.emissiveMap=n.shopTex[0]},apply:n=>{n.shopSignMat.map=n.shopTex[1],n.shopSignMat.emissiveMap=n.shopTex[1]}},figure:{reset:n=>{n.figure.visible=!1},apply:n=>{const[t,e]=ru[n.group.userData.figureAnchor??0];n.figure.position.set(t,0,e),n.figure.rotation.y=Math.random()<.5?Math.PI:Math.PI*.85,n.figure.visible=!0}},blood_trail:Xe(n=>n.bloodTrail),skull:Xe(n=>n.skull),face_window:Xe(n=>n.facePlane),handprints:Xe(n=>n.handprints),swing_figure:Xe(n=>n.swingFigure),eyes:Xe(n=>n.eyes),bus_figure:Xe(n=>n.busFigure),drag_mark:Xe(n=>n.dragMark)};function Yg(n,t){var e,i;for(const s of Object.values(dc))s.reset(n);n.group.userData.effects=t;for(const s of t)(i=(e=dc[s]).apply)==null||i.call(e,n)}const $g=new $t(Ci),mi={hue:.075,hueMix:.92,satBase:.07,satMix:.3,satMax:.24,lift:.11,gain:.95},xs={h:0,s:0,l:0},fc=new $t;function Kg(n){fc.setHex(n).getHSL(xs);const t=xs.h+(mi.hue-xs.h)*mi.hueMix,e=Math.min(mi.satMax,mi.satBase+xs.s*mi.satMix),i=Math.min(.92,xs.l*mi.gain+mi.lift);return fc.setHSL(t,e,i).getHex()}function Zg(n,t){n.traverse(e=>{const i=e;if(!i.isMesh)return;const s=Array.isArray(i.material)?i.material:[i.material];for(const r of s){const o=r;if(!(o!=null&&o.color)||!o.isMeshStandardMaterial||o.userData.keepColor||o.map&&!o.userData.surface||o.emissive&&o.emissive.getHex()!==0)continue;o.userData.nightColor===void 0&&(o.userData.nightColor=o.color.getHex());const l=o.userData.nightColor;o.color.setHex(t?Kg(l):l)}})}function jg(n,t){n.themes.forEach((e,i)=>e.visible=i===t-1)}function uu(n,t){if(n.group.userData.morning)return;const e=Ps[Math.min(t,Ps.length-1)];n.group.userData.lampBase=e,n.lampLight.intensity=e,n.ambient.intensity=Math.max(1.1,2.2-t*.18),n.group.userData.ambientBase=n.ambient.intensity,hu(n,9-t*.7)}function hu(n,t,e=!1){n.boothLight.intensity=Math.max(0,t),n.boothLight.color.setHex(e?Rg:12374250),n.boothTubeMat.emissive.setHex(t>.1?e?Cg:9414340:0)}function Oa(n,t){n.group.userData.morning=t,Zg(n.scene,t),n.scene.background.setHex(t?au:Ci);const e=n.scene.fog;e.color.setHex(t?lu:Ci),e.density=t?.012:.044,n.ambient.color.setHex(t?15656166:3752286),n.ambient.intensity=t?1.8:2.2,n.group.userData.ambientBase=n.ambient.intensity,n.moon.color.setHex(t?16767424:8425664),n.moon.intensity=t?4.6:.75,t?n.moon.position.set(11,6,3):n.moon.position.set(4,10,2),n.skyDome.visible=t,n.skyDome.material.color.setScalar(1),n.lampLight.color.setHex(t?Eg:16762503),n.lampLight.intensity=t?Tg:Ps[0],n.lampHeadMat.emissive.setHex(t?bg:3811858),hu(n,t?Pg:9,t)}function gr(n,t,e){const i=n.scene.fog,s=Math.max(0,Math.min(1,t));i.density=e+s*s*1.4;const r=!!n.group.userData.morning,o=Math.pow(1-s,2.2),a=(c,u)=>{c.setHex(u),r&&s>0&&c.lerp($g,Math.min(1,s*2.5)),c.multiplyScalar(o)};a(i.color,r?lu:Ci),a(n.scene.background,r?au:Ci),r&&n.skyDome.material.color.setScalar(o);for(const c of n.tunnelLights)c.color.setHex(r?wg:nu),c.intensity=iu*(1-s);n.tunnelLampMat.emissive.setHex(r?Ag:Fa).multiplyScalar(1-s);const l=n.group.userData.ambientBase??2.2;n.ambient.intensity=l*(1-s*.92)}function Jg(n,t){n.stretchMark.visible=t}function du(n,t,e=!0){const i=!!n.group.userData.morning;n.tunnel.visible=!t,n.shopFront.visible=t&&e,n.homeFront.visible=t&&!e,n.shopGlow.intensity=t?e?26:30:i?0:4,n.shopSign.visible=t&&e,n.shopSignMat.emissive.setHex(t&&e?16777215:0)}function Qg(n,t){n.backTunnel.visible=!t,n.shopBack.visible=t}function t_(n,t){n.banner.position.z=t?-C+.25:-.25,n.banner.rotation.y=t?0:Math.PI}function e_(n,t){const e=(i,s)=>{i.scale.x=s?-1:1};e(n.themes[3],t),e(n.themes[4],!t),n.banner.scale.x=t?-1:1}const n_=9049622,i_=3111498;function s_(n,t){const e=n.group.userData.effects??[];if(e.includes("lamp_flicker")){const s=n.group.userData.lampBase??Ps[0],r=t%1.6,o=!(r<.12||r>.24&&r<.36);n.lampLight.intensity=o?s:Math.min(2,s)}if(e.includes("swing")&&(n.swingPivot.rotation.x=Math.sin(t*2.2)*.38),n.themes[3].visible){const s=e.includes("traffic_red"),r=_g(t)?Math.floor(t*4)%2===0:!0,o=!s&&Cs(t)&&r,a=s||!Cs(t);for(const l of n.trafficGreen)l.emissive.setHex(o?i_:0);for(const l of n.trafficRed)l.emissive.setHex(a?n_:0)}const i=n.group.userData.carStart;if(i!==void 0){const s=(t-i)/tu;if(s>=1||!n.themes[3].visible)n.car.visible=!1,n.carLight.intensity=0,n.group.userData.carStart=void 0;else{const r=n.group.userData.carDir??1;n.car.position.x=r*(-da/2+da*s),n.car.rotation.y=r>0?0:Math.PI,n.car.visible=!0,n.carLight.intensity=n.group.userData.morning?Lg:26}}}function r_(n){n.group.userData.carStart=void 0,n.car.visible=!1,n.carLight.intensity=0}function o_(n,t,e=1){n.group.userData.carStart=t,n.group.userData.carDir=e,n.car.position.set(e*-da/2,0,Ee),n.car.visible=!0}function a_(n){return n.car.visible&&Math.abs(n.car.position.x)<H+2.2}function l_(n){const t=mg(),e=zg(n,t),i=Gg(t),s=Vg(),r=Wg(t),o=Xg(t),a=qg(t),c=[i,s,r,o,a].map(f=>f.group);c.forEach((f,p)=>{p!==3&&kg(f),f.visible=!1,f.name=`테마${p+1}`,e.refs.group.add(f)}),e.refs.group.name="골목",e.refs.tunnel.name="앞터널",e.refs.backTunnel.name="뒤터널",e.refs.shopFront.name="FF-1204(앞)",e.refs.shopBack.name="FF-1204(뒤)",e.refs.homeFront.name="집",e.refs.figure.name="그림자사람",e.refs.car.name="차",e.refs.shopSign.name="FF-1204 간판",o.refs.banner.name="개업 현수막",o.refs.busFigure.name="정류장의 형체",a.refs.sign.name="입간판",a.refs.dragMark.name="끌린 자국",i.refs.bloodTrail.name="핏자국",i.refs.skull.name="백골",i.refs.umbrella.name="우산",s.refs.handprints.name="손자국",r.refs.swingFigure.name="그네의 형체",r.refs.eyes.name="어둠의 눈",r.refs.ball.name="공";const u=(f,p)=>{const g=f.name?p?`${p}/${f.name}`:f.name:p;f.children.forEach((_,m)=>{_.isMesh&&!_.userData.src&&(_.userData.src=`${g||"?"}#${m}`),u(_,g)})};u(e.refs.group,"");const h={...e.hit,...i.hit,...s.hit,...r.hit,...o.hit,...a.hit};return{...e.refs,...i.refs,...s.refs,...r.refs,...o.refs,...a.refs,themes:c,hit:h}}const Ba="fries.save.v1",yr={night:1,tut:!1,misses:0,results:[],brightness:1,muted:!1};function c_(n){const t={...yr,results:[]};if(typeof n!="object"||n===null)return t;const e=n;return typeof e.night=="number"&&Number.isInteger(e.night)&&e.night>=1&&e.night<=99&&(t.night=e.night),typeof e.tut=="boolean"&&(t.tut=e.tut),t.night>1&&(t.tut=!0),typeof e.misses=="number"&&Number.isInteger(e.misses)&&e.misses>=0&&(t.misses=e.misses),Array.isArray(e.results)&&(t.results=e.results.slice(0,99).map(i=>i==="crispy"||i==="lukewarm"||i==="soggy"?i:null)),typeof e.brightness=="number"&&e.brightness>=.6&&e.brightness<=1.9&&(t.brightness=e.brightness),typeof e.muted=="boolean"&&(t.muted=e.muted),t}function u_(){try{const n=localStorage.getItem(Ba);return n?c_(JSON.parse(n)):{...yr,results:[]}}catch{return{...yr,results:[]}}}const ce=u_();function cs(){try{localStorage.setItem(Ba,JSON.stringify(ce))}catch{}}function h_(){Object.assign(ce,yr,{results:[]});try{localStorage.removeItem(Ba)}catch{}}function d_(){return ce.night>1||ce.misses>0||ce.tut}const f_=`
...
<span class="k">조준</span> ${c}`}pick(){var g;this.ray.setFromCamera(this.center,this.host.camera);const e=this.ray.intersectObjects(this.host.scene.children,!0).find(_=>{if(!_.object.isMesh)return!1;for(let m=_.object;m;m=m.parent)if(!m.visible)return!1;return!0});if(!e)return'<span class="k">(없음)</span>';const i=e.object,s=[];for(let _=i;_;_=_.parent)_.name&&s.unshift(_.name);const r=i.geometry,o=r.parameters;let a=r.type??"?";o&&(r.type==="BoxGeometry"?a=`Box ${_e(o.width)}×${_e(o.height)}×${_e(o.depth)}`:r.type==="PlaneGeometry"?a=`Plane ${_e(o.width)}×${_e(o.height)}`:r.type==="SphereGeometry"?a=`Sphere r${_e(o.radius)}`:r.type==="CylinderGeometry"&&(a=`Cyl r${_e(o.radiusTop)} h${_e(o.height)}`));const l=i.material,c=Array.isArray(l)?"(면별 재질)":"#"+(((g=l.color)==null?void 0:g.getHexString())??"??????"),u=i.getWorldPosition(new N),h=this.host.segLength,f=u.z<.5&&u.z>-h*1.4?` = -L*${_e(-u.z/h,3)}`:"",p=typeof i.userData.src=="string"?i.userData.src:"";return this.line+=`
${s.join(" › ")} | ${p} | ${a} ${c} | x ${_e(u.x)} y ${_e(u.y)} z ${_e(u.z)}${f}`,`<span class="o">${s.join(" › ")||"(이름 없음)"}</span>
`+(p?`     <span class="o">${p}</span>
`:"")+`     ${a}  ${c}  <span class="k">${_e(e.distance,1)}m</span>
     <span class="v">x ${_e(u.x)}  y ${_e(u.y)}  z ${_e(u.z)}</span><span class="k">${f}</span>`}openPanel(){var a,l,c,u;(a=document.exitPointerLock)==null||a.call(document);const t=this.host.snapshot(),e=document.createElement("div");e.id="adm-panel";const i=this.host.anomalies.map(h=>`<option value="${h.effect}">${h.segment?`구간 ${h.segment}`:"전 구간"} · ${h.label}</option>`).join(""),s=m_(this.host.nights,this.host.segments);e.innerHTML=`
      <h3>관리자 — 콘솔</h3>
      <label><span>스테이지</span><select id="adm-stop">${s.map((h,f)=>{const p=h.morning===t.morning&&h.theme===t.theme&&(h.morning||h.night===t.night);return`<option value="${f}"${p?" selected":""}>${f+1}. ${h.label}</option>`}).join("")}</select></label>
