...
1. **접히는 골목** — 이상현상을 못 보고 지나치면 죽음이 아니라 연장: 같은 구간이 미묘히
   달라진 채 반복되고, 남은 거리가 늘어난다. 긴장의 축은 죽음이 아니라 "끝나지 않는 길"
2. **지적과 깊이** — 이상한 것은 직접 짚는다(관찰이 곧 조작). 놓치거나 헛짚을수록
   가로등이 죽고 골목은 더 낯설게 어긋난다
